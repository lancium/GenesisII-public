...
public class pwrapperManipulator extends
		AbstractCmdLineManipulator<PwrapperVariationConfiguration> {
	...
	public List<String> transform(Map<String, Object> jobProperties,
		...
		processManipulatorConfiguration(jobProperties,
				manipulatorConfiguration, variationName, manipProps);
