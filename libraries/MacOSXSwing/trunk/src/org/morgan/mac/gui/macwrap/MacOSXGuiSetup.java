...
public class MacOSXGuiSetup
{
	...
	{
		System.setProperty(GROWBOX_INTRUDES_PROPERTY, Boolean.toString(growboxIntrudes));
	}
	...
	{
		System.setProperty(USE_SCREEN_MENU_BAR_PROPERTY, Boolean.toString(useScreenMenuBar));
	}
}