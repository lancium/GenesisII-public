...
public class Application
{
	...
	static {
		try {
			...
			GET_DOCK_MENU = REAL_APPLICATION_CLASS.getDeclaredMethod("getDockMenu");
			GET_ENABLED_ABOUT_MENU = REAL_APPLICATION_CLASS.getDeclaredMethod("getEnabledAboutMenu");
			GET_ENABLED_PREFERENCES_MENU = REAL_APPLICATION_CLASS.getDeclaredMethod("getEnabledPreferencesMenu");
			IS_ABOUT_MENU_ITEM_PRESENT = REAL_APPLICATION_CLASS.getDeclaredMethod("isAboutMenuItemPresent");
			...
			SET_ENABLED_ABOUT_MENU = REAL_APPLICATION_CLASS.getDeclaredMethod("setEnabledAboutMenu", boolean.class);
			SET_ENABLED_PREFERENCES_MENU = REAL_APPLICATION_CLASS.getDeclaredMethod("setEnabledPreferencesMenu", boolean.class);
	...
	static private Object doExceptionlessInvoke(Method method, Object instance, Object... args)
	{
		try {
	...
	{
		return (Image) doExceptionlessInvoke(GET_DOCK_ICON_IMAGE, _applicationObject);
	}

	public PopupMenu getDockMenu()
	{
		return (PopupMenu) doExceptionlessInvoke(GET_DOCK_MENU, _applicationObject);
	}

	public boolean getEnabledAboutMenu()
	{
		return (Boolean) doExceptionlessInvoke(GET_ENABLED_ABOUT_MENU, _applicationObject);
	}

	public boolean getEnabledPreferencesMenu()
	{
		return (Boolean) doExceptionlessInvoke(GET_ENABLED_PREFERENCES_MENU, _applicationObject);
	}

	public boolean isAboutMenuItemPresent()
	{
		return (Boolean) doExceptionlessInvoke(IS_ABOUT_MENU_ITEM_PRESENT, _applicationObject);
	}

	public boolean isPreferencesMenuItemPresent()
	{
		return (Boolean) doExceptionlessInvoke(IS_PREFERENCES_MENU_ITEM_PRESENT, _applicationObject);
	}
	...
	{
		doExceptionlessInvoke(SET_ENABLED_ABOUT_MENU, _applicationObject, new Boolean(enable));
	}

	public void setEnabledPreferencesMenu(boolean enable)
	{
		doExceptionlessInvoke(SET_ENABLED_PREFERENCES_MENU, _applicationObject, new Boolean(enable));
	}
}