...
/**
 * Provides a way to separate the specifics of certificate validation (including
 * a hidden internal trust store capability) from the simple objects that just
 * want to validate their certificates.
 */
