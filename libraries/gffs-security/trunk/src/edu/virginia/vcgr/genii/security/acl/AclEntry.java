...
/**
 * An element in an ACL policy collection indicating a specific authorization
 * rule
 * 
 * @author dgm4d
 */
public interface AclEntry extends Serializable, Describable {
	...
	/**
	 * Returns false if policy does not yield access to the given Identity.
	 * Throws an exception if there is an issue with the validity of the
