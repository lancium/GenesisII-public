...
public interface AclEntry extends Serializable, Describable
{
	...
	/**
	 * Returns false if policy does not yield access to the given Identity. Throws an exception if
	 * there is an issue with the validity of the identity validity checking.
	 */
