...
public class AttributeInvalidException extends GeneralSecurityException
{
	...
	/**
	 * Constructs a AttributeInvalidException with the specified detail message. A detail message is
	...
	/**
	 * Creates a <code>AttributeInvalidException</code> with the specified cause and a detail
