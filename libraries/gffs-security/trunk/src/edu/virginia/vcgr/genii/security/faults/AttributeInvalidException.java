...
public class AttributeInvalidException extends GeneralSecurityException
{
	...
	/**
	 * Constructs a AttributeInvalidException with the specified detail message. A detail message is a String that describes this particular
	 * exception.
	 * 
	 * @param msg
	 *            the detail message.
	...
	/**
	 * Creates a <code>AttributeInvalidException</code> with the specified detail message and cause.
	 * 
	 * @param message
	...
	/**
	 * Creates a <code>AttributeInvalidException</code> with the specified cause and a detail message of
