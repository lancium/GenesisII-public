...
/**
 * This class hosts all SAML related constants that are used in various places in the code.
 * 
 * @author myanhaona
 */
public class SAMLConstants
{
	...
	/**
	 * this property holds the client's ssl certificate info in the calling context.
	 */
	...
	public static final QName SAML_ASSERTION_QNAME = new QName(SAMLNamespace, "Assertion");
	...
	public static final QName SECURITY_TOKEN_QNAME = new QName(WS_SECURITY_NS11_URI, "SecurityTokenReference");
	public static final QName EMBEDDED_TOKEN_QNAME = new QName(WS_SECURITY_NS11_URI, "Embedded");
}
