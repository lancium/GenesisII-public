...
public class AttributeExpiredException extends AttributeInvalidException
{
	...
	/**
	 * Constructs a AttributeExpiredException with the specified detail message. A detail message is
	...
	/**
	 * Creates a <code>AttributeExpiredException</code> with the specified cause and a detail
