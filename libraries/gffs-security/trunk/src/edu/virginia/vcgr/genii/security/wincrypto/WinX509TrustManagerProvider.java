...
public class WinX509TrustManagerProvider extends java.security.Provider
{
	...
	/**
	 * String identifiying the instance-name to be supplied to TrustManagerFactory for obtaining a WinX509TrustManagerFactory
	 */
	...
	/**
	 * Installs the WinX509TrustManagerProvider into the provider hierarchy if it was not done in the JDK/JRE's lib/security/java.security
	 * file. Using this mechanism may require that the codebase comprising this code be signed appropriately
	 */
