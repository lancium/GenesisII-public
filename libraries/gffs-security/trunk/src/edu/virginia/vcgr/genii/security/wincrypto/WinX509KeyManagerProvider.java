...
public class WinX509KeyManagerProvider extends java.security.Provider
{
	...
	/**
	 * String identifiying the instance-name to be supplied to KeyManagerFactory for obtaining a WinX509KeyManagerFactory
	 */
	...
	/**
	 * Installs the WinX509KeyManagerProvider into the provider hierarchy if it was not done in the JDK/JRE's lib/security/java.security file.
	 * Using this mechanism may require that the codebase comprising this code be signed appropriately
	 */
