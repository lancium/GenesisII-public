...
public class TestPKCS12 
{
    ...
    public void test()
    {
        ...
        X509v2AttributeCertificateBuilder acBldr = null;
		try {
			acBldr = new X509v2AttributeCertificateBuilder(
        ...
        X509AttributeCertificateHolder att = null;
		try {
			att = acBldr.build(new JcaContentSignerBuilder("SHA1WithRSA").setProvider("BC").build(caPrivKey));
