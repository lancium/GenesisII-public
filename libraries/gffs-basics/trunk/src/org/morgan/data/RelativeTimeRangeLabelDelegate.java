...
public class RelativeTimeRangeLabelDelegate implements
		TimeAwareDataRangeLabelDelegate<TimeRange> {
	...
	public String toString(TimeRange dataRange) {
		return String.format(_format, (_mark - dataRange.beginning()
				.getTimeInMillis()) / _units.toMillis(1));
	}
}