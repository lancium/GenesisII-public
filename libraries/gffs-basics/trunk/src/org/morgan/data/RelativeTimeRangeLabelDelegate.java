...
public class RelativeTimeRangeLabelDelegate implements TimeAwareDataRangeLabelDelegate<TimeRange>
{
	...
	{
		this(String.format("-%%d %s", toWordCase(units.toString())), units);
	}
	...
	{
		return String.format(_format, (_mark - dataRange.beginning().getTimeInMillis()) / _units.toMillis(1));
	}
}