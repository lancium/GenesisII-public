...
public class TimeRange
{
	...
	{
		this(start.getTimeInMillis(), start.getTimeInMillis() + durationUnits.toMillis(duration));
	}
	...
	final public TimeRange previous()
	{
		...
		return new TimeRange(_start - diff, _stop - diff);
	}
	...
	{
		return String.format("[%1$tF %1$tT, %2$tF %2$tT)", _start, _stop);
	}
}
