...
/**
 * Parses a configuration section of the form: &lt;mconf:properties&gt; &lt;mconf:property name="some-name" value="some-value"/&gt;*
 * &lt;/mconf:properties&gt;
 * 
	...
	public Object parse(Node n) throws ConfigurationException
	{
		...
		for (int lcv = 0; lcv < length; lcv++) {
			...
			if (child.getNodeType() == Node.ELEMENT_NODE) {
				...
				props.setProperty(nameNode.getTextContent(), MacroUtils.replaceMacros(System.getProperties(), valueNode.getTextContent()));
			}
		}
