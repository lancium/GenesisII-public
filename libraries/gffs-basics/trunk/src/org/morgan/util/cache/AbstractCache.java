...
public abstract class AbstractCache<KeyType, DataType> implements ICache<KeyType, DataType>
{
	...
	protected abstract DataType miss(KeyType key) throws CacheMissException;
}