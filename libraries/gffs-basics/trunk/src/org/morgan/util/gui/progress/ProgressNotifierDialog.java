...
class ProgressNotifierDialog extends JDialog implements ProgressNotifier {
	...
	public ProgressNotifierDialog(Window owner, String title, String note,
			ProgressTask<?> task, int initialProgress,
		...
		add(new JButton(new CancelAction()), new GridBagConstraints(0, 2, 1, 1,
