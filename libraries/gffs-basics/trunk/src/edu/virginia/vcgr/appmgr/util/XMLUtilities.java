...
public class XMLUtilities {
	...
	static public String getRequiredAttribute(NamedNodeMap attributes,
			String attributeName) throws SAXException {
		String ret = getAttribute(attributes, attributeName, null);
		if (ret == null)
			throw new SAXException(String.format(
					"Unable to find required attribute %s.", attributeName));
		return ret;
	}

	static public String getRequiredAttribute(Node node, String attributeName)
			throws SAXException {
		return getRequiredAttribute(node.getAttributes(), attributeName);
	}

	static public String getAttribute(NamedNodeMap attributes,
	...
	static public String getAttribute(Node node, String attributeName,
			String defaultValue) {
	...
	static public String getTextContent(Element e) throws SAXException {
		...
		if (n.getNodeType() != Node.TEXT_NODE)
			throw new SAXException(String.format(
					"XML Element %s does not contain text.", getQName(e)));
