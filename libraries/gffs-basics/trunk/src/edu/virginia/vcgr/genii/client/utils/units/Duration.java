...
public class Duration extends UnitableValue<DurationUnits>
{
	...
	static public final long MILLISECONDS_PER_YEAR = DurationUnits.Years.multiplier();
	static public final long MILLISECONDS_PER_MONTH = DurationUnits.Months.multiplier();
	static public final long MILLISECONDS_PER_WEEK = DurationUnits.Weeks.multiplier();
	static public final long MILLISECONDS_PER_DAY = DurationUnits.Days.multiplier();
	static public final long MILLISECONDS_PER_HOUR = DurationUnits.Hours.multiplier();
	static public final long MILLISECONDS_PER_MINUTE = DurationUnits.Minutes.multiplier();
	static public final long MILLISECONDS_PER_SECOND = DurationUnits.Seconds.multiplier();
