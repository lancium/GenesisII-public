...
/**
 * A simple class to store a clock speed. Clock speeds are nothing more then longs indicating the number of cycles in the speed. What makes
 * this class special is it's ability to parse clock speed descriptions from strings.
 * 
 * @author mmm2a
 */
