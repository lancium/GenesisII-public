...
public enum ClockSpeedUnits {
	Hertz(1L, "Hz"), Kilohertz(1000L, "KHz"), Megahertz(1000L * 1000L, "MHz"), Gigahertz(
			1000L * 1000L * 1000L, "GHz"), Terahertz(
	...
	static public ClockSpeedUnits parse(String text) {
		...
		throw new IllegalArgumentException(String.format(
				"Can't match %s to a Clock Speed enumeration value.", text));
	}
}