...
public class Log4jHelper {
	...
	// retrieves the file used for logging on the appender called
	// "appenderName".
	// this only works if the appenderName exists, and if it is derived from
	// FileAppender.
	static public String queryLog4jFile(String appenderName) {
		// re-use the answer from last time, if there was an answer. the log
		// file will
