...
public enum DurationUnits {
	Milliseconds(1L, "ms", "milli", "millis", "millisecond", "milliseconds"), Seconds(
			1000L, "s", "sec", "secs", "second", "seconds"), Minutes(
			1000L * 60, "m", "min", "mins", "minute", "minutes"), Hours(
			1000L * 60 * 60, "h", "hr", "hrs", "hour", "hours"), Days(
			1000L * 60 * 60 * 24, "d", "dy", "dys", "day", "days"), Weeks(1000L
			* 60 * 60 * 24 * 7, "w", "wks", "week", "weeks"), Months(1000L * 60
			* 60 * 24 * 30, "mth", "mths", "mon", "mons", "month", "months"), Years(
	...
	static public DurationUnits parse(String text) {
		...
		throw new IllegalArgumentException(String.format(
				"Can't match %s to a Duration enumeration value.", text));
	}
}