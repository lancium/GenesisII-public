...
public enum SizeUnits {
	Bytes(1L, "B", "Byte"), Kilobytes(1024L, "KB", "K", "KBs", "Kilobyte"), Megabytes(
			1024L * 1024L, "MB", "M", "MBs", "Megabyte"), Gigabytes(
			1024L * 1024L * 1024L, "GB", "G", "GBs", "Gigabyte"), Terabytes(
			1024L * 1024L * 1024L, "TB", "T", "TBs", "Terabyte");
	...
	static public SizeUnits parse(String text) {
		...
		throw new IllegalArgumentException(String.format(
				"Can't match %s to a Size Units enumeration value.", text));
	}
}
