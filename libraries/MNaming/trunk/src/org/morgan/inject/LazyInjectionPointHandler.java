...
class LazyInjectionPointHandler implements InvocationHandler {
	...
	public LazyInjectionPointHandler(MInjectFactory resolver,
			MInject injectInformation, Class<?> injectionTarget) {
		if (resolver == null)
			throw new IllegalArgumentException("Resolver cannot be null.");

		if (injectionTarget == null)
			throw new IllegalArgumentException(
					"Injection target cannot be null.");
	...
	public Object invoke(Object proxy, Method method, Object[] args)
		...
		synchronized (this) {
			if (_resolvedValue == null)
				_resolvedValue = _resolver.resolve(_injectInformation,
						_injectionTarget);
		}
