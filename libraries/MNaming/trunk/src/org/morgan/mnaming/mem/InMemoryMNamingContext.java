...
final public class InMemoryMNamingContext extends AbstractMNamingContext {
	...
	@Override
	final protected void bindLocal(String localName, Object value)
	...
	@Override
	final protected Object rebindLocal(String localName, Object value)
			throws MNamingException {
		synchronized (_values) {
	...
	@Override
	final protected Object removeLocal(String localName)
			throws MNamingException {
		synchronized (_values) {
	...
	@Override
	final protected Object lookupLocal(String localName)
			throws MNamingException {
		synchronized (_values) {
