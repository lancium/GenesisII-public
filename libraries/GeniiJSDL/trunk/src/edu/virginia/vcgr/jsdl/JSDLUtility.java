...
/**
 * This utility class provides a singleton JAXBContext that can be used to create JAXB Marshallers and Unmarshallers for XML serializing and
...
{
	/**
	 * The singleton JAXBContext that one should by default use to create JSDL Marshallers and Unmarshallers.
	 */
