 ...
 */
public class OperatingSystemNameElement extends CommonJSDLElement
{
	...
	public OperatingSystemNameElement(OperatingSystemNames osName)
	{
		_osName = osName;
	}

	public OperatingSystemNameElement()
	{
		this(null);
	}
