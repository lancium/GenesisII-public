...
/**
 * The DirectoryName class represents an HPC Profile Application extension element that indicates the name of a directory (used inside the
 * application element when overriding the working directory element).
 * 
