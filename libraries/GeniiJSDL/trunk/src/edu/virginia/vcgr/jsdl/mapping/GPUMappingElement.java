 ...
 */
class GPUMappingElement
{
	@XmlAttribute(name = "java-value", required = true)
	private String _javaValue;

	@XmlAttribute(name = "jsdl-value", required = true)
	private GPUProcessorArchitecture _arch;

	@SuppressWarnings("unused")
	private void afterUnmarshal(Unmarshaller u, Object parent) throws JAXBException
	{
		if (_javaValue == null)
			throw new JAXBException("Error trying to xml unmarshall GPU mapping:  " + "java-value was null.");

		if (_arch == null)
			throw new JAXBException("Error trying to xml unmarshall GPU mapping:  " + "jsdl-value was null.");
	}
	 ...
	 */
	@SuppressWarnings("unused")
	private GPUMappingElement()
	{
	}

	GPUMappingElement(String javaValue, GPUProcessorArchitecture arch)
	{
	...
	final GPUProcessorArchitecture architecture()
	{
		return _arch;
	}
}
