...
@XmlType(propOrder = { "_executable", "_arguments", "_input", "_output", "_error", "_workingDirectory", "_environmentVariables", "_userName",
	"_numberOfProcesses", "_processesPerHost", "_threadsPerProcess", "_spmdVariation" })
