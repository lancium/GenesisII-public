...
/**
 * The SweepListener interface is a callback interface implemented by callers that wish to receive the results of parameter sweep operations.
 * When a caller wishes to "expand" the job definitions represented by a parameter sweep, s/he uses this callback to receive the generated
 * singleton jobs.
 * 
