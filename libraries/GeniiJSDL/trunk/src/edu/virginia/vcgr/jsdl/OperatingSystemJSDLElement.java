...
public class OperatingSystemJSDLElement extends CommonJSDLElement
{
	static final long serialVersionUID = 0L;

	@XmlElement(namespace = JSDLConstants.JSDL_NS, name = "OperatingSystemType")
	private OperatingSystemNameElement _osType = null;
	...
	public OperatingSystemJSDLElement(OperatingSystemNameElement osType)
	{
		_osType = osType;
	}

	public OperatingSystemJSDLElement()
	{
		this(null);
	}

	final public void osType(OperatingSystemNameElement osType)
	{
		_osType = osType;
	}

	final public OperatingSystemNameElement osType()
	{
		return _osType;
	}
