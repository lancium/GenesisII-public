 ...
 */
@XmlType(propOrder = { "_executable", "_arguments", "_input", "_output", "_error", "_workingDirectory", "_environmentVariables",
	"_wallTimeLimit", "_fileSizeLimit", "_coreDumpLimit", "_dataSegmentLimit", "_lockedMemoryLimit", "_memoryLimit", "_openDescriptorsLimit",
	"_pipeSizeLimit", "_stackSizeLimit", "_cpuTimeLimit", "_processCountLimit", "_virtualMemoryLimit", "_threadCountLimit", "_userName",
	"_groupName" })
