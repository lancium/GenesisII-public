...
class PageContextDescription {
	...
	PageContextDescription(String context, String resourceBase,
			String injectionHandlerFactoryClassName)
			throws ClassNotFoundException, InstantiationException,
			IllegalAccessException {
		_context = context;
		_resourceBase = resourceBase;

		Class<? extends ObjectInjectionHandlerFactory> factoryClass = (Class<? extends ObjectInjectionHandlerFactory>) Thread
