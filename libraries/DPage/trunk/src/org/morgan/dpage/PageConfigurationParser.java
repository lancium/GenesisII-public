...
class PageConfigurationParser extends DefaultHandler
{
	...
	public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException
	{
		if (qName.equals("page")) {
			...
			String injectionHandlerFactoryClassName = attributes.getValue("injection-handler-factory");
			if (injectionHandlerFactoryClassName == null)
				injectionHandlerFactoryClassName = NullValueInjectionHandlerFactory.class.getName();

			if (context == null)
				throw new SAXParseException("Page element missing required \"context\" attribute.", _locator);
