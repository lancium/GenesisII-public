...
public abstract class AbstractFilesystem implements Filesystem
{
	...
	public Object clone()
	{
		throw new UnsupportedOperationException("Clone not supported in this class.");
	}

	@Override
	public FileSystem toJSDLFilesystem()
	{
		throw new UnsupportedOperationException(String.format("Can't generate JSDL for filesystem %s", this));
	}
}