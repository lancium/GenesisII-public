...
public class WallclockPanel extends TitledPanel {
	...
	WallclockPanel(JobDocumentContext context) {
		...
		JSpinner upperBound = new UnitValueSpinner(
				new UnitValueSpinnerModel<FriendlyTimeUnit>(currentLimit, 1,
						Long.MAX_VALUE, 1));
		TimeUnitComboBox upperBoundUnit = new TimeUnitComboBox(currentLimit);

		add(new JLabel("Wallclock Time Limit"), new GridBagConstraints(0, 0, 1,
				1, 0.0, 1.0, GridBagConstraints.NORTHWEST,
