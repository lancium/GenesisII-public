...
public class ArgumentsPanel extends JPanel {
	...
	public ArgumentsPanel(FilesystemMap filesystemMap,
		...
		add(new JLabel("Arguments"), new GridBagConstraints(0, 0, 1, 1, 1.0,
		...
		add(ButtonPanel.createHorizontalPanel(new SimpleIconButton(
				...
				ShapeIcons.Minus, _minusAction), null, new SimpleIconButton(
				ShapeIcons.UpArrow, _upAction), new SimpleIconButton(
				ShapeIcons.DownArrow, _downAction)), new GridBagConstraints(0,
	...
	private class ListSelectionListenerImpl implements ListSelectionListener {
		...
		public void valueChanged(ListSelectionEvent e) {
			...
			_downAction
					.setEnabled(num == 1
							&& _table.getSelectedRow() < (_tableModel
									.getRowCount() - 1));
		}
	}
}