...
class SPMDVariationComboModel extends AbstractListModel implements ComboBoxModel
{
	...
	{
		_selection = null;
		_elements = new Vector<SPMDVariation>(Configuration.configuration.spmdVariations().values());
