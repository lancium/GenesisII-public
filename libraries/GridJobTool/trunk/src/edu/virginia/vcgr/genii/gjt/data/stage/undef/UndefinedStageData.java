...
public class UndefinedStageData extends AbstractStageData
{
	...
	{
		analysis.addError("A data stage for file \"%s\" is not defined.", filename);
	}

	@Override
	public String getJSDLURI()
	{
		throw new UnsupportedOperationException("Can't get the JSDL URI for an undefined data stage type.");
	}
}
