...
public class DataStageCellEditor extends AbstractCellEditor implements
		TableCellEditor {
	...
	private class EditAction extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			if (_currentValue.edit(SwingUtilities
					.getWindowAncestor((JComponent) e.getSource())) != null)
				fireEditingStopped();
			else
				fireEditingCanceled();
		}
