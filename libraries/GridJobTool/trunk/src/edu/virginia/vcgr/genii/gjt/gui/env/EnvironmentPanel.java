...
public class EnvironmentPanel extends JPanel
{
	...
	public EnvironmentPanel(FilesystemMap filesystemMap, EnvironmentList environment)
	{
		super(new GridBagLayout());

		setPreferredSize(SIZE);

		EnvironmentTable table = new EnvironmentTable(filesystemMap, environment);
		EnvironmentTableModel model = (EnvironmentTableModel) table.getModel();
		_table = table;
		_tableModel = model;

		add(new JLabel("Environment"), new GridBagConstraints(0, 0, 1, 1, 1.0, 0.0, GridBagConstraints.WEST,
