...
class OperatingSystemPanel extends TitledPanel
{
	...
	OperatingSystemPanel(JobDocumentContext context)
	{
		...
		ParameterizableStringField osVersion =
			new ParameterizableStringField(context.jobDocument().operatingSystemVersion(), 8);
		...
		add(new JLabel("Type"), new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
			new Insets(5, 5, 5, 5), 5, 5));
		add(osCombo, new GridBagConstraints(1, 0, 1, 1, 1.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
			new Insets(5, 5, 5, 5), 5, 5));
		add(new JLabel("Version"), new GridBagConstraints(0, 1, 1, 1, 0.0, 1.0, GridBagConstraints.NORTHWEST,
