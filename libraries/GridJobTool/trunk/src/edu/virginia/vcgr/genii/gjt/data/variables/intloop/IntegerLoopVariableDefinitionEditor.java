...
public class IntegerLoopVariableDefinitionEditor extends
		VariableDefinitionEditor<IntegerLoopVariableDefinition> {
	static final long serialVersionUID = 0L;

	private SpinnerNumberModel _start = new SpinnerNumberModel(0,
			Integer.MIN_VALUE, Integer.MAX_VALUE, 1);
	private SpinnerNumberModel _stop = new SpinnerNumberModel(0,
			Integer.MIN_VALUE, Integer.MAX_VALUE, 1);
	private SpinnerNumberModel _step = new SpinnerNumberModel(1, 1,
			Integer.MAX_VALUE, 1);

	@Override
	public IntegerLoopVariableDefinition getVariableDefinitionImpl() {
		return new IntegerLoopVariableDefinition(_start.getNumber().intValue(),
				_stop.getNumber().intValue(), _step.getNumber().intValue());
	}
	...
	public void setFromVariableDefinition(
			IntegerLoopVariableDefinition variableDefinition) {
