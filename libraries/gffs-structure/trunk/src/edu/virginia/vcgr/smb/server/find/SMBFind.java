...
public class SMBFind
{
	...
	public static int encode(SMBSearchState search, int searchCount, boolean resume, int infoLevel, List<String> xattr, boolean unicode,
		SMBBuffer buffer) throws SMBException
	{
		switch (infoLevel) {
			case INFO_STANDARD:
