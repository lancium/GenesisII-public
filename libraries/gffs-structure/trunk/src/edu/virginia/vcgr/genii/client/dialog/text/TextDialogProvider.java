...
public class TextDialogProvider implements DialogProvider {
	...
	public InputDialog createHiddenInputDialog(String title, String prompt)
		...
		TextInputDialog dialog = (TextInputDialog) createInputDialog(title,
				prompt);
	...
	public InformationDialog createInformationDialog(String title,
			...
			UserCancelException {
		return new TextInformationDialog(title, _package, informationContent,
				false);
	}
	...
	public ComboBoxDialog createComboBoxDialog(String title, String prompt,
			...
			UserCancelException {
		return new TextComboBoxDialog(title, _package, prompt, defaultItem,
				items);
	}

	@Override
	public ComboBoxDialog createSingleListSelectionDialog(String title,
