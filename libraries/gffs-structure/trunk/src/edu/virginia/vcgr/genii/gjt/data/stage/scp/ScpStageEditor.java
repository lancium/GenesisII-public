...
class ScpStageEditor extends StageEditor<ScpStageData>
{
	...
	ScpStageEditor(Window owner)
	{
		...
		container.add(new JLabel("Username"),
			new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5, 5, 5, 5), 5, 5));
		...
		container.add(new JLabel("Password"),
			new GridBagConstraints(2, 2, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5, 5, 5, 5), 5, 5));
