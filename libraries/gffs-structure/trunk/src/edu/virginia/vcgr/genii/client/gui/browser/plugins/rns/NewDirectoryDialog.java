...
/**
 * This dialog box is displayed when the user has requested that a new directory
 * be created. It asks the user to give a name to that new directory.
 * 
 * @author mmm2a
 */
class NewDirectoryDialog extends JDialog {
	...
	private NewDirectoryDialog(JFrame parent) {
		...
		/*
		 * Don't allow the user to click on "X" in the corner to close this box.
		 * They MUST click cancel or OK.
		 */
		...
		contentPane.add(_input = new JFormattedTextField(formatter),
		...
		bottomPanel.add(new JButton(action), new GridBagConstraints(0, 0, 1, 1,
		...
		bottomPanel.add(cancel, new GridBagConstraints(1, 0, 1, 1, 1.0, 1.0,
				GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(
						5, 5, 5, 5), 5, 5));
		contentPane.add(bottomPanel, new GridBagConstraints(0, 1, 2, 1, 1.0,
	...
	/**
	 * The action that the OK button has to either perform actions or disable
	 * the button when the text in the text field is not appropriate to be a new
	 * directory name.
	 * 
	 * @author mmm2a
	 */
	...
	/**
	 * A helper method that creates the dialog box and uses it to get user
	 * input.
	 * 
	 * @param owner
	 *            The frame that should own the new dialog.
	 * @return The string name of the directory entered by the user, or null if
