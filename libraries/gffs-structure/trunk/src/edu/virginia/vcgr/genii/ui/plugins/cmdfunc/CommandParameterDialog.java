...
class CommandParameterDialog extends JDialog
{
	...
	private CommandParameterDialog(Component ownerComponent, JavaCommandFunction function)
	{
		...
		content.add(new JLabel(String.format("Parameters for Command Function \"%s\":", function)),
		...
		for (JavaCommandParameter parameter : function.parameters()) {
			...
			content.add(label, new GridBagConstraints(0, count, 1, 1, 0.0, 0.0, GridBagConstraints.EAST, GridBagConstraints.NONE,
