...
final class IDPLoginPanel extends LoginPanel
{
	...
	final public Collection<NuCredential> doLogin(UIContext uiContext) throws Throwable
	{
		...
		try {
			...
			UsernamePasswordIdentity upt =
				new UsernamePasswordIdentity(_username.getText(), new String(_password.getPassword()));

			TransientCredentials transientCredentials =
				TransientCredentials.getTransientCredentials(uiContext.callingContext());
