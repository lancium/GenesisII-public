...
public interface SByteIOTopics extends GenesisIIBaseTopics {
	...
	static final public TopicPath SBYTEIO_INSTANCE_DYING = TopicPath
			.createTopicPath(RESOURCE_TERMINATION_TOPIC, new QName(
					StreamableByteIORP.STREAMABLE_BYTEIO_NS,
