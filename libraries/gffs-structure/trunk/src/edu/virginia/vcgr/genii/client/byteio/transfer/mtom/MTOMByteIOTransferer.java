...
/**
 * An interface for all MTOM transferers. This interface is basically a convenient place to put some constants relevant to the MTOM transfer
 * protocol.
 * 
 * @author mmm2a
 */
public interface MTOMByteIOTransferer
{
	...
	static public final int PREFERRED_READ_SIZE = 1024 * 1024 * 8 * ByteIOConstants.NUMBER_OF_THREADS_FOR_BYTEIO_PARALLEL_READS;
