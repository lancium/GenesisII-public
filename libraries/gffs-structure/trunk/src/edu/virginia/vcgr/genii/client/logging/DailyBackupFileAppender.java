/*
 * Copied from the posted source for DailyRollingFileAppender.java from the log4j repositories, and
 * modified for use in the GenesisII framework for daily backups into RNS. I tried extending,
 * initially, but the methods and variables I wanted to Override were private to the class, so it
 * was actually more feasible to work from here.
 * 
 * Sorry Apache.
 */
...
public class DailyBackupFileAppender extends FileAppender {
	 ...
	 */
	public DailyBackupFileAppender(Layout layout, String filename,
			String localPath, String remotePath, String datePattern)
			throws IOException {
	...
	public void activateOptions() {
		...
		if (datePattern != null && fileName != null) {
			...
			remoteScheduledFilename = remoteFileName
					+ sdf.format(new Date(file.lastModified()));
	...
	protected void rollOver() throws IOException {
		...
		try {
			CopyTool.copy("local:" + scheduledFilename, "grid:"
					+ remoteScheduledFilename, false, false, null,
