...
public class ClientConstructionParameters {
	static public MessageElement createEndpointIdentifierProperty(
			org.apache.axis.types.URI epiURI) {
		MessageElement ret = new MessageElement(
	...
	static public org.apache.axis.types.URI getEndpointIdentifierProperty(
			MessageElement m)
