...
public class AdditionalUserData implements Serializable {
	...
	static public <Type extends AdditionalUserData> MessageElement toMessageElement(
			Type value) throws JAXBException {
		JAXBContext context = JAXBContext.newInstance(value.getClass());
		Marshaller m = context.createMarshaller();
		DOMResult result = new DOMResult();
		JAXBElement jaxbe = new JAXBElement(
				AdditionalUserDataConstants.ELEMENT_QNAME, value.getClass(),
				value);
	...
	static public <Type extends AdditionalUserData> Type fromElement(
			Class<Type> type, Element me) throws JAXBException {
