...
class ValueListVariableDefinitionEditor extends VariableDefinitionEditor<ValueListVariableDefinition>
{
	...
	public ValueListVariableDefinitionEditor(Window owner)
	{
		...
		container.add(new JLabel("Values"),
			new GridBagConstraints(0, 0, 1, 1, 1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5, 5, 0, 5), 0, 0));
		container.add(new JScrollPane(_list),
			new GridBagConstraints(0, 1, 1, 1, 1.0, 1.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 5, 5, 5), 0, 0));
		container.add(
	...
	@SuppressWarnings("unchecked")
	@Override
	public void setFromVariableDefinition(ValueListVariableDefinition variableDefinition)
	{
		_model.clear();
	...
	private class PlusAction extends AbstractAction
	{
		...
		{
			String answer = JOptionPane.showInputDialog(ValueListVariableDefinitionEditor.this, "What value would you like to add?",
