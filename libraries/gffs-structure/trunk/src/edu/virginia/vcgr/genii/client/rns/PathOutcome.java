...
public class PathOutcome {
	...
	// it indicates that a bounce occurred, but it should not be construed as a
	// failure
	// that should stop the tree traversal.
	public static final PathOutcome OUTCOME_CONTINUABLE = new PathOutcome(11);
	// this outcome indicates that an RNS path is not properly supporting EPIs,
	// which we
	...
	// some comparisons that still work if people construct their own
	// PathOutcomes.
	...
	/**
	 * returns a textual representation of the outcomes that are known about by
	 * this class.
	 */
