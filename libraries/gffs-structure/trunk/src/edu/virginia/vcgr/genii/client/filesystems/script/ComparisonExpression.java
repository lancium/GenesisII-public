...
abstract class ComparisonExpression implements BooleanExpression {
	...
	static private class LessComparisonExpression extends ComparisonExpression {
		...
		final public boolean evaluate(
			...
			return _left.evaluate(usageInformation) < _right
					.evaluate(usageInformation);
		}
	...
	static private class LessEqualsComparisonExpression extends
	...
	static private class NotEqualsComparisonExpression extends
			ComparisonExpression {
	...
	static private class EqualsComparisonExpression extends
			ComparisonExpression {
	...
	static private class GreaterEqualsComparisonExpression extends
			ComparisonExpression {
	...
	static private class GreaterComparisonExpression extends
			ComparisonExpression {
