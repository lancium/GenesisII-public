...
public class ApplicationDescriptionCreator {
	...
	static public EndpointReferenceType createApplicationDescription(
			EndpointReferenceType serviceEPR, String name,
			ApplicationVersion applicationVersion) throws CreationException {
		return ResourceCreator.createNewResource(serviceEPR,
				new MessageElement[] {
						new MessageElement(APPLICATION_NAME_CREATION_PARAMETER,
								name),
						new MessageElement(
								APPLICATION_VERSION_CREATION_PARAMETER,
