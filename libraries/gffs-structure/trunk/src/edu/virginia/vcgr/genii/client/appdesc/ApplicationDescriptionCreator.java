...
{
	static public QName APPLICATION_NAME_CREATION_PARAMETER = new QName(ApplicationDescriptionConstants.APPLICATION_DESCRIPTION_NS,
		"application-name");
	static public QName APPLICATION_VERSION_CREATION_PARAMETER = new QName(ApplicationDescriptionConstants.APPLICATION_DESCRIPTION_NS,
		"application-version");
	...
	{
		return ResourceCreator.createNewResource(
			serviceName,
			new MessageElement[] {
				new MessageElement(APPLICATION_NAME_CREATION_PARAMETER, name),
				new MessageElement(APPLICATION_VERSION_CREATION_PARAMETER, (applicationVersion == null) ? null : applicationVersion
					.toString()) }, null);
	}
}