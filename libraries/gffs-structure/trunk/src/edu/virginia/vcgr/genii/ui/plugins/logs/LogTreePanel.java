...
public class LogTreePanel extends JPanel {
	...
	public LogTreePanel(LogTree browserTree) {
		...
		add(new JScrollPane(browserTree), new GridBagConstraints(0, 0, 1, 1,
				1.0, 1.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,
				new Insets(5, 5, 5, 5), 5, 5));
		_browserTree = browserTree;

		String[] options = { "Display logs by...", "RPC-ID",
				"command/procedure" };
		...
		add(_displayByBox, new GridBagConstraints(0, 1, 1, 1, 1.0, 0.0,
