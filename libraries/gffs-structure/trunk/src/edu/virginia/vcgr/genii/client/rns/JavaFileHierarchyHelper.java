...
public class JavaFileHierarchyHelper implements TreeTraversalPathQuery<File> {
	static private Log _logger = LogFactory
			.getLog(JavaFileHierarchyHelper.class);

	public JavaFileHierarchyHelper() {
	}

	@Override
	public PathOutcome checkPathSanity(File path,
			TreeTraversalActionAlert<File> bounce) {
		if (path == null)
		...
		// for cycle detection, we rely on the tree traverser's depth limit.
		// currently there is
