...
public class ByteIOConstants
{
	...
	static public final String TRANSFER_TYPE_SIMPLE = "http://schemas.ggf.org/byteio/2005/10/transfer-mechanisms/simple";
	...
	static public QName SBYTEIO_SUBSCRIBE_CONSTRUCTION_PARAMETER = new QName(GenesisIIConstants.GENESISII_NS, "sbyteio-subscribe");
	...
	// the most threads we will use for reading chunks of byteio data in parallel.
