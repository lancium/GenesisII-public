...
/**
 * The long action runner is the wrapper class that wraps a long running action
 * and handles it inside of a seperate thread.
 * 
 * @author mmm2a
 */
class LongActionRunner implements Runnable {
	 ...
	 * 
	 * @param action
	 *            The long running action to handle.
	 * @param context
	 *            The action context to use for running the job.
	 */
