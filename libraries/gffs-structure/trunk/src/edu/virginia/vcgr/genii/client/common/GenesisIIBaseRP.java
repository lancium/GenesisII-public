...
public interface GenesisIIBaseRP {
	...
	static public final QName MATCHING_PARAMETER_ATTR_QNAME = new QName(
			GENII_COMMON_NS, MATCHING_PARAMETER_ATTR_NAME);
	...
	static public final QName AUTHZ_CONFIG_QNAME = new QName(
			AUTHZ_CONFIG_NAMESPACE, AUTHZ_CONFIG_NAME);

	static public final String PERMISSIONS_STRING_NAME = "Permissions";
	static public final QName PERMISSIONS_STRING_QNAME = new QName(
			GenesisIIConstants.GENESISII_NS, PERMISSIONS_STRING_NAME);
