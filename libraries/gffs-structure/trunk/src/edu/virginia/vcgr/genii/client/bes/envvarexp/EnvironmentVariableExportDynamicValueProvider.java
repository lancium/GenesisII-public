...
class EnvironmentVariableExportDynamicValueProvider implements
		EnvironmentVariableExportValueProvider {
	private EnvironmentVariableExportValueProvider _realProvider;

	@XmlAttribute(name = "class", required = true)
	private void setClassName(String className) throws InstantiationException,
			IllegalAccessException, ClassNotFoundException {
		_realProvider = (EnvironmentVariableExportValueProvider) (Class
