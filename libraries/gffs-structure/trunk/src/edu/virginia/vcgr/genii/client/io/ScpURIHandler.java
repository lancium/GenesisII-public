...
public class ScpURIHandler extends AbstractURIHandler {
	static private final String[] _HANDLED_PROTOCOLS = new String[] { "scp" };
	...
	protected DataTransferStatistics getInternal(URI source, File target,
		...
		return ScpUtility.get(target, user, password, host, port, remotePath,
				false);
	}
	...
	protected DataTransferStatistics putInternal(File source, URI target,
		...
		return ScpUtility.put(source, user, password, host, port, remotePath,
				false);
	}
