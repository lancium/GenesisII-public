...
public class BESConstants {
	...
	public final QName GENII_BES_NOTIFICATION_SUBSCRIBE_ELEMENT_QNAME = new QName(
			GENII_BES_NOTIFICATION_NS, GENII_BES_NOTIFICATION_SUBSCRIBE_ELEMENT);
	public final QName GENII_BES_NOTIFICATION_STATE_ELEMENT_QNAME = new QName(
			GENII_BES_NOTIFICATION_NS,
	...
	static public final String LOCAL_RESOURCE_MANAGER_TYPE_SIMPLE = LOCAL_RESOURCE_MANAGER_TYPE_BASE
			+ "simple";
	static public final String LOCAL_RESOURCE_MANAGER_TYPE_PBS = LOCAL_RESOURCE_MANAGER_TYPE_BASE
			+ "pbs";
	static public final String LOCAL_RESOURCE_MANAGER_TYPE_SGE = LOCAL_RESOURCE_MANAGER_TYPE_BASE
			+ "sge";
	static public final String LOCAL_RESOURCE_MANAGER_TYPE_GRID_QUEUE = LOCAL_RESOURCE_MANAGER_TYPE_BASE
			+ "grid-queue";
	...
	public final QName TOTAL_NUMBER_OF_ACTIVITIES_ATTR = new QName(
			GENII_BES_NS, "TotalNumberOfActivities");
	public final QName ACTIVITY_REFERENCE_ATTR = new QName(GENII_BES_NS,
			"ActivityReference");
	public final QName DESCRIPTION_ATTR = new QName(GENII_BES_NS, "Description");
	public final QName OPERATING_SYSTEM_ATTR = new QName(GENII_BES_NS,
			"OperatingSystem");
	public final QName CPU_ARCHITECTURE_ATTR = new QName(GENII_BES_NS,
			"CPUArchitecture");
	public final QName CPU_COUNT_ATTR = new QName(GENII_BES_NS, "CPUCount");
	public final QName BES_POLICY_ATTR = new QName(GENII_BES_NS,
			POLICY_RESOURCE_PROPERTY_NAME);
	public final QName BES_THRESHOLD_ATTR = new QName(GENII_BES_NS,
			THRESHOLD_RESOURCE_PROPERTY_NAME);
	public final QName OGRSH_VERSIONS_ATTR = new QName(GENII_BES_NS,
			"OGRSHVersion");
	public final QName SUPPORTS_FUSE_ATTR = new QName(GENII_BES_NS,
			"SupportsFuse");

	public final QName BES_WALLCLOCK_TIMELIMIT_ATTR = new QName(GENII_BES_NS,
			"WallclockTimeLimit");

	public final QName SPMD_PROVIDER_ATTR = new QName(GENII_BES_NS,
			"SPMDProvider");

	public final QName CPU_SPEED_ATTR = new QName(GenesisIIConstants.JSDL_NS,
			"IndividualCPUSpeed");
	public final QName PHYSICAL_MEMORY_ATTR = new QName(
			GenesisIIConstants.JSDL_NS, "PhysicalMemory");
	public final QName VIRTUAL_MEMORY_ATTR = new QName(
	...
	public final QName IS_ACCEPTING_NEW_ACTIVITIES_ATTR = new QName(
			GENII_BES_NS, IS_ACCEPTING_NEW_ACTIVITIES_NAME);

	public final QName FILESYSTEM_SUPPORT_ATTR = new QName(GENII_BES_NS,
