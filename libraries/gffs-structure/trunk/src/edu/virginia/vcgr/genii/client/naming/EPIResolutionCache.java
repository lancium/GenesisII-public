...
/**
 * The EPIResolutionCache class to maintain a cache of resolved EPRs for EPIs. The methods are currently all static and this class manages
 * synchronization isssues, etc.
 * 
