...
public class LogTreeNode extends DefaultMutableTreeNode
{
	...
	void expand(LogTree tree, DisplayByType type)
	{
		...
		model
			...
			.createMonitor(tree, null, null, 1000L * 1000,
				...
				new ExpansionCompletionListener(tree, model.uiPluginContext().uiContext())).start();
	}
	...
	private class ExpansionTask extends AbstractTask<LogPath[]>
	{
		...
		@Override
		public LogPath[] execute(TaskProgressListener progressListener) throws Exception
		{
	...
	private class ExpansionCompletionListener implements TaskCompletionListener<LogPath[]>
	{
