...
public enum InputBindingsType {
	DEFAULT("default", DefaultInputBindings.class), EMACS("emacs",
			EmacsInputBindings.class), VI("vi", ViInputBindings.class);

	private String _humanName;
	private Class<? extends InputBindings> _bindingsClass;

	private InputBindingsType(String humanName,
			Class<? extends InputBindings> bindingsClass) {
	...
	final public InputBindings createBindings() {
		try {
			...
			throw new ConfigurationException(
					"Unable to create input bindings.", e);
