 ...
 * @author kkk5z
 * 
 *         This is the class for the GUI used by the Information Service. It represent the properties from the AttributesDocument of the BES
 *         containers being monitored by the information service.
 */
...
public class QueryGUI extends JFrame
{
	...
	private void initComponents()
	{
			...
			.addGroup(layout.createSequentialGroup().addContainerGap()
				.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
					.addGroup(layout.createSequentialGroup()
						.addComponent(OperatingSystem, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
							javax.swing.GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED))
				.addGroup(layout.createSequentialGroup().addComponent(OSTypeLabel)
					.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(OSType)
					.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(OSVersionLabel)
					.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(OSVersion))
				.addGroup(
					layout.createSequentialGroup().addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(CPU))
				.addGroup(layout.createSequentialGroup().addComponent(CPUArchitectureNameLabel)
					.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(CPUArchitectureName))
				.addGroup(layout.createSequentialGroup().addComponent(CPUCountLabel)
					.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(CPUCount)
					.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(CPUSpeedLabel)
					.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(CPUSpeed))
				.addGroup(
					layout.createSequentialGroup().addComponent(Memory).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED))
				.addGroup(layout.createSequentialGroup().addComponent(PhysicalMamoryLabel)
					.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(PhysicalMemory)
					.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(VirtualMemoryLabel)
					.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(VirtualMemory))
				.addGroup(layout.createSequentialGroup().addComponent(IsAcceptingNewActivities)
					.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED))
				.addGroup(layout.createSequentialGroup().addComponent(CommonNameLabel).addComponent(CommonName)
					.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED))
				.addGroup(layout.createSequentialGroup().addComponent(TotalNumberOfActivitiesLabel).addComponent(TotalNumberOfActivities)
					.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED))
				.addGroup(layout.createSequentialGroup().addComponent(LocalResourceManagerTypeLabel).addComponent(LocalResourcemanagerType)
					.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED))
				.addGroup(layout.createSequentialGroup().addComponent(NamingProfileLabel).addComponent(NamingProfile)
					.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED))
		...
		layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] { OSTypeLabel, OSType, OSVersionLabel, OSVersion });
		layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] { CPUCountLabel, CPUCount, CPUSpeedLabel, CPUSpeed });
		layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] { CPUArchitectureNameLabel, CPUArchitectureName });
		layout.linkSize(javax.swing.SwingConstants.HORIZONTAL,
			new java.awt.Component[] { PhysicalMamoryLabel, PhysicalMemory, VirtualMemoryLabel, VirtualMemory });
		layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] { CommonNameLabel, CommonName });
		layout.linkSize(javax.swing.SwingConstants.HORIZONTAL,
			new java.awt.Component[] { TotalNumberOfActivitiesLabel, TotalNumberOfActivities });
		layout.linkSize(javax.swing.SwingConstants.HORIZONTAL,
			new java.awt.Component[] { LocalResourceManagerTypeLabel, LocalResourcemanagerType });
		...
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
			.addGroup(layout.createSequentialGroup().addContainerGap()
				.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(OperatingSystem,
					javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
			.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
			.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(OSTypeLabel).addComponent(OSType)
				.addComponent(OSVersionLabel).addComponent(OSVersion)).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
			.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(CPU))
			.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
			.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(CPUArchitectureNameLabel)
				.addComponent(CPUArchitectureName))
			.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
			.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(CPUCountLabel)
			...
			.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
			.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(PhysicalMamoryLabel)
				.addComponent(PhysicalMemory).addComponent(VirtualMemoryLabel).addComponent(VirtualMemory))
			.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
			.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(IsAcceptingNewActivities))
			.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
			.addGroup(
				layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(CommonNameLabel).addComponent(CommonName))
			.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
			.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(TotalNumberOfActivitiesLabel)
				.addComponent(TotalNumberOfActivities))
			.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
			.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(LocalResourceManagerTypeLabel)
				.addComponent(LocalResourcemanagerType))
			.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
			.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(NamingProfileLabel)
	...
	protected void submitButtonActionPerformed(ActionEvent evt)
	{
		...
		/*
		 * if the user wants to submit the so-formed query the values entered in the GUI are stored in the variable queryParameters
		 */
