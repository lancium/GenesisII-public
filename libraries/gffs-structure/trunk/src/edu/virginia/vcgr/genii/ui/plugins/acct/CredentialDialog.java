...
class CredentialDialog extends JDialog {
	...
	private CredentialDialog(Component ownerComponent, Connection connection)
			throws SQLException {
		...
		container.add(new JScrollPane(table), new GridBagConstraints(0, 0, 1,
	...
	static Collection<CredentialBundle> manageCredentials(Component owner,
