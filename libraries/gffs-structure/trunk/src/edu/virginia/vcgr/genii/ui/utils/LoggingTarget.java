...
/**
 * A per-program object that provides a pathway to the real target of diagnostic
 * and debugging information. This must be initialized by the owner of the
 * diagnostic target; until then, anything logged will be thrown on the floor.
 */
public class LoggingTarget {
	...
	public static synchronized boolean logInfo(String toConsume, Throwable cause) {
		if (_realTarget == null)
			return false; // nothing to log to currently.
