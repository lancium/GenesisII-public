...
public class DefaultOperatingSystemTypeFacet extends DefaultPersonalityFacet implements OperatingSystemTypeFacet
{
	@Override
	...
	{
		throw new UnsupportedJSDLElement(new QName(JSDLConstants.JSDL_NS, "OperatingSystemName"));
	}
}
