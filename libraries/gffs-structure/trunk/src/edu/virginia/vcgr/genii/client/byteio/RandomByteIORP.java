 ...
 * random byteio resource. As per the resource property translators in Genesis
 * II, this interface does not need to be realized as a class implementation --
 * rather, a dynamically generated proxy is created at runtime which has the
 * ability to retrieve and translate the correct attributes.
 * 
 * @author mmm2a
 */
