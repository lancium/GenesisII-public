...
/**
 * This exception is thrown when a fork/exec is attempted that fails with a
 * non-zero exit code.
 * 
 * @author mmm2a
 */
public class ScriptExecutionException extends NativeQueueException {
	 ...
	 * @param exitMessage
	 *            An exit message that was printed on stderr from the failed
	 *            command.
	 */
	...
	/**
	 * Form a useful error text from the command line and the exit message that
	 * the fork/exec'd application produced.
	 * 
	 * @param commandLine
