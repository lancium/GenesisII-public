...
/**
 * This class is used internally by the NewDirectoryDialog to ensure that the
 * directory name entered into the text field contains the appropriate
 * characters only.
 * 
 * @author mmm2a
 */
public class NewDirectoryName {
	static private Pattern _validDirectoryNamePattern = Pattern
			.compile("^[a-zA-Z0-9 .]*$");

	private String _directoryName;

	/**
	 * Create a new directory name with the appropriate characters for an RNS
	 * name.
	 * 
	 * @param name
