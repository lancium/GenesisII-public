...
public class SerializedContext implements Serializable {
	...
	public SerializedContext(byte[] data,
			HashMap<String, Serializable> transientProperties) {
		_data = data;
	...
	public Object readResolve() throws ObjectStreamException {
		...
		try {
			...
			/*
			 * CallingContextImpl context =
			 * (CallingContextImpl)ContextStreamUtils.load( new
			 * InflaterInputStream(bais));
			 */
			CallingContextImpl context = (CallingContextImpl) ContextStreamUtils
					.load(bais);
