...
public class SPMDVariation
{
	...
	{
		if (name == null)
			throw new IllegalArgumentException("SPMDVariation name cannot be null.");
		if (variationURI == null)
			throw new IllegalArgumentException("SPMDVariation URI cannot be null.");
	...
	{
		return _name.equals(other._name) && _variationURI.equals(other._variationURI);
	}
