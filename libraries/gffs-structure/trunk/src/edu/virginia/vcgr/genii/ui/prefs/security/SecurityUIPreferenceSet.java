...
public class SecurityUIPreferenceSet extends AbstractUIPreferenceSet {
	...
	protected void loadImpl(Preferences prefNode) {
		_verbosityLevel = VerbosityLevel.valueOf(prefNode.get(
				ACL_VERBOSITY_LEVEL_KEY, VerbosityLevel.LOW.name()));
	}
	...
	public void load(JPanel editor) {
		_verbosityLevel = ((SecurityUIPreferenceSetEditor) editor)
				.aclVerbosityLevel();
	}
