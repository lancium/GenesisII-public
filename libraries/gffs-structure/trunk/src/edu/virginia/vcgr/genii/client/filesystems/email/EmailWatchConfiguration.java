...
public class EmailWatchConfiguration
{
	...
	@XmlElement(namespace = "http://vcgr.cs.virginia.edu/filesystems/address-info", name = "addressing-info", required = true)
	private AddressInfoConfiguration _addr = null;

	@XmlElement(namespace = "http://vcgr.cs.virginia.edu/filesystems/email-watch", name = "subject", required = false)
	private String _subject = null;

	@XmlElement(namespace = "http://vcgr.cs.virginia.edu/filesystems/email-watch", name = "positive-subject", required = false)
	private String _positiveSubject = null;

	@XmlElement(namespace = "http://vcgr.cs.virginia.edu/filesystems/email-watch", name = "message", required = false)
