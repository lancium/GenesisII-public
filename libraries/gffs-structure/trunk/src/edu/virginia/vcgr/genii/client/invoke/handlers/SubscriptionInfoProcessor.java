...
public class SubscriptionInfoProcessor
{
	 ...
	 * the returned RNS entries to retrieve the address of notification-broker-factory, which is used to create a broker subscriber with pull
	 * point to retrieve updates on the the returned RNS entries, if it deemed useful. Finally, its place the current target endPoint in the
