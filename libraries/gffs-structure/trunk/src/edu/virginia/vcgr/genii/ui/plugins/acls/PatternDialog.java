...
class PatternDialog extends JDialog
{
	...
	private PatternDialog(Window owner, X509Identity issuingAuthority)
	{
		...
		content.add(new JButton(new SetPatternAction()),
			new GridBagConstraints(0, 3, 1, 1, 1.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(5, 5, 5, 5), 5, 5));
		content.add(new JButton(new CancelAction()),
			new GridBagConstraints(1, 3, 1, 1, 1.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(5, 5, 5, 5), 5, 5));
