...
public class MenuDialog<EntryType> extends JDialog implements ActionListener, ListSelectionListener
{
	...
	private MenuDialog(String title, String prompt, Collection<?> entries)
	{
		...
		container.add(new JScrollPane(_list = new JList(createListContents(entries))),
			new GridBagConstraints(0, 1, 2, 1, 1.0, 1.0, GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(5, 5, 5, 5), 5, 5));
