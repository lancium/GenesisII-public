...
{
	/**
	 * Constructs an object for recursing an RNS path. This takes 4 alert methods that will be invoked when (1) entering a directory, (2)
	 * leaving a directory, (3) hitting a file, and (4) encountering a cycle in the RNS hierarchy graph. It's okay for the alert functions to
	 * be null.
	 */
