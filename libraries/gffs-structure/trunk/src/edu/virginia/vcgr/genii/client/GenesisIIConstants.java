...
public class GenesisIIConstants {
	...
	/*
	 * a storage area in the calling context where the original TLS certificate
	 * can be remembered during container operations on behalf of the client.
	 */
	static public final String PASS_THROUGH_IDENTITY = "PassThroughIdentity";

	/*
	 * this holds onto the TLS certificate that the container saw from the
	 * client.
	 */
	...
	static public QName REGISTERED_TOPICS_ATTR_QNAME = new QName(GENESISII_NS,
			REGISTERED_TOPICS_ATTR);

	static public QName AUTHZ_CONFIG_ATTR_QNAME = new QName(
			"http://vcgr.cs.virginia.edu/genii/2008/12/security", "AuthZConfig");
	static public final String AUTHZ_CONFIG_ATTR = AUTHZ_CONFIG_ATTR_QNAME
			.getLocalPart();

	static public final String CACHE_COHERENCE_WINDOW_ATTR_NAME = "CacheCoherenceWindow";
	static public QName CACHE_COHERENCE_WINDOW_ATTR_QNAME = new QName(
			GENESISII_NS, CACHE_COHERENCE_WINDOW_ATTR_NAME);

	static public final String SCHED_TERM_TIME_PROPERTY_NAME = "scheduled-termintation-time";

	static public QName RESOURCE_PROPERTY_NAMES_QNAME = new QName(OGSA_BP_NS,
			"ResourcePropertyNames");

	static public QName GLOBAL_PROPERTY_SECTION_NAME = new QName(
			GenesisIIConstants.GENESISII_NS, "global-properties");

	static public QName CONTEXT_INFORMATION_QNAME = new QName(
			GenesisIIConstants.GENESISII_NS, "calling-context");
	...
	static public final String EXECUTION_ENGINE_THREAD_POOL_SIZE_PROPERTY = "edu.virginia.vcgr.genii.container.production.bes.thread-pool-size";
	...
	static public QName RNS_CACHED_METADATA_DOCUMENT_QNAME = new QName(
			GENESISII_NS, "rns-cached-metadata");
	...
	static final public QName COMMAND_FUNCTION_QNAME = new QName(
			WellKnownPortTypes.VCGR_COMMON_PORT_TYPE().getQName()
					.getNamespaceURI(), COMMAND_FUNCTION_NAME);

	static public QName NOTIFICATION_MESSAGE_ATTRIBUTES_SEPARATOR = new QName(
			GENESISII_NS, "notification-message-attributes-separator");

	static public final QName NOTIFICATION_BROKER_FACTORY_ADDRESS = new QName(
			GenesisIIConstants.GENESISII_NS, "NotificationBrokerFactory");
	...
	static public final QName DELEGATED_SAML_ASSERTIONS_QNAME = new QName(
			GENESISII_NS, DELEGATED_SAML_ASSERTIONS_NAME);

	static public final QName MYPROXY_QNAME = new QName(UNICORE_NS,
			MYPROXY_ATTRIBUTE_NAME);
	...
	static public final QName WSSE11_NS_SECURITY_QNAME = new QName(
			org.apache.ws.security.WSConstants.WSSE11_NS,
			"SecurityTokenReference");

	// our old namespace for wss, which has been outdated by using newer wss4j
	// library.
	...
	static public final QName INTERMEDIATE_WSE_NS_SECURITY_QNAME = new QName(
			INTERMEDIATE_WSE_NS, "SecurityTokenReference");
	...
	// all picture resources are expected to live in this path (within jars,
	// generally).
