...
public class SetContainerServicePropertiesTool extends BaseGridTool {
	...
	private SetResourceProperties generateSetRequest() {
		...
		addMessageElement(elements,
				ContainerConstants.PROPERTY_DOWNLOAD_TMPDIR, _downloadMgrTmpDir);
		addMessageElement(elements,
				ContainerConstants.PROPERTY_SCRATCH_SPACE_DIR, _scratchSpaceDir);

		SetResourceProperties ret = new SetResourceProperties(null,
				elements.size() == 0 ? null : new UpdateType(
