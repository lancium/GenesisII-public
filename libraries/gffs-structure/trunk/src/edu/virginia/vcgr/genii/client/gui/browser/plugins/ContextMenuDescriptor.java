...
public class ContextMenuDescriptor extends PluginDescriptor<IMenuPlugin>
{
	 ...
	 * @param plugin
	 *            The menu plugin that implements the functionallity of this menu plugin.
	 * @param menuLabel
	 *            The label that the menu should have for this plugin.
	 * @param menuGroup
	 *            A string name that helps to group plug-ins together in the context menu.
	 */
	public ContextMenuDescriptor(String pluginName, IMenuPlugin plugin, String menuLabel, String menuGroup)
	{
