...
public class ACLImages extends Images {
	...
	static {
		try {
			_everyoneImage = loadImage("everyone.png");
			_personImage = loadImage("person.png");
			_emptyPatternImage = loadImage("empty-pattern.png");
			_filledPatternImage = loadImage("filled-pattern.png");
