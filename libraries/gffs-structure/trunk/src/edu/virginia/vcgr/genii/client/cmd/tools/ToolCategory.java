...
public enum ToolCategory {
	...
	DATA(false, "Data"), HELP(false, "Help"), SECURITY(false, "Security"), MISC(
			false, "Misc"), INTERNAL(false, "Internal Use"), EXECUTION(false,
			"Job/Execution"), ANTIQUATED(false, "Antiquated"), GENERAL(false,
			"General"), ADMINISTRATION(false, "Administration");
