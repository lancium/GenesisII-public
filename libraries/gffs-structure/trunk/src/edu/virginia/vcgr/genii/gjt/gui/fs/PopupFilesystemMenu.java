...
public class PopupFilesystemMenu extends JPopupMenu
{
	...
	public PopupFilesystemMenu(FilesystemMap filesystemMap, FilesystemType filesystemType)
	{
		super(filesystemType.toString());

		add(new NewFilesystemDefinitionAction(filesystemMap, filesystemType));
		addSeparator();
		for (Duple<Calendar, Filesystem> recent : FilesystemRecents.instance(filesystemType).recents())
