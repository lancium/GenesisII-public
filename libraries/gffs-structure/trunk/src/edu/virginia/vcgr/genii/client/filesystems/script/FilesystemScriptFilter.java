...
public class FilesystemScriptFilter implements FilesystemWatchFilter {
	...
	static final private QName LESS_EQUALS_ELEMENT = new QName(SCRIPT_NS,
			"less-equals");
	static final private QName NOT_EQUALS_ELEMENT = new QName(SCRIPT_NS,
			"not-equals");
	static final private QName EQUALS_ELEMENT = new QName(SCRIPT_NS, "equals");
	static final private QName GREATER_EQUALS_ELEMENT = new QName(SCRIPT_NS,
			"greater-equals");
	static final private QName GREATER_ELEMENT = new QName(SCRIPT_NS, "greater");
	static final private QName VARIABLE_ELEMENT = new QName(SCRIPT_NS,
			"variable");
	...
	static private NumericValueExpression parseNumericValueExpression(
		...
		if (name.equals(VARIABLE_ELEMENT)) {
			...
			throw new FilterScriptException(String.format(
					"%s element is not a value element.", name));
		}
	}
	...
	static private BooleanExpression parseBinaryValueExpression(
		...
		return ComparisonExpression.createComparisonExpression(left, operator,
				right);
	}
	...
	static private BooleanExpression parseBooleanExpression(Element node)
		...
		if (name.equals(AND_ELEMENT)) {
			...
			return parseBinaryValueExpression(
			...
			throw new FilterScriptException(String.format(
					"Unexpectd element \"%s\" encountered.", name));
	}
	...
	static public void main(String[] args) throws Throwable {
		...
		InputStream in = FilesystemScriptFilter.class
				.getResourceAsStream("example-script.xml");
