...
public class ResourcePathsWidget extends JComponent
{
	...
	public ResourcePathsWidget(boolean getLocalPath, boolean getContainerPath, String ContainerPath, String TargetPath)
	{
		...
		if (getLocalPath) {
			...
			if (browseLocal != null)
				add(browseLocal, new GridBagConstraints(2, 0, 1, 1, 0.0, 1.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(
					5, 5, 5, 5), 5, 5));
		} else {
		...
		if (getContainerPath) {
			...
			add(_containerLabel = new JLabel(_CONTAINER_LABEL), new GridBagConstraints(0, 2, 1, 1, 0.0, 1.0, GridBagConstraints.WEST,
