...
public class WellKnownPortTypes
{
	...
	{
		return PortType.portTypeFactory().get(
			new QName("http://vcgr.cs.virginia.edu/genii/2010/08/notification", "GeniiWSNBrokerPortType"));
	}
	...
	{
		return PortType.portTypeFactory().get(
			new QName("http://vcgr.cs.virginia.edu/genii/2006/12/resource-factory", "GeniiResourceFactory"));
	}

	static public PortType GENII_RESOURCE_ATTRS_PORT_TYPE()
	{
		return PortType.portTypeFactory().get(
			new QName("http://vcgr.cs.virginia.edu/genii/2006/12/resource-attrs", "GeniiResourceAttrs"));
	}

	static public PortType GENII_RESOURCE_AUTHZ_PORT_TYPE()
	{
		return PortType.portTypeFactory().get(
			new QName("http://vcgr.cs.virginia.edu/genii/2006/12/resource-authz", "GeniiResourceAuthz"));
	}
	...
	{
		return PortType.portTypeFactory().get(
			new QName("http://vcgr.cs.virginia.edu/counter/2006/06/counter", "CounterPortType"));
	}
	...
	{
		return PortType.portTypeFactory().get(
			new QName("http://vcgr.cs.virginia.edu/genii/2007/01/scheduler", "SchedulerPortType"));
	}
	...
	{
		return PortType.portTypeFactory().get(
			new QName("http://vcgr.cs.virginia.edu/container/2008/04/enhanced-rns", "EnhancedRNSPortType"));
	}

	static public PortType RBYTEIO_SERVICE_PORT_TYPE()
	{
		return PortType.portTypeFactory().get(
			new QName("http://schemas.ggf.org/byteio/2005/10/random-access", "RandomByteIOPortType"));
	}
	...
	{
		return PortType.portTypeFactory().get(
			new QName("http://vcgr.cs.virginia.edu/sbyteio/2006/11/factory", "StreamableByteIOFactory"));
	}

	static public PortType EXPORTED_ROOT_SERVICE_PORT_TYPE()
	{
		return PortType.portTypeFactory().get(
			new QName("http://vcgr.cs.virginia.edu/rns/2006/08/exported-root", "ExportedRootPortType"));
	}
	...
	{
		return PortType.portTypeFactory().get(
			new QName("http://vcgr.cs.virginia.edu/byteio/2006/08/exported-file", "ExportedFilePortType"));
	}

	static public PortType EXPORTED_DIR_SERVICE_PORT_TYPE()
	{
		return PortType.portTypeFactory().get(
			new QName("http://vcgr.cs.virginia.edu/rns/2006/08/exported-dir", "ExportedDirPortType"));
	}

	static public PortType VCGR_CONTAINER_SERVICE_PORT_TYPE()
	{
		return PortType.portTypeFactory().get(
			new QName("http://vcgr.cs.virginia.edu/container/2006/07/container", "VCGRContainerPortType"));
	}
	...
	{
		return PortType.portTypeFactory().get(
			new QName("http://vcgr.cs.virginia.edu/container/2007/11/x509-authn", "X509AuthnPortType"));
	}

	static public PortType JNDI_AUTHN_SERVICE_PORT_TYPE()
	{
		return PortType.portTypeFactory().get(
			new QName("http://vcgr.cs.virginia.edu/container/2007/11/jndi-authn", "JNDIAuthnPortType"));
	}

	static public PortType KERB_AUTHN_SERVICE_PORT_TYPE()
	{
		return PortType.portTypeFactory().get(
			new QName("http://vcgr.cs.virginia.edu/container/2007/11/kerb-authn", "KerbAuthnPortType"));
	}
	...
	{
		return PortType.portTypeFactory().get(
			new QName("http://vcgr.cs.virginia.edu/genii/genii-resolver", "GeniiResolverPortType"));
	}
	...
	{
		return PortType.portTypeFactory().get(
			new QName("http://vcgr.cs.virginia.edu/rns/2007/08/rexport-dir", "RExportDirPortType"));
	}

	static public PortType GENII_FACTORY_PORT_TYPE()
	{
		return PortType.portTypeFactory().get(
			new QName("http://vcgr.cs.virginia.edu/genii/2006/12/factory-pattern", "GeniiFactoryPortType"));
	}

	static public PortType CERT_GENERATOR_SERVICE_PORT_TYPE()
	{
		return PortType.portTypeFactory().get(
			new QName("http://vcgr.cs.virginia.edu/genii/2007/08/certGenerator", "CertGeneratorPortType"));
	}

	static public PortType INFORMATION_SERVICE_PORT_TYPE()
	{
		return PortType.portTypeFactory().get(
			new QName("http://vcgr.cs.virginia.edu/genii/informationService", "InformationServicePortType"));
	}

	static public PortType GENESIS_DAI_CORE_DATA_ACCESS_COMBINED_PORT_TYPE()
	{
		return PortType.portTypeFactory().get(
			new QName("http://vcgr.cs.virginia.edu/genii/genesis_dai", "CoreDataAccessCombinedPortType"));
	}

	static public PortType GENESIS_DAI_WSRF_DATA_RESOURCE_PORT_TYPE()
	{
		return PortType.portTypeFactory().get(
			new QName("http://vcgr.cs.virginia.edu/genii/genesis_dai", "WSRFDataResourcePortType"));
	}

	static public PortType GENESIS_DAIR_SQL_ACCESS_COMBINED_PORT_TYPE()
	{
		return PortType.portTypeFactory().get(
			new QName("http://vcgr.cs.virginia.edu/genii/genesis_dair", "SQLAccessCombinedPortType"));
	}

	static public PortType GENESIS_DAIR_SQL_RESPONSE_COMBINED_PORT_TYPE()
	{
		return PortType.portTypeFactory().get(
			new QName("http://vcgr.cs.virginia.edu/genii/genesis_dair", "SQLResponseCombinedPortType"));
	}

	static public PortType GENESIS_DAIR_SQL_ROWSET_ACCESS_PORT_TYPE()
	{
		return PortType.portTypeFactory().get(
			new QName("http://vcgr.cs.virginia.edu/genii/genesis_dair", "SQLRowsetAccessPortType"));
	}
	...
	{
		return PortType.portTypeFactory().get(
			new QName("http://vcgr.cs.virginia.edu/genii/job-management", "JobManagementPortType"));
	}
	...
	{
		return PortType.portTypeFactory().get(
			new QName("http://vcgr.cs.virginia.edu/container/2011/07/enhanced-notification-broker",
