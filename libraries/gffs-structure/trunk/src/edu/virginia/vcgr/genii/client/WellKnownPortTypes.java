...
public class WellKnownPortTypes {
	static public PortType GENII_NOTIFICATION_PRODUCER_PORT_TYPE() {
		return PortType
				.portTypeFactory()
				.get(new QName(
						"http://vcgr.cs.virginia.edu/genii/2006/12/notification",
	...
	static public PortType GENII_WSNBROKER_PORT_TYPE() {
		return PortType
				.portTypeFactory()
				.get(new QName(
						"http://vcgr.cs.virginia.edu/genii/2010/08/notification",
	...
	static public PortType GENII_RESOURCE_FACTORY_PORT_TYPE() {
		return PortType
				.portTypeFactory()
				.get(new QName(
						"http://vcgr.cs.virginia.edu/genii/2006/12/resource-factory",
	...
	static public PortType GENII_RESOURCE_ATTRS_PORT_TYPE() {
		return PortType
				.portTypeFactory()
				.get(new QName(
						"http://vcgr.cs.virginia.edu/genii/2006/12/resource-attrs",
						"GeniiResourceAttrs"));
	}
	...
	static public PortType GENII_RESOURCE_AUTHZ_PORT_TYPE() {
		return PortType
				.portTypeFactory()
				.get(new QName(
						"http://vcgr.cs.virginia.edu/genii/2006/12/resource-authz",
						"GeniiResourceAuthz"));
	}
	...
	static public PortType COUNTER_PORT_TYPE() {
		return PortType.portTypeFactory().get(
				new QName(
						"http://vcgr.cs.virginia.edu/counter/2006/06/counter",
						"CounterPortType"));
	}

	static public PortType RESOURCE_FORK_PORT_TYPE() {
		return PortType.portTypeFactory().get(
				new QName("http://vcgr.cs.virginia.edu/genii/rfork",
	...
	static public PortType SCHEDULER_PORT_TYPE() {
		return PortType.portTypeFactory().get(
				new QName(
						"http://vcgr.cs.virginia.edu/genii/2007/01/scheduler",
						"SchedulerPortType"));
	}
	...
	static public PortType BASIC_SCHEDULER_PORT_TYPE() {
		return PortType
				.portTypeFactory()
				.get(new QName(
						"http://vcgr.cs.virginia.edu/genii/2007/01/scheduler/basic",
	...
	static public PortType SBYTEIO_FACTORY_PORT_TYPE() {
		return PortType.portTypeFactory().get(
				new QName(
						"http://vcgr.cs.virginia.edu/sbyteio/2006/11/factory",
	...
	static public PortType EXPORTED_ROOT_SERVICE_PORT_TYPE() {
		return PortType
				.portTypeFactory()
				.get(new QName(
						"http://vcgr.cs.virginia.edu/rns/2006/08/exported-root",
						"ExportedRootPortType"));
	}

	static public PortType EXPORTED_FSPROXY_ROOT_SERVICE_PORT_TYPE() {
		return PortType.portTypeFactory().get(
				new QName("http://vcgr.cs.virginia.edu/rns/2010/12/fsproxy",
						"FSProxyPortType"));
	}
	...
	static public PortType EXPORTED_LIGHTWEIGHT_ROOT_SERVICE_PORT_TYPE() {
		return PortType
				.portTypeFactory()
				.get(new QName(
						"http://vcgr.cs.virginia.edu/export/2009/05/light-export",
	...
	static public PortType EXPORTED_FILE_SERVICE_PORT_TYPE() {
		return PortType
				.portTypeFactory()
				.get(new QName(
						"http://vcgr.cs.virginia.edu/byteio/2006/08/exported-file",
	...
	static public PortType EXPORTED_DIR_SERVICE_PORT_TYPE() {
		return PortType.portTypeFactory().get(
				new QName(
						"http://vcgr.cs.virginia.edu/rns/2006/08/exported-dir",
						"ExportedDirPortType"));
	}
	...
	static public PortType VCGR_CONTAINER_SERVICE_PORT_TYPE() {
		return PortType
				.portTypeFactory()
				.get(new QName(
						"http://vcgr.cs.virginia.edu/container/2006/07/container",
	...
	static public PortType JNDI_AUTHN_SERVICE_PORT_TYPE() {
		return PortType
				.portTypeFactory()
				.get(new QName(
						"http://vcgr.cs.virginia.edu/container/2007/11/jndi-authn",
						"JNDIAuthnPortType"));
	}
	...
	static public PortType KERB_AUTHN_SERVICE_PORT_TYPE() {
		return PortType
				.portTypeFactory()
				.get(new QName(
						"http://vcgr.cs.virginia.edu/container/2007/11/kerb-authn",
						"KerbAuthnPortType"));
	}
	...
	static public PortType ENDPOINT_IDENTIFIER_RESOLVER_SERVICE_PORT_TYPE() {
		return PortType
				.portTypeFactory()
				.get(new QName(
						"http://schemas.ogf.org/naming/2006/08/naming/wsdl/EndpointIdentifierResolver",
	...
	static public PortType REFERENCE_RESOLVER_SERVICE_PORT_TYPE() {
		return PortType
				.portTypeFactory()
				.get(new QName(
						"http://schemas.ogf.org/naming/2006/08/naming/wsdl/ReferenceResolver",
						"ReferenceResolverPortType"));
	}

	static public PortType GENII_RESOLVER_PORT_TYPE() {
		return PortType.portTypeFactory().get(
				new QName("http://vcgr.cs.virginia.edu/genii/genii-resolver",
	...
	static public PortType REXPORT_RESOLVER_FACTORY_PORT_TYPE() {
		return PortType
				.portTypeFactory()
				.get(new QName(
						"http://vcgr.cs.virginia.edu/rns/2007/08/replicatedExport/resolver-factory",
	...
	static public PortType REXPORT_RESOLVER_PORT_TYPE() {
		return PortType
				.portTypeFactory()
				.get(new QName(
						"http://vcgr.cs.virginia.edu/rns/2007/08/replicatedExport/resolver",
	...
	static public PortType REXPORT_DIR_PORT_TYPE() {
		return PortType.portTypeFactory().get(
				new QName(
						"http://vcgr.cs.virginia.edu/rns/2007/08/rexport-dir",
						"RExportDirPortType"));
	}
	...
	static public PortType GENII_FACTORY_PORT_TYPE() {
		return PortType
				.portTypeFactory()
				.get(new QName(
						"http://vcgr.cs.virginia.edu/genii/2006/12/factory-pattern",
	...
	static public PortType CERT_GENERATOR_SERVICE_PORT_TYPE() {
		return PortType
				.portTypeFactory()
				.get(new QName(
						"http://vcgr.cs.virginia.edu/genii/2007/08/certGenerator",
	...
	static public PortType INFORMATION_SERVICE_PORT_TYPE() {
		return PortType.portTypeFactory().get(
				new QName(
						"http://vcgr.cs.virginia.edu/genii/informationService",
						"InformationServicePortType"));
	}

	static public PortType GENESIS_DAI_CORE_DATA_ACCESS_COMBINED_PORT_TYPE() {
		return PortType.portTypeFactory().get(
				new QName("http://vcgr.cs.virginia.edu/genii/genesis_dai",
	...
	static public PortType GENESIS_DAIR_SQL_ACCESS_COMBINED_PORT_TYPE() {
		return PortType.portTypeFactory().get(
				new QName("http://vcgr.cs.virginia.edu/genii/genesis_dair",
	...
	static public PortType JOB_MANAGEMENT_PORT_TYPE() {
		return PortType.portTypeFactory().get(
				new QName("http://vcgr.cs.virginia.edu/genii/job-management",
						"JobManagementPortType"));
	}

	static public PortType NOTIFICATION_PRODUCER_PORT_TYPE() {
		return PortType.portTypeFactory().get(
				new QName("http://docs.oasis-open.org/wsn/bw-2",
