...
import edu.virginia.vcgr.genii.client.jsdl.FilesystemFactory;
...
public class ExecutionFilesystemFacet extends DefaultFileSystemFacet {
	...
	public void consumeFileSystemType(Object currentUnderstanding,
			FileSystemTypeEnumeration fileSystemType) {
	...
	public void completeFacet(Object parentUnderstanding,
		...
		jr.addFilesystem(FilesystemFactory.getFilesystem(_filesystemName,
				_type, null, _mountSource));
	}
}