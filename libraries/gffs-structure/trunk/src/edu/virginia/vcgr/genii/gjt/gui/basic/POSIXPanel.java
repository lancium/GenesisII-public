...
public class POSIXPanel extends TitledPanel
{
	...
	POSIXPanel(JobDocument document)
	{
		...
		add(new JLabel("Executable"), new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
		...
		add(new EnvironmentPanel(document.filesystemMap(), document.environment()), new GridBagConstraints(0, 2, 3, 1, 1.0, 1.0,
			GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(5, 5, 5, 5), 5, 5));
	}
}