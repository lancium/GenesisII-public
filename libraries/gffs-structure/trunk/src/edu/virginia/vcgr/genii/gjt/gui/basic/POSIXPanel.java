...
public class POSIXPanel extends TitledPanel
{
	...
	POSIXPanel(JobDocument document)
	{
		...
		add(new JLabel("Executable"),
			new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5, 5, 5, 5), 5, 5));
		add(new ParameterizableStringField(document.executable(), 16), new GridBagConstraints(1, 0, 1, 1, 1.0, 0.0, GridBagConstraints.CENTER,
		...
		add(new ArgumentsPanel(document.filesystemMap(), document.arguments()),
			new GridBagConstraints(0, 1, 3, 1, 1.0, 1.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(5, 5, 5, 5), 5, 5));
		add(new EnvironmentPanel(document.filesystemMap(), document.environment()),
