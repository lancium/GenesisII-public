...
/**
 * The IMenuPlugin interface is the interface that all plugins which wish to participate in menus (be they main menus, or context menus) must
 * implement.
 * 
 * @author mmm2a
 */
public interface IMenuPlugin extends IPlugin
{
	 ...
	 * @param actionContext
	 *            An action context that the plugin can use to request context from the main browser frame and the RNS tree.
	 * 
