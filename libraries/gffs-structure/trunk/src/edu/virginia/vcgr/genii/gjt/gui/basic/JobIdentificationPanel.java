...
class JobIdentificationPanel extends TitledPanel
{
	...
	JobIdentificationPanel(JobDocument document)
	{
		...
		add(new JLabel("Job Annotations"),
		...
		add(new DescribedField<ParameterizableStringList>(document.jobAnnotations(), new ParameterizableStringListDescriber(),
			new ParameterizableStringListEditor("Job Annotations", "Enter new job annotation"), 16),
			new GridBagConstraints(3, 0, 1, 1, 1.0, 1.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(5, 5, 5, 5), 5,
				5));

		add(new JLabel("Job Projects"),
		...
		add(new DescribedField<ParameterizableStringList>(document.jobProjects(), new ParameterizableStringListDescriber(),
			new ParameterizableStringListEditor("Job Projects", "Enter new job project"), 16),
			new GridBagConstraints(1, 1, 1, 1, 1.0, 1.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(5, 5, 5, 5), 5,
				5));

		add(new JLabel("Job Description"),
			new GridBagConstraints(2, 1, 1, 1, 0.0, 1.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5, 5, 5, 5), 5, 5));
