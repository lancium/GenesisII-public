...
public abstract class AbstractSubscriptionFactory implements
		SubscriptionFactory {
	static public SubscribeRequest createRequest(
			EndpointReferenceType consumer, TopicQueryExpression topicFilter,
			TerminationTimeType terminationTime,
			AdditionalUserData additionalUserData,
			SubscriptionPolicy... policies) {
		return new SubscribeRequest(consumer, topicFilter, terminationTime,
	...
	@Override
	final public SubscribeRequest createRequest(
			TopicQueryExpression topicFilter,
			TerminationTimeType terminationTime,
			AdditionalUserData additionalUserData,
			SubscriptionPolicy... policies) {
		return createRequest(getConsumerReference(), topicFilter,
