...
public class NotificationBrokerConstants {
	...
	public static final QName INDIRECT_SUBSCRIPTION_TYPE = new QName(
			GenesisIIConstants.ENHANCED_NOTIFICATION_BROKER_NS,
			"SubscriptionType");

	public static final QName MESSAGE_INDEX_QNAME = new QName(
			GenesisIIConstants.ENHANCED_NOTIFICATION_BROKER_NS, "MessageIndex");
}
