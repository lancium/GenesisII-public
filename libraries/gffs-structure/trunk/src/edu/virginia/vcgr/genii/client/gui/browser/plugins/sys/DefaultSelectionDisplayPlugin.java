...
/**
 * This class implements the default tab plugin display which shows the RNS path and EPR of the selected instance.
 * 
 * @author mmm2a
 */
public class DefaultSelectionDisplayPlugin implements ITabPlugin
{
	...
	public Component getComponent(RNSPath[] selectedPaths) throws PluginException
	{
		...
		/*
		 * For each path that we were given, we will create a string document which has the appropriate text embedded to be displayed.
		 */
		...
		try {
			/*
			 * Now that we have the text that we want to display, we have to update the tab's component display to show that text.
			 */
