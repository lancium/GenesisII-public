...
public interface IProxyFactory
{
	...
	/**
	 * This method can be used to determine the EPR that a proxy (created by this same class (not necessarily same instance)) points to.
	 * 
	 * @param proxy
	 *            An object that was returned from the createClientProxy method above in this same class.
