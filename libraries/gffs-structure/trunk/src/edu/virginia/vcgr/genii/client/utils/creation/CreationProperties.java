...
/**
 * This class is a collection of utility functions that makes it easier to add
 * Java Properties to a creation message (the any element).
 * 
 * @author mmm2a
 */
public class CreationProperties {
	...
	static public final QName CREATION_PROPERTIES_QNAME = new QName(
			CREATION_PROPERTIES_NS, CREATION_PROPERTIES_NAME);
	...
	static public final QName CREATION_PROPERTY_QNAME = new QName(
			CREATION_PROPERTY_NS, CREATION_PROPERTY_NAME);

	static public final String CREATION_PROPERTY_NAME_ATTR = "name";
	static public final String CREATION_PROPERTY_VALUE_ATTR = "value";

	static public org.apache.axis.message.MessageElement translate(
			Properties properties) {
		try {
			org.apache.axis.message.MessageElement ret = new org.apache.axis.message.MessageElement(
					CREATION_PROPERTIES_QNAME);
			...
			throw new RuntimeException("Unable to create message properties "
					+ "for creation properties.", se);
		}
	}

	static public Properties translate(
		...
		while (iter.hasNext()) {
			org.apache.axis.message.MessageElement child = (org.apache.axis.message.MessageElement) iter
					.next();
	...
	static private org.apache.axis.message.MessageElement translate(String key,
			String value) {
		org.apache.axis.message.MessageElement ret = new org.apache.axis.message.MessageElement(
				CREATION_PROPERTY_QNAME);
	...
	static private void add(Properties props,
			org.apache.axis.message.MessageElement child) {
		...
		if (key == null || value == null)
			throw new RuntimeException(
					"Unable to parse creation property element.");
