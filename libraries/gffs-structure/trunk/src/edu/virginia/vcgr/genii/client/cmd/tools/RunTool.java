...
public class RunTool extends BaseGridTool
{
	...
	public ActivityState checkStatus(EndpointReferenceType activity) throws ResourceException, RemoteException
	{
		GeniiCommon common = ClientUtils.createProxy(GeniiCommon.class, activity);
		...
		throws ResourceException, RemoteException, RNSPathDoesNotExistException
	{
		...
		GetActivityStatusesResponseType resp =
			bes.getActivityStatuses(new GetActivityStatusesType(new EndpointReferenceType[] { activity }, null));
		return new ActivityState(resp.getResponse(0).getActivityStatus());
	}

	public EndpointReferenceType submitJob(String jsdlFileName, EndpointReferenceType besContainer, String optJobName,
		...
		RemoteException
	{
		...
		GetResourcePropertyResponse response = bes.getResourceProperty(bconsts.DEPLOYER_EPR_ATTR);
