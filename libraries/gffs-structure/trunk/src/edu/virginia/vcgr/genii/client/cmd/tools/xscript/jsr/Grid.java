...
public class Grid {
	...
	public Grid(Properties properties, BufferedReader stdin,
	...
	private int runCommandInternal(String command, String... arguments)
		...
		return new CommandLineRunner().runCommand(cLine, _stdout, _stderr,
				_stdin);
	}
	...
	public int runCommand(String command, String arg7, String arg8)
			throws Throwable {
		return runCommandInternal(command, arg7, arg8);
	}

	public int runCommand(String command, String arg6, String arg7, String arg8)
			throws Throwable {
	...
	public int runCommand(String command, String arg2, String arg3,
			...
			throws Throwable {
		return runCommandInternal(command, arg2, arg3, arg4, arg5, arg6, arg7,
				arg8);
	}
	...
	public int runCommand(String command, String arg1, String arg2,
		...
		return runCommandInternal(command, arg1, arg2, arg3, arg4, arg5, arg6,
				arg7, arg8);
	}
}
