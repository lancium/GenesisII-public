...
class StreamableByteIOFactoryOpenFile extends GeniiOpenFile {
	...
	StreamableByteIOFactoryOpenFile(String[] path,
		...
		_target = ClientUtils.createProxy(StreamableByteIOPortType.class,
				target);
		_file = new StreamableByteIOOpenFile(path, false, _target, canRead,
				canWrite, isAppend);
	}
