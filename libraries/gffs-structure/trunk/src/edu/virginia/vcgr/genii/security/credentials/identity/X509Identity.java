...
public class X509Identity extends edu.virginia.vcgr.genii.security.credentials.X509Identity
{
	...
	private Object readResolve() throws ObjectStreamException
	{
		if (_logger.isTraceEnabled())
			_logger.trace("old x509 load: type is " + _type + " for " + _identity[0].getSubjectDN());
		edu.virginia.vcgr.genii.security.credentials.X509Identity toReturn =
			new edu.virginia.vcgr.genii.security.credentials.X509Identity(_identity, _type);
