...
class HistoryEventDisplayDialog extends JDialog
{
	...
	static private Log _logger = LogFactory.getLog(HistoryEventDisplayDialog.class);
	...
	HistoryEventDisplayDialog(Window owner, UIContext context, HistoryEvent event)
	{
		this(owner, context);
	...
	HistoryEventDisplayDialog(Window owner, UIContext context)
	{
		...
		_categoryLabel.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createEtchedBorder(EtchedBorder.LOWERED),
			BorderFactory.createEmptyBorder(0, 2, 0, 2)));
