...
class HistoryEventDisplayDialog extends JDialog {
	...
	static private Log _logger = LogFactory
			.getLog(HistoryEventDisplayDialog.class);
	...
	private HistoryPropertiesTableModel _properties = new HistoryPropertiesTableModel();
	private JTextArea _detailsArea = new JTextArea();

	private JPanel createHeaderPanel() {
		JPanel panel = new JPanel(new GridBagLayout());

		panel.add(_headerLabel, new GridBagConstraints(0, 0, 1, 1, 1.0, 1.0,
				GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5,
						5, 5, 5), 5, 5));
		panel.add(_sourceLabel, new GridBagConstraints(1, 0, 1, 1, 1.0, 1.0,
	...
	private JPanel createTitlePanel() {
		...
		panel.add(new JLabel("Event Title"), new GridBagConstraints(0, 0, 1, 1,
				0.0, 1.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(5, 5, 5, 5), 5, 5));
		panel.add(_titleField, new GridBagConstraints(1, 0, 1, 1, 1.0, 1.0,
				GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5,
						5, 5, 5), 5, 5));
	...
	private JPanel createCategoryAndLevelPanel() {
		...
		panel.add(new JLabel("Event Level"), new GridBagConstraints(0, 0, 1, 1,
				0.0, 1.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(5, 5, 5, 5), 5, 5));
		panel.add(_levelLabel, new GridBagConstraints(1, 0, 1, 1, 0.0, 1.0,
				GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5,
						5, 5, 5), 5, 5));
		panel.add(new JLabel("Event Category"), new GridBagConstraints(2, 0, 1,
				1, 0.0, 1.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(5, 5, 5, 5), 5, 5));
		panel.add(_categoryLabel, new GridBagConstraints(3, 0, 1, 1, 1.0, 1.0,
				GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5,
						5, 5, 5), 5, 5));
	...
	HistoryEventDisplayDialog(Window owner, UIContext context) {
		...
		content.add(createHeaderPanel(), new GridBagConstraints(0, 0, 1, 1,
				1.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(5, 5, 5, 5), 5, 5));
		content.add(createTitlePanel(), new GridBagConstraints(0, 1, 1, 1, 1.0,
				0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL,
				new Insets(5, 5, 5, 5), 5, 5));
		content.add(createCategoryAndLevelPanel(), new GridBagConstraints(0, 2,
		...
		propertiesTable.getColumnModel().getColumn(0)
				.setHeaderValue("Property Name");
		propertiesTable.getColumnModel().getColumn(1)
				.setHeaderValue("Property Value");
	...
	void setEvent(HistoryEvent event) {
		...
		if (event == null) {
			...
			_headerLabel.setText(String.format(
					"Event %1$s occurred at %2$tr on %2$tF",
					event.eventNumber(), event.eventTimestamp()));
			_titleField.setText(event.eventData().toString());
			_levelLabel.setText(event.eventLevel().toString());
			_categoryLabel.setIcon(event.eventCategory().information()
					.categoryIcon());
