...
{
	/**
	 * Constructs an object for recursing a File. This takes 4 alert methods that will be invoked when (1) entering a directory, (2) leaving a
	 * directory, (3) hitting a file, and (4) encountering a cycle in the directory tree. It's okay for the alert functions to be null.
	 */
