...
/**
 * The ShowAttributesPlugin is a simple plugin which, in a tab, displays the
 * attributes document for a selected resource.
 * 
 * @author mmm2a
 */
public class ShowAttributesPlugin implements ITabPlugin {
	...
	public PluginStatus getStatus(RNSPath[] selectedResources)
			throws PluginException {
		/*
		 * If the currently selected paths exists and contains exactly one path
		 * endpoint, then we can show the attributes.
		 */
