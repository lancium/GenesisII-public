...
public class SystemUtils {
	 ...
	 * 
	 * static final private String _OS_ARCH_PREFIX = "os.arch."; static final
	 * private String _OS_NAME_PREFIX = "os.name.";
	 */
	...
	static public CPUArchitecture_Type[] getSupportedArchitectures() {
		 ...
		 * secondaryArchName = ProcessorArchitectureEnumeration.x86; else { try
		 * { String osName = System.getProperty("os.name"); if
		 * (osName.equals("Linux")) secondaryArchName =
		 * ProcessorArchitectureEnumeration.fromString(
		 * ExecutionEngine.simpleExecute("uname", "-m")); } catch (IOException
		 * ioe) { _logger.warn(
		 * "Unable to determine whether or not this JVM is running on a 64 bit machine."
		 * , ioe); } }
		 * 
		 * if (secondaryArchName != null) return new CPUArchitecture_Type[] {
		 * new CPUArchitecture_Type(primaryArchName, null), new
		 * CPUArchitecture_Type(secondaryArchName, null) };
		 * 
		 * return new CPUArchitecture_Type[] { new
		 * CPUArchitecture_Type(primaryArchName, null) };
		 */
	}
	...
	static public OperatingSystem_Type[] getSupportedOperatingSystems() {
		...
		/*
		 * OperatingSystemTypeEnumeration operatingSystemName; String
		 * operatingSystemVersion; String description = null;
		 * 
		 ...
		 * OperatingSystemType_Type(operatingSystemName, null),
