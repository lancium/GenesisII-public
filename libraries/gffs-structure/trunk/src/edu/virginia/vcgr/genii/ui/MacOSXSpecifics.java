...
public class MacOSXSpecifics {
	static private Class<?> getApplicationListenerInterface()
			throws ClassNotFoundException {
		return Class.forName("com.apple.eawt.ApplicationListener");
	}

	static private Object getApplicationObject() throws ClassNotFoundException,
	...
	static private Object getApplicationAdapterObject()
	...
	static private void callVoidMethod(Object instance, String methodName,
			Class<?>[] types, Object[] parameters) throws SecurityException,
	...
	static public void setupMacOSApplication(ApplicationContext context) {
		try {
			...
			callVoidMethod(application, "addAboutMenuItem", new Class<?>[0],
					new Object[0]);

			callVoidMethod(application, "addPreferencesMenuItem",
					new Class<?>[0], new Object[0]);
			callVoidMethod(application, "setEnabledAboutMenu",
					new Class<?>[] { boolean.class }, new Object[] { true });
			callVoidMethod(application, "setEnabledPreferencesMenu",
					new Class<?>[] { boolean.class }, new Object[] { true });

			callVoidMethod(
					application,
					"addApplicationListener",
					new Class<?>[] { getApplicationListenerInterface() },
					new Object[] { Proxy.newProxyInstance(
							GenesisClassLoader.classLoaderFactory(),
							new Class<?>[] { getApplicationListenerInterface() },
							new ApplicationListenerInvoker(context)) });
		} catch (RuntimeException re) {
			throw re;
		} catch (Throwable cause) {
			throw new RuntimeException(
					"Internal Error -- we think we are Mac OS X, but we aren't.",
					cause);
		}
	}

	static private class ApplicationListenerInvoker implements
			InvocationHandler {
		private ApplicationContext _context;
		private Object _applicationAdapter;

		static private void setApplicationEventHandled(Object eventObject,
				boolean result) throws SecurityException,
				IllegalArgumentException, NoSuchMethodException,
				IllegalAccessException, InvocationTargetException {
			callVoidMethod(eventObject, "setHandled",
					new Class<?>[] { boolean.class }, new Object[] { result });
		}
