...
public class GUIInternalStruct {
	...
	public GUIInternalStruct(String OSTypeValue, String OSVersionValue,
			String CPUArchitectureNameValue, String CPUCountValue,
			String CPUSpeedValue, String physicalMemoryValue,
			String virtualMemoryValue, String commonNameValue,
			String totalNumberOfActivitiesValue,
			String localResourceManagerValue, String namingProfileValue,
	...
	public void setIsAcceptingNewActivitiesValue(
