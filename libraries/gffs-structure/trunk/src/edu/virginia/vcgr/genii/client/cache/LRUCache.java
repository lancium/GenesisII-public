...
public class LRUCache<KeyType, DataType> extends
		LinkedHashMap<KeyType, DataType> {
	 ...
	 * new entry into the map. It provides the implementer with the opportunity
	 * to remove the eldest entry each time a new one is added.
	 */
