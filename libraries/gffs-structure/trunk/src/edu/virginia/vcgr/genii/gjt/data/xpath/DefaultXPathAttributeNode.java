...
public class DefaultXPathAttributeNode extends DefaultXPathNode implements XPathAttributeNode
{
	...
	{
		if (_namespaceURI == null || _namespaceURI.equals(XMLConstants.NULL_NS_URI))
			return _name;
