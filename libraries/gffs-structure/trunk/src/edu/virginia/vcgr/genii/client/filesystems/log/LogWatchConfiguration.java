...
{
	@XmlElement(namespace = "http://vcgr.cs.virginia.edu/filesystems/log-watch", name = "message", required = true)
	private String _messageFormat = null;

	@XmlElement(namespace = "http://vcgr.cs.virginia.edu/filesystems/log-watch", name = "level", required = false)
