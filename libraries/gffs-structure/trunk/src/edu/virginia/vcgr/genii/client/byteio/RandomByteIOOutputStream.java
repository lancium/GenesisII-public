...
/**
 * An implementation of the standard Java Output stream that writes to remote Random ByteIO resources.
 * 
 * @author mmm2a
 */
public class RandomByteIOOutputStream extends OutputStream
{
	 ...
	 *            The desired transfer protocol to use when writing bytes.
	 * 
	...
	/**
	 * A convenience method for creating a buffered stream (using the current transferer's preferred buffering size) from this output stream.
	 * 
