...
{
	/**
	 * Construct a new streamable byteio transferer factory for a given remote stub.
	 * 
	 * @param clientStub
	 ...
	 */
	public StreamableByteIOTransfererFactory(StreamableByteIOPortType clientStub) throws RemoteException, IOException
	{
		super(clientStub);
	}
	...
	{
		return new SimpleSByteIOTransferer((StreamableByteIOPortType) clientStub);
	}
	...
	public StreamableByteIOTransferer createStreamableByteIOTransferer(URI desiredTransferType) throws IOException
	{
	 ...
	 * @throws ConfigurationException
	 */
	public StreamableByteIOTransferer createStreamableByteIOTransferer() throws IOException
	{
