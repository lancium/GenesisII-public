...
public class StreamableByteIOTransfererFactory extends TransfererFactory {
	/**
	 * Construct a new streamable byteio transferer factory for a given remote
	 * stub.
	 * 
	 * @param clientStub
	 *            The remote client stub to use for outcoing calls.
	 * 
	 * @throws ConfigurationException
	 * @throws RemoteException
	 */
	public StreamableByteIOTransfererFactory(StreamableByteIOPortType clientStub)
	...
	/**
	 * A convenience method to create new StreamableByteIO transferers given the
	 * URI description of the transfer protocol to use.
	 * 
	 * @param desiredTransferType
	 *            The desired transfer protocol to use (if available). By
	 *            default, this factory will create an instance of a "preferred"
	...
	public StreamableByteIOTransferer createStreamableByteIOTransferer(
		...
		return (StreamableByteIOTransferer) createTransferer(desiredTransferType
				.toString());
	}
	...
	/**
	 * A convenience method to create a new streamable byteio transferer based
	 * off of a given target streamablebyteio.
	 * 
	 * @param target
	 *            The target for which to create a new StreamableByteIO
	 *            transferer agent.
	 * 
	...
	static public StreamableByteIOTransferer createStreamableByteIOTransferer(
			StreamableByteIOPortType target) throws RemoteException,
			IOException {
		return (new StreamableByteIOTransfererFactory(target))
				.createStreamableByteIOTransferer();
	}
	 ...
	 * 
	 * @param target
	 *            target The target for which to create a new StreamableByteIO
	 *            transferer agent.
	 * @param desiredTransferType
	 *            The transfer type (if any) that the caller wants to use. If
	 *            null, a "preferred" transfer type will be created.
	 * 
	...
	static public StreamableByteIOTransferer createStreamableByteIOTransferer(
			...
			throws RemoteException, IOException {
		return (new StreamableByteIOTransfererFactory(target))
				.createStreamableByteIOTransferer(desiredTransferType);
	}
}