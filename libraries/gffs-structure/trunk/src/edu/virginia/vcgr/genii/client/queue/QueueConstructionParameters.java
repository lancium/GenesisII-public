...
public class QueueConstructionParameters extends ConstructionParameters implements Serializable
{
	static final long serialVersionUID = 0L;

	static final public String QUEUE_CONS_PARMS_NS = "http://vcgr.cs.virginia.edu/construction-parameters/queue";
	...
	@XmlElement(namespace = QUEUE_CONS_PARMS_NS, name = "resource-overrides", required = false, nillable = true)
