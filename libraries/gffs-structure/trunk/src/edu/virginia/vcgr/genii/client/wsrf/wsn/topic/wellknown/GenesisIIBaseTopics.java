...
public interface GenesisIIBaseTopics {
	...
	static final public TopicPath RESOURCE_TERMINATION_TOPIC = TopicPath
			.createTopicPath(new QName(WSRFConstants.WSRF_RL_NS,
					"ResourceTermination", "wsrl"));

	@WSNTopic(contentsType = AuthZConfigUpdateNotification.class)
	static final public TopicPath AUTHZ_CONFIG_UPDATE_TOPIC = TopicPath
			.createTopicPath(new QName(GenesisIIConstants.GENESISII_NS,
