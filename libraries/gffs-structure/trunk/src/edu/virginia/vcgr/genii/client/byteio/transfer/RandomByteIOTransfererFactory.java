...
/**
 * A simple factory class for creating new RandomByteIO transferers. This class
 * merely serves as a convenient single point from which transferers can be
 * created.
 * 
 * @author mmm2a
 */
public class RandomByteIOTransfererFactory extends TransfererFactory {
	 ...
	 * 
	 * @param clientStub
	 *            The RandomByteIO client stub to use for outcalls from created
	 *            transferers.
	 * 
	...
	/**
	 * A convenience method to create new RandomByteIO transferers given the URI
	 * description of the transfer protocol to use.
	 * 
	...
	public RandomByteIOTransferer createRandomByteIOTransferer(
		...
		return (RandomByteIOTransferer) createTransferer(desiredTransferType
				.toString());
	}
	 ...
	 * 
	 * @param target
	 *            The target for which to create a new RandomByteIO transferer
	 *            agent.
	 * 
	...
	static public RandomByteIOTransferer createRandomByteIOTransferer(
			RandomByteIOPortType target) throws RemoteException, IOException {
		return (new RandomByteIOTransfererFactory(target))
	 ...
	 * 
	 * @param target
	 *            target The target for which to create a new RandomByteIO
	 *            transferer agent.
	 * @param desiredTransferType
	...
	static public RandomByteIOTransferer createRandomByteIOTransferer(
			...
			throws RemoteException, IOException {
		return (new RandomByteIOTransfererFactory(target))
				.createRandomByteIOTransferer(desiredTransferType);
	}
}