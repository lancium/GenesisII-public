...
public interface HPCConstants {
	...
	static public final QName HPC_APPLICATION_QNAME = new QName(HPC_NS,
			HPC_APPLICATION_NAME);
	static public final QName HPCP_CREDENTIAL_QNAME = new QName(HPCP_NS,
			"Credential");
	static public final QName USERNAME_TOKEN_QNAME = new QName(
			USERNAME_TOKEN_NS, USERNAME_TOKEN_NAME);
}