...
/**
 * Upgrades credentials that do not ordinarily produce Axis XML objects into
 * ones that do. This works on X509Identity, TrustCredential and
...
public class XMLConverter {
	...
	/**
	 * turns a simple NuCredential into an object that can produce Axis
	 * MessageElements, if there is any possible conversion. otherwise null is
	 * returned.
	 */
	public static XMLCompatible upscaleCredential(NuCredential toUpscale) {
		...
		// uh-oh.
		_logger.error("failed to upscale credential to XMLCompatible type: "
				+ toUpscale.toString());
		return null;
	}
}
