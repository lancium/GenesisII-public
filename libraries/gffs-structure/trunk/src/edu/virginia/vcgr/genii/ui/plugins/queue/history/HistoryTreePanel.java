...
class HistoryTreePanel extends JPanel {
	...
	HistoryTreePanel(UIContext context, RNSPath queue, String ticketNumber,
			Collection<HistoryEvent> events) {
		super(new GridBagLayout());

		HistoryUIPreferenceSet pref = context.preferences().preferenceSet(
				HistoryUIPreferenceSet.class);
		...
		add(new FilterPanel(filter), new GridBagConstraints(0, 0, 1, 1, 1.0,
