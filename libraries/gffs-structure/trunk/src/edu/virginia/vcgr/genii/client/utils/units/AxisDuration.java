...
public class AxisDuration extends Duration
{
	...
	public static org.apache.axis.types.Duration toApacheDuration(Duration toConvert)
	{
		int years;
		int days;
		int hours;
		...
		long millis = (long) toConvert.units().toMilliseconds(toConvert.value());
		...
		return new org.apache.axis.types.Duration(false, years, 0, days, hours, minutes, seconds);
	}

	public static Duration fromApacheDuration(org.apache.axis.types.Duration aDur)
	{
		if (aDur == null)
			return null;
