...
public class ByteIOAttributesUpdateNotification extends
	...
	public ByteIOAttributesUpdateNotification(long size, Calendar createTime,
			Calendar modificationTime, Calendar accessTime) {
		this();
		this.size = size;
