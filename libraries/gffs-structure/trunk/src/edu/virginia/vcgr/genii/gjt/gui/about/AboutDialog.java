...
public class AboutDialog extends JDialog
{
	...
	public AboutDialog(JDialog owner)
	{
		...
		JTextArea text = new JTextArea("Grid Job Tool\n\n" + VERSION_STRING + "\n\n"
		...
		container.add(icon,
			new GridBagConstraints(0, 0, 1, 1, 0.0, 1.0, GridBagConstraints.NORTH, GridBagConstraints.NONE, new Insets(5, 5, 5, 5), 5, 5));
		container.add(text,
			new GridBagConstraints(1, 0, 1, 1, 1.0, 1.0, GridBagConstraints.NORTH, GridBagConstraints.BOTH, new Insets(5, 5, 5, 5), 5, 5));
