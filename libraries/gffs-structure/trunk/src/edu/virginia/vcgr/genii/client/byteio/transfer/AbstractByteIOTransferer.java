...
public abstract class AbstractByteIOTransferer<Type> implements ByteIOTransferer
{
	 ...
	 */
	static protected byte[] receiveResponseAttachmentData(Object clientProxy) throws RemoteException
	{
	 ...
	 *            The transfer protocol that this instance (it's derived version) will support.
	 ...
	 */
	protected AbstractByteIOTransferer(Type clientStub, URI transferProcotol, int preferredReadSize, int maximumReadSize,
