...
public interface ILongRunningAction {
	/**
	 * This method is called by the dialog long running job manager when the
	 * long running action is given it's turn to compute.
	 * 
	 * @param actionContext
	 *            The action context that the long running action can use to
	 *            make requests back to the main dialog.
	 * 
	 * @throws Throwable
	 */
