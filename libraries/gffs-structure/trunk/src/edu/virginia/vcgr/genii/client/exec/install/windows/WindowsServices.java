...
public class WindowsServices
{
	static private class StartServiceTask extends AbstractExecutionTask
	{
		...
		{
			return new String[] { "net", "start", _name };
		}

		@Override
		public String toString()
		{
			return String.format("Start Windows Service \"%s\"", _name);
		}
	}
	...
	static private class StopServiceTask extends AbstractExecutionTask
	{
		...
		public String[] getCommandLine()
		{
			return new String[] { "net", "stop", _name };
		}

		@Override
		public String toString()
		{
			return String.format("Stop Windows Service \"%s\"", _name);
		}
	}
