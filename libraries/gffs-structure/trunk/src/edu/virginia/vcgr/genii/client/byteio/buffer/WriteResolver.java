 ...
 * write a set of bytes to some sink (ostensibly, a file, though that is not
 * required). This interface is used by the ByteIO cache to "flush" out the
 * bytes of a buffer to some "original" sink.
 * 
 * @author mmm2a
 */
