...
public class DefaultResourcesFacet extends DefaultPersonalityFacet implements
	...
	@Override
	public void consumeIndividualNetworkBandwidth(Object currentUnderstanding,
	...
	@Override
	public void consumeIndividualPhysicalMemory(Object currentUnderstanding,
			RangeExpression individualPhysicalMemory) throws JSDLException {
		throw new UnsupportedJSDLElement(new QName(JSDLConstants.JSDL_NS,
				"IndividualPhsyicalMemory"));
	}

	@Override
	public void consumeIndividualVirtualMemory(Object currentUnderstanding,
