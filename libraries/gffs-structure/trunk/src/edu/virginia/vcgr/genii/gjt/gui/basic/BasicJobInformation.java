...
public class BasicJobInformation extends JPanel
{
	...
	public BasicJobInformation(JobDocumentContext documentContext, int index)
	{
		super(new GridBagLayout());

		setName("Basic Job Information");

		add(new JobIdentificationPanel(documentContext.jobRoot().jobDocument().get(index)), new GridBagConstraints(0, 0, 1, 1, 1.0, 0.0,
			GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(5, 5, 5, 5), 5, 5));

		add(new POSIXPanel(documentContext.jobRoot().jobDocument().get(index)),
