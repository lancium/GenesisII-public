...
public interface OGSAWSRFBPConstants {
	...
	static public final QName CURRENT_TIME_ATTR_QNAME = new QName(WSRF_RL_NS,
			CURRENT_TIME_ATTR);
	static public final QName RESOURCE_ENDPOINT_REFERENCE_ATTR_QNAME = new QName(
			OGSA_WSRF_BP_NS, RESOURCE_ENDPOINT_REFERENCE_ATTR);
	...
	static public final QName WS_FINAL_RESOURCE_INTERFACE_ATTR_QNAME = new QName(
			OGSA_WSRF_BP_NS, WS_FINAL_RESOURCE_INTERFACE_ATTR);
