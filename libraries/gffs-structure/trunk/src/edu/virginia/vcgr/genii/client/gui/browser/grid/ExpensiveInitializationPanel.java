...
public abstract class ExpensiveInitializationPanel extends JPanel
{
	 ...
	 * 
	 * @param newComponent
	 *            The new component that the user finally resolved and wants displayed.
	 */
	...
	private class ComponentResolver implements Runnable
	{
		...
		public void run()
		{
			...
			try {
				...
				/*
				 * If anything goes wrong, display the exception instead in a text display.
				 */
	...
	private class ComponentSwitcher implements Runnable
	{
		...
		/**
		 * Create a new component switcher with the new component to replace the old one with.
		 * 
		 * @param newComponent
		 */
