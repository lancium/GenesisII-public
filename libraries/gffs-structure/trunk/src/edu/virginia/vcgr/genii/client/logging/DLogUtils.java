...
public class DLogUtils {
	...
	public static DLogDatabase addConnector(String databaseURL, String databaseUser,
			String databasePassword, String entryTable, String metaTable,
			String hierTable) {
		DLogDatabase ret = new DLogDatabase(
				databaseURL, databaseUser, databasePassword,
				entryTable, metaTable, hierTable);
		return ret;
	}

	private static EndpointReferenceType[] getLoggerEPRs(EndpointReferenceType epr) 
