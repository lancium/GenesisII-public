...
public class DurationTranslator implements SingleResourcePropertyTranslator {
	...
	public <Type> Type deserialize(Class<Type> clazz, MessageElement element)
		...
		if (!clazz
				.equals(edu.virginia.vcgr.genii.client.utils.units.Duration.class))
		...
		try {
			...
			edu.virginia.vcgr.genii.client.utils.units.Duration gDur = edu.virginia.vcgr.genii.client.utils.units.AxisDuration
