...
public class CommonCPUArchitectureFacet extends DefaultCPUArchitectureFacet {
	...
	public void consumeCPUArchitectureName(Object currentUnderstanding,
		...
		/*
		 * This has been causing us problems with BES containers that front end
		 * other machines. Instead, we're just going to ignore it.
		 */
		/*
		 * if
		 * (!JSDLUtils.getLocalCPUArchitecture().getCPUArchitectureName().equals
		 * (cpuArchitectureName )) throw new JSDLMatchException(String.format(
