...
public class CertGeneratorTool extends BaseGridTool
{
	...
	{
		super(new LoadFileResource(_DESCRIPTION), new LoadFileResource(_USAGE_RESOURCE), false, ToolCategory.SECURITY);
	}
		...
		GeneralSecurityException
	{
		...
		PublicKeyType newPublicKeyType = new PublicKeyType(SecurityUtilities.serializePublicKey(newPublicKey));
		...
		X509Certificate[] newCertChain = KeystoreManager.decodeCertificateChain(newCertChainType);
