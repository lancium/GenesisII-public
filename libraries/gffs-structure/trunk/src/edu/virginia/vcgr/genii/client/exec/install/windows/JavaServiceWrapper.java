...
public class JavaServiceWrapper
{
	static public abstract class JavaServiceWrapperTask extends AbstractExecutionTask
	{
		...
		protected JavaServiceWrapperTask(File wrapperExe, File configurationFile) throws IOException
		{
	...
	static private class InstallServiceWrapper extends JavaServiceWrapperTask
	{
		...
		public String[] getCommandLine()
		{
			...
			if (_password == null)
				...
				cLine.add(String.format("wrapper.ntservice.password=%s", _password));
			}
	...
	{
		public UninstallServiceWrapper(File wrapperExe, File configurationFile) throws IOException
		{
			super(wrapperExe, configurationFile);
		}
	...
	static public JavaServiceWrapperTask uninstallServiceWrapper(File wrapperExe, File configurationFile) throws IOException
	{
