...
public final class ResourceSecurityPolicy {
	...
	public ResourceSecurityPolicy(EndpointReferenceType epr)
			throws ResourcePropertyException, AuthZSecurityException,
			GeneralSecurityException {
		_propertyManager = (GenesisIIBaseRP) ResourcePropertyManager
				.createRPInterface(epr, GenesisIIBaseRP.class);
	...
	public void addResource(ResourceSecurityPolicy resource,
			RWXCategory category) throws AuthZSecurityException {
	...
	private static void copyFrom(Collection<AclEntry> src,
			Collection<AclEntry> dst) {
