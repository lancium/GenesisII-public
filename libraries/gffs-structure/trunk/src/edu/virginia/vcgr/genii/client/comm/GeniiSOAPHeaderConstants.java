...
public interface GeniiSOAPHeaderConstants
{
	...
	static public final QName GENII_CREDENTIAL_SHORTHAND_SUPPORTED_QNAME =
		new QName(GenesisIIConstants.GENESISII_NS, GENII_CREDENTIAL_SHORTHAND_SUPPORTED_NAME);
}
