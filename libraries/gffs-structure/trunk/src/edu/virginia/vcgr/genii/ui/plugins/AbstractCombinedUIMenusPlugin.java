...
public abstract class AbstractCombinedUIMenusPlugin extends
		AbstractUIMenuPlugin implements UITopMenuPlugin, UIPopupMenuPlugin {
	protected abstract void performMenuAction(UIPluginContext context,
			MenuType menuType) throws UIPluginException;
