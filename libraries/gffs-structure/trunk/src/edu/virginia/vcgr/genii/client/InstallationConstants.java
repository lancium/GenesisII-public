...
public class InstallationConstants
{
	...
	/*
	 * the file containing information about the current grid deployment. will only be definitively valid for an installed system; the build
	 * just copies an example deployment file into place.
	 */
	final public static String DEPLOYMENT_PROPERTIES_FILE = "current.deployment";

	/*
	 * the property name for the grid's "simple name" which is stored in the deployment properties file. knowing the value of this should let
	 * us guess the proper login proxy.
	 */
