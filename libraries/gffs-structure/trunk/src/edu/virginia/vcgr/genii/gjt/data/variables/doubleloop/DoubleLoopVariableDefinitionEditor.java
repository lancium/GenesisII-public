...
public class DoubleLoopVariableDefinitionEditor extends VariableDefinitionEditor<DoubleLoopVariableDefinition>
{
	static final long serialVersionUID = 0L;

	static private final Dimension SIZE = new Dimension(250, 200);

	private SpinnerNumberModel _start = new SpinnerNumberModel(0.0, -1 * Double.MAX_VALUE, Double.MAX_VALUE, 0.1);
	private SpinnerNumberModel _stop = new SpinnerNumberModel(0.0, -1 * Double.MAX_VALUE, Double.MAX_VALUE, 0.1);
	private SpinnerNumberModel _step = new SpinnerNumberModel(0.1, Double.MIN_VALUE, Double.MAX_VALUE, 0.1);

	@Override
	public DoubleLoopVariableDefinition getVariableDefinitionImpl()
	{
		return new DoubleLoopVariableDefinition(_start.getNumber().doubleValue(), _stop.getNumber().doubleValue(),
			_step.getNumber().doubleValue());
	}
	...
	@Override
	public void setFromVariableDefinition(DoubleLoopVariableDefinition variableDefinition)
	{
