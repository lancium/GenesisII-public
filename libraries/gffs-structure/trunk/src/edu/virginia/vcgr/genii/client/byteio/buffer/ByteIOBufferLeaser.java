...
/**
 * This is the final implementation class of a leaser which can lease out byte
 * arrays to be used for ByteIO Buffering.
 * 
 * @author mmm2a
 */
public class ByteIOBufferLeaser extends ResourceLeaser<ByteBuffer> {
	...
	static {
		...
		ByteIOBufferLeaser eightMegBuffer = new ByteIOBufferLeaser(
				1024 * 1024 * 8, 4);
