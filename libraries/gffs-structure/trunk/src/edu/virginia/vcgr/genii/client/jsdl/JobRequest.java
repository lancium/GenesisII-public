...
public class JobRequest implements Serializable {
	...
	private Collection<ContainerDataStage> _stageIns = new LinkedList<ContainerDataStage>();
	private Collection<ContainerDataStage> _stageOuts = new LinkedList<ContainerDataStage>();
	...
	final public void addEnvironmentVariable(String variable,
			FilesystemRelative<String> value) {
	...
	final public void setWorkingDirectory(
			FilesystemRelative<String> workingDirectory) {
	...
	final public void addDataStage(ContainerDataStage stage) {
	...
	final public Collection<ContainerDataStage> getStageIns() {
		return _stageIns;
	}

	final public Collection<ContainerDataStage> getStageOuts() {
		return _stageOuts;
	}
}