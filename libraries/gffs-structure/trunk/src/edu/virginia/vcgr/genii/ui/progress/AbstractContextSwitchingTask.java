...
public abstract class AbstractContextSwitchingTask<ResultType> extends
		AbstractTask<ResultType> {
	private UIContext _context;

	protected abstract ResultType executeInsideContext(
	...
	@Override
	final public ResultType execute(TaskProgressListener progressListener)
			throws Exception {
		Closeable token = null;

		try {
			token = ContextManager.temporarilyAssumeContext(_context
					.callingContext());
