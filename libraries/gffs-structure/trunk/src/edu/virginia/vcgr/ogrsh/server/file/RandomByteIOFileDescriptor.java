...
public class RandomByteIOFileDescriptor extends AbstractFileDescriptor {
	static private Log _logger = LogFactory
			.getLog(RandomByteIOFileDescriptor.class);
	...
	public RandomByteIOFileDescriptor(EndpointReferenceType epr,
		...
		_epr = epr;
		try {
			RandomByteIOPortType stub = ClientUtils.createProxy(
					RandomByteIOPortType.class, epr);
			_transferer = RandomByteIOTransfererFactory
					.createRandomByteIOTransferer(stub);
