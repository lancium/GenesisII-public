...
public class WindowsFilesystemPathRepresentation extends AbstractFilesystemPathRepresentation
{
	static private final Pattern WINDOWS_ROOT_PATTERN = Pattern.compile("^(?:[a-zA-Z]:)?\\\\+(.*)$");
	...
	protected String toStringImpl(String[] path)
	{
		...
		StringBuilder builder = new StringBuilder(_driveLetter == null ? "" : String.format("%c:", _driveLetter.charValue()));
