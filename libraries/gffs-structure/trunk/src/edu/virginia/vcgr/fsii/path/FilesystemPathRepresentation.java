...
/**
 * This interface is used by clients and providers alike to specify how paths in
 * their file system are parsed and concatenated together to form strings.
 * 
 * @author mmm2a
 */
public interface FilesystemPathRepresentation {
	 ...
	 * 
	 * @param path
	 *            The path to convert. This parameter can be null in which case
	 *            it is equivalent to new String[0].
	 * 
