...
/**
 * These are the flags that can be used to open a file. They specify conditions
 * that affect that creation such as whether to truncate the file, create it,
 * append, etc.
 * 
 * @author mmm2a
 */
public class OpenFlags {
	...
	public OpenFlags(boolean isCreate, boolean isAppend, boolean isTruncate,
			boolean isExclusive) {
