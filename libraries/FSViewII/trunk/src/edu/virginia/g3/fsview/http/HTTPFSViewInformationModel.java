...
final class HTTPFSViewInformationModel extends AbstractFSViewInformationModel<URI>
{
	private String _url;
	...
	final public AcceptabilityState isAcceptable()
	{
		...
		return AcceptabilityState.deny(HTTPFSViewInformationModel.class, "URL cannot be empty");
	}
	...
	final public Component createGuiComponent()
	{
		...
		panel.add(new JLabel("HTTP(S) URL"), new GridBagConstraints(0, 0, 1, 1, 0.0, 1.0, GridBagConstraints.WEST,
