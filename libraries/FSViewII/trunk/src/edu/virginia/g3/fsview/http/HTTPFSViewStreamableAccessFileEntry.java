...
class HTTPFSViewStreamableAccessFileEntry extends AbstractFSViewStreamableFileEntry<HTTPFSViewSession>
{
	@Override
	final protected OutputStream openOutpuStreamImpl() throws IOException
	{
		throw new IOException("Not allowed to open output streams to HTTP(S) connections!");
	}
