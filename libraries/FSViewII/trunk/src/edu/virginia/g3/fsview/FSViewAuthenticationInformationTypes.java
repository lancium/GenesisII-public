...
public enum FSViewAuthenticationInformationTypes {
	Anonymous("Anonymous", new AnonymousAuthenticationInformationManager()),
	DomainUsernamePassword("Domain/Username/Password", new DomainUsernamePasswordManager()),
	UsernamePassword("Username/Password", new UsernamePasswordInformationManager());
