...
public abstract class AbstractFSViewInformationModel<InfoType> implements FSViewInformationModel<InfoType>
{
	...
	final protected void fireContentsChanged()
	{
		...
		synchronized (_listeners) {
			listeners = new ArrayList<FSViewInformationListener<InfoType>>(_listeners);
		}
	...
	@Override
	final public void addInformationListener(FSViewInformationListener<InfoType> listener)
	{
		synchronized (_listeners) {
	...
	@Override
	final public void removeInformationListener(FSViewInformationListener<InfoType> listener)
	{
		synchronized (_listeners) {
