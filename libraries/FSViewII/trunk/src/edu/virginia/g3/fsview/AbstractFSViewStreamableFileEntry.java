...
public abstract class AbstractFSViewStreamableFileEntry<SessionType extends FSViewSession>
		extends AbstractFSViewFileEntry<SessionType> implements
		FSViewStreamableAccessFileEntry {
	abstract protected OutputStream openOutpuStreamImpl() throws IOException;

	protected AbstractFSViewStreamableFileEntry(
		...
		super(sessionTypeClass, session, parentEntry, entryName,
				FSViewFileEntryType.StreamableAccessFile);
	}
