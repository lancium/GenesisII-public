...
public abstract class AbstractFSViewRandomAccessFileEntry<SessionType extends FSViewSession>
		extends AbstractFSViewFileEntry<SessionType> implements
		FSViewRandomAccessFileEntry {
	...
	abstract protected void writeImpl(long offset, ByteBuffer source)
			throws IOException;

	protected AbstractFSViewRandomAccessFileEntry(
			Class<SessionType> sessionTypeClass, SessionType session,
			FSViewDirectoryEntry parentEntry, String entryName) {
		super(sessionTypeClass, session, parentEntry, entryName,
				FSViewFileEntryType.RandomAccessFile);
	}
