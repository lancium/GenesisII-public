...
final public class FSViewCreatorDialog extends JDialog {
	...
	public FSViewCreatorDialog(Window owner) {
		...
		for (FSViewFactory factory : factories) {
			FSViewCombinedInformationModel model = new FSViewCombinedInformationModel(
					factory);
		...
		content.add(_tabbedPane, new GridBagConstraints(0, 0, 2, 1, 1.0, 1.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(
						5, 5, 5, 5), 5, 5));
		content.add(_readOnlyButton, new GridBagConstraints(0, 1, 2, 1, 1.0,
				0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(5, 5, 5, 5), 5, 5));

		content.add(new JButton(ok), new GridBagConstraints(0, 2, 1, 1, 1.0,
				0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(5, 5, 5, 5), 5, 5));
		content.add(new JButton(new CancelAction()), new GridBagConstraints(0,
				2, 1, 1, 1.0, 0.0, GridBagConstraints.EAST,
				GridBagConstraints.NONE, new Insets(5, 5, 5, 5), 5, 5));
		/* VANA added 'Help' button */
		content.add(new JButton(new HelpAction()), new GridBagConstraints(1, 2,
		...
		errorPanel.add(_errorLabel, new GridBagConstraints(0, 0, 1, 1, 1.0,
				1.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(5, 5, 5, 5), 5, 5));

		content.add(errorPanel, new GridBagConstraints(0, 3, 2, 1, 1.0, 0.0,
	...
	public FSViewConnectionInformation connectionInformation() {
		...
		FSViewCombinedInformationPanel panel = (FSViewCombinedInformationPanel) _tabbedPane
	...
	private class OKAction extends AbstractAction implements
			FSViewInformationListener<FSViewConnectionInformation>,
			ChangeListener {
		static final long serialVersionUID = 0L;
		...
		@Override
		final public void contentsChanged(
				FSViewInformationModel<FSViewConnectionInformation> model) {
			evalutateState();
		}
