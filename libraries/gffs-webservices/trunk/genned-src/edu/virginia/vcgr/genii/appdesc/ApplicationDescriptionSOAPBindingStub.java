/**
 * ApplicationDescriptionSOAPBindingStub.java
 *
...
public class ApplicationDescriptionSOAPBindingStub extends org.apache.axis.client.Stub implements edu.virginia.vcgr.genii.appdesc.ApplicationDescriptionPortType {
    ...
    private static void _initOperationDesc1(){
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("createDeploymentDocument");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://vcgr.cs.virginia.edu/genii/application-description", "CreateDeploymentDocumentRequestType"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://vcgr.cs.virginia.edu/genii/application-description", "CreateDeploymentDocumentRequestType"), edu.virginia.vcgr.genii.appdesc.CreateDeploymentDocumentRequestType.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://vcgr.cs.virginia.edu/genii/application-description", "CreateDeploymentDocumentResponseType"));
        oper.setReturnClass(edu.virginia.vcgr.genii.appdesc.CreateDeploymentDocumentResponseType.class);
        oper.setReturnQName(new javax.xml.namespace.QName("http://vcgr.cs.virginia.edu/genii/application-description", "CreateDeploymentDocumentResponseType"));
        oper.setStyle(org.apache.axis.constants.Style.DOCUMENT);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
        oper.addFault(new org.apache.axis.description.FaultDesc(
                      new javax.xml.namespace.QName("http://vcgr.cs.virginia.edu/genii/application-description", "DeploymentExistsFaultType"),
                      "edu.virginia.vcgr.genii.appdesc.DeploymentExistsFaultType",
                      new javax.xml.namespace.QName("http://vcgr.cs.virginia.edu/genii/application-description", "DeploymentExistsFaultType"), 
                      true
                     ));
        _operations[4] = oper;
    ...
    public ApplicationDescriptionSOAPBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public ApplicationDescriptionSOAPBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public ApplicationDescriptionSOAPBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    private void addBindings2() {
            ...
            qName = new javax.xml.namespace.QName("http://vcgr.cs.virginia.edu/genii/application-description/bin", "BinDeploymentType");
            cachedSerQNames.add(qName);
            cls = edu.virginia.vcgr.genii.appdesc.bin.BinDeploymentType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://vcgr.cs.virginia.edu/genii/application-description/bin", "DummyDeploymentType");
            cachedSerQNames.add(qName);
            cls = edu.virginia.vcgr.genii.appdesc.bin.DummyDeploymentType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://vcgr.cs.virginia.edu/genii/application-description/bin", "NamedSourceType");
            cachedSerQNames.add(qName);
            cls = edu.virginia.vcgr.genii.appdesc.bin.NamedSourceType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://vcgr.cs.virginia.edu/genii/application-description/bin", "RelativeNamedSourceType");
            cachedSerQNames.add(qName);
            cls = edu.virginia.vcgr.genii.appdesc.bin.RelativeNamedSourceType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://vcgr.cs.virginia.edu/genii/application-description/zip-jar", "DummyDeploymentType");
            cachedSerQNames.add(qName);
            cls = edu.virginia.vcgr.genii.appdesc.zipjar.DummyDeploymentType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://vcgr.cs.virginia.edu/genii/application-description/zip-jar", "ZipJarDeploymentType");
            cachedSerQNames.add(qName);
            cls = edu.virginia.vcgr.genii.appdesc.zipjar.ZipJarDeploymentType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://vcgr.cs.virginia.edu/genii/application-description/zip-jar", "ZipJarEnumeration");
            cachedSerQNames.add(qName);
            cls = edu.virginia.vcgr.genii.appdesc.zipjar.ZipJarEnumeration.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(enumsf);
            cachedDeserFactories.add(enumdf);

            qName = new javax.xml.namespace.QName("http://vcgr.cs.virginia.edu/genii/application-description/zip-jar", "ZipJarSourceType");
            cachedSerQNames.add(qName);
            cls = edu.virginia.vcgr.genii.appdesc.zipjar.ZipJarSourceType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://vcgr.cs.virginia.edu/genii/application-description", "CommonDeploymentDescriptionType");
            cachedSerQNames.add(qName);
            cls = edu.virginia.vcgr.genii.appdesc.CommonDeploymentDescriptionType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://vcgr.cs.virginia.edu/genii/application-description", "CreateDeploymentDocumentRequestType");
            cachedSerQNames.add(qName);
            cls = edu.virginia.vcgr.genii.appdesc.CreateDeploymentDocumentRequestType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://vcgr.cs.virginia.edu/genii/application-description", "CreateDeploymentDocumentResponseType");
            cachedSerQNames.add(qName);
            cls = edu.virginia.vcgr.genii.appdesc.CreateDeploymentDocumentResponseType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://vcgr.cs.virginia.edu/genii/application-description", "DeploymentDocumentType");
            cachedSerQNames.add(qName);
            cls = edu.virginia.vcgr.genii.appdesc.DeploymentDocumentType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://vcgr.cs.virginia.edu/genii/application-description", "DeploymentExistsFaultType");
            cachedSerQNames.add(qName);
            cls = edu.virginia.vcgr.genii.appdesc.DeploymentExistsFaultType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://vcgr.cs.virginia.edu/genii/application-description", "PlatformDescriptionType");
            cachedSerQNames.add(qName);
            cls = edu.virginia.vcgr.genii.appdesc.PlatformDescriptionType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://vcgr.cs.virginia.edu/genii/application-description", "SourceElementType");
            cachedSerQNames.add(qName);
            cls = edu.virginia.vcgr.genii.appdesc.SourceElementType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://vcgr.cs.virginia.edu/genii/application-description", "SupportDocumentType");
            cachedSerQNames.add(qName);
            cls = edu.virginia.vcgr.genii.appdesc.SupportDocumentType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://vcgr.cs.virginia.edu/genii/application-description", "VersionType");
            cachedSerQNames.add(qName);
            cls = java.lang.String.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(org.apache.axis.encoding.ser.BaseSerializerFactory.createFactory(org.apache.axis.encoding.ser.SimpleSerializerFactory.class, cls, qName));
...
synchronized on the service object, then another class of AXIS-2498 was prevented. */
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {queryResourcePropertiesRequest});
  ...
  throw axisFaultException;
    ...
    public edu.virginia.vcgr.genii.appdesc.CreateDeploymentDocumentResponseType createDeploymentDocument(edu.virginia.vcgr.genii.appdesc.CreateDeploymentDocumentRequestType createDeploymentDocumentRequest) throws java.rmi.RemoteException, edu.virginia.vcgr.genii.appdesc.DeploymentExistsFaultType {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("", "createDeploymentDocument"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {createDeploymentDocumentRequest});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (edu.virginia.vcgr.genii.appdesc.CreateDeploymentDocumentResponseType) _resp;
            } catch (java.lang.Exception _exception) {
                return (edu.virginia.vcgr.genii.appdesc.CreateDeploymentDocumentResponseType) org.apache.axis.utils.JavaUtils.convert(_resp, edu.virginia.vcgr.genii.appdesc.CreateDeploymentDocumentResponseType.class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
    if (axisFaultException.detail != null) {
        ...
        if (axisFaultException.detail instanceof edu.virginia.vcgr.genii.appdesc.DeploymentExistsFaultType) {
              throw (edu.virginia.vcgr.genii.appdesc.DeploymentExistsFaultType) axisFaultException.detail;
         }
   }
  throw axisFaultException;
}
