...
public class SeekReadResponse  implements java.io.Serializable {
    private org.ggf.byteio.TransferInformationType transferInformation;

    public SeekReadResponse() {
    }
    ...
    /**
     * Gets the transferInformation value for this SeekReadResponse.
     * 
    ...
    /**
     * Sets the transferInformation value for this SeekReadResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SeekReadResponse)) return false;
        SeekReadResponse other = (SeekReadResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SeekReadResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.ggf.org/byteio/2005/10/streamable-access", ">seekReadResponse"));
