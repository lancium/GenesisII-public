/**
 * UnableToModifyResourcePropertyFaultType.java
 *
...
public class UnableToModifyResourcePropertyFaultType  extends org.oasis_open.wsrf.basefaults.BaseFaultType  implements java.io.Serializable {
    private org.oasis_open.docs.wsrf.rp_2.ResourcePropertyChangeFailureType resourcePropertyChangeFailure;

    public UnableToModifyResourcePropertyFaultType() {
    }
    ...
    /**
     * Gets the resourcePropertyChangeFailure value for this UnableToModifyResourcePropertyFaultType.
     * 
    ...
    /**
     * Sets the resourcePropertyChangeFailure value for this UnableToModifyResourcePropertyFaultType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof UnableToModifyResourcePropertyFaultType)) return false;
        UnableToModifyResourcePropertyFaultType other = (UnableToModifyResourcePropertyFaultType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(UnableToModifyResourcePropertyFaultType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://docs.oasis-open.org/wsrf/rp-2", "UnableToModifyResourcePropertyFaultType"));
