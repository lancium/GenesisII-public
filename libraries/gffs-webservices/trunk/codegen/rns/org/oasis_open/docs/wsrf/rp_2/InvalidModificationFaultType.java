/**
 * InvalidModificationFaultType.java
 *
...
public class InvalidModificationFaultType  extends org.oasis_open.wsrf.basefaults.BaseFaultType  implements java.io.Serializable {
    private org.oasis_open.docs.wsrf.rp_2.ResourcePropertyChangeFailureType resourcePropertyChangeFailure;

    public InvalidModificationFaultType() {
    }
    ...
    /**
     * Gets the resourcePropertyChangeFailure value for this InvalidModificationFaultType.
     * 
    ...
    /**
     * Sets the resourcePropertyChangeFailure value for this InvalidModificationFaultType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof InvalidModificationFaultType)) return false;
        InvalidModificationFaultType other = (InvalidModificationFaultType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(InvalidModificationFaultType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://docs.oasis-open.org/wsrf/rp-2", "InvalidModificationFaultType"));
