/**
 * UpdateResourcePropertiesRequestFailedFaultType.java
 *
...
public class UpdateResourcePropertiesRequestFailedFaultType  extends org.oasis_open.wsrf.basefaults.BaseFaultType  implements java.io.Serializable {
    private org.oasis_open.docs.wsrf.rp_2.ResourcePropertyChangeFailureType resourcePropertyChangeFailure;

    public UpdateResourcePropertiesRequestFailedFaultType() {
    }
    ...
    /**
     * Gets the resourcePropertyChangeFailure value for this UpdateResourcePropertiesRequestFailedFaultType.
     * 
    ...
    /**
     * Sets the resourcePropertyChangeFailure value for this UpdateResourcePropertiesRequestFailedFaultType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof UpdateResourcePropertiesRequestFailedFaultType)) return false;
        UpdateResourcePropertiesRequestFailedFaultType other = (UpdateResourcePropertiesRequestFailedFaultType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(UpdateResourcePropertiesRequestFailedFaultType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://docs.oasis-open.org/wsrf/rp-2", "UpdateResourcePropertiesRequestFailedFaultType"));
