/**
 * CertGeneratorSOAPBindingStub.java
 *
...
public class CertGeneratorSOAPBindingStub extends org.apache.axis.client.Stub implements edu.virginia.vcgr.genii.certGenerator.CertGeneratorPortType {
    ...
    private static void _initOperationDesc2(){
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("generateX509V3CertificateChain");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://vcgr.cs.virginia.edu/genii/2007/08/certGenerator", "generateX509V3CertificateChainRequest"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://vcgr.cs.virginia.edu/genii/2007/08/certGenerator", "generateX509V3CertificateChainRequestType"), edu.virginia.vcgr.genii.certGenerator.GenerateX509V3CertificateChainRequestType.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://vcgr.cs.virginia.edu/genii/2007/08/certGenerator", "generateX509V3CertificateChainResponseType"));
        oper.setReturnClass(edu.virginia.vcgr.genii.certGenerator.GenerateX509V3CertificateChainResponseType.class);
        oper.setReturnQName(new javax.xml.namespace.QName("http://vcgr.cs.virginia.edu/genii/2007/08/certGenerator", "generateX509V3CertificateChainResponse"));
        oper.setStyle(org.apache.axis.constants.Style.DOCUMENT);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
        oper.addFault(new org.apache.axis.description.FaultDesc(
                      new javax.xml.namespace.QName("http://docs.oasis-open.org/wsrf/r-2", "ResourceUnknownFault"),
        ...
        oper.addFault(new org.apache.axis.description.FaultDesc(
                      new javax.xml.namespace.QName("http://vcgr.cs.virginia.edu/genii/2007/08/certGenerator", "InvalidCertificateRequestFault"),
                      "edu.virginia.vcgr.genii.certGenerator.InvalidCertificateRequestFaultType",
                      new javax.xml.namespace.QName("http://vcgr.cs.virginia.edu/genii/2007/08/certGenerator", "InvalidCertificateRequestFaultType"), 
                      true
                     ));
        _operations[17] = oper;
    ...
    public CertGeneratorSOAPBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public CertGeneratorSOAPBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public CertGeneratorSOAPBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    private void addBindings1() {
            ...
            qName = new javax.xml.namespace.QName("http://vcgr.cs.virginia.edu/genii/2007/08/certGenerator", "CertificateChainType");
            cachedSerQNames.add(qName);
            cls = edu.virginia.vcgr.genii.certGenerator.CertificateChainType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://vcgr.cs.virginia.edu/genii/2007/08/certGenerator", "generateX509V3CertificateChainRequestType");
            cachedSerQNames.add(qName);
            cls = edu.virginia.vcgr.genii.certGenerator.GenerateX509V3CertificateChainRequestType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://vcgr.cs.virginia.edu/genii/2007/08/certGenerator", "generateX509V3CertificateChainResponseType");
            cachedSerQNames.add(qName);
            cls = edu.virginia.vcgr.genii.certGenerator.GenerateX509V3CertificateChainResponseType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://vcgr.cs.virginia.edu/genii/2007/08/certGenerator", "InvalidCertificateRequestFaultType");
            cachedSerQNames.add(qName);
            cls = edu.virginia.vcgr.genii.certGenerator.InvalidCertificateRequestFaultType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://vcgr.cs.virginia.edu/genii/2007/08/certGenerator", "PublicKeyType");
            cachedSerQNames.add(qName);
            cls = edu.virginia.vcgr.genii.certGenerator.PublicKeyType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://vcgr.cs.virginia.edu/genii/2007/08/certGenerator", "X509NameType");
            cachedSerQNames.add(qName);
            cls = edu.virginia.vcgr.genii.certGenerator.X509NameType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {destroyRequest});
  ...
  throw axisFaultException;
    ...
    public edu.virginia.vcgr.genii.certGenerator.GenerateX509V3CertificateChainResponseType generateX509V3CertificateChain(edu.virginia.vcgr.genii.certGenerator.GenerateX509V3CertificateChainRequestType generateX509V3CertificateChainRequest) throws java.rmi.RemoteException, org.oasis_open.docs.wsrf.r_2.ResourceUnknownFaultType, edu.virginia.vcgr.genii.certGenerator.InvalidCertificateRequestFaultType {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("", "generateX509V3CertificateChain"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {generateX509V3CertificateChainRequest});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (edu.virginia.vcgr.genii.certGenerator.GenerateX509V3CertificateChainResponseType) _resp;
            } catch (java.lang.Exception _exception) {
                return (edu.virginia.vcgr.genii.certGenerator.GenerateX509V3CertificateChainResponseType) org.apache.axis.utils.JavaUtils.convert(_resp, edu.virginia.vcgr.genii.certGenerator.GenerateX509V3CertificateChainResponseType.class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
    if (axisFaultException.detail != null) {
        ...
        if (axisFaultException.detail instanceof edu.virginia.vcgr.genii.certGenerator.InvalidCertificateRequestFaultType) {
              throw (edu.virginia.vcgr.genii.certGenerator.InvalidCertificateRequestFaultType) axisFaultException.detail;
         }
   }
  throw axisFaultException;
}
