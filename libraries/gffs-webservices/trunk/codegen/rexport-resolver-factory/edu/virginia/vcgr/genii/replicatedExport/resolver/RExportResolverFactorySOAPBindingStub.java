/**
 * RExportResolverFactorySOAPBindingStub.java
 *
...
public class RExportResolverFactorySOAPBindingStub extends org.apache.axis.client.Stub implements edu.virginia.vcgr.genii.replicatedExport.resolver.RExportResolverFactoryPortType {
    ...
    private static void _initOperationDesc1(){
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("createResolver");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://vcgr.cs.virginia.edu/rns/2007/08/replicatedExport/resolver-factory", "CreateResolverRequest"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://vcgr.cs.virginia.edu/rns/2007/08/replicatedExport/resolver-factory", "CreateResolverRequestType"), edu.virginia.vcgr.genii.replicatedExport.resolver.CreateResolverRequestType.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://vcgr.cs.virginia.edu/rns/2007/08/replicatedExport/resolver-factory", "CreateResolverResponseType"));
        oper.setReturnClass(edu.virginia.vcgr.genii.replicatedExport.resolver.CreateResolverResponseType.class);
        oper.setReturnQName(new javax.xml.namespace.QName("http://vcgr.cs.virginia.edu/rns/2007/08/replicatedExport/resolver-factory", "CreateResolverResponse"));
        oper.setStyle(org.apache.axis.constants.Style.DOCUMENT);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
        oper.addFault(new org.apache.axis.description.FaultDesc(
    ...
    public RExportResolverFactorySOAPBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public RExportResolverFactorySOAPBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public RExportResolverFactorySOAPBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    private void addBindings1() {
            ...
            qName = new javax.xml.namespace.QName("http://vcgr.cs.virginia.edu/rns/2007/08/replicatedExport/resolver-factory", "CreateResolverRequestType");
            cachedSerQNames.add(qName);
            cls = edu.virginia.vcgr.genii.replicatedExport.resolver.CreateResolverRequestType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://vcgr.cs.virginia.edu/rns/2007/08/replicatedExport/resolver-factory", "CreateResolverResponseType");
            cachedSerQNames.add(qName);
            cls = edu.virginia.vcgr.genii.replicatedExport.resolver.CreateResolverResponseType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
...
synchronized on the service object, then another class of AXIS-2498 was prevented. */
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {pingRequest});
  ...
  throw axisFaultException;
    ...
    public edu.virginia.vcgr.genii.replicatedExport.resolver.CreateResolverResponseType createResolver(edu.virginia.vcgr.genii.replicatedExport.resolver.CreateResolverRequestType createResolverRequest) throws java.rmi.RemoteException, edu.virginia.vcgr.genii.replicatedExport.resolver.InvalidWSNameFaultType {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("", "createResolver"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {createResolverRequest});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (edu.virginia.vcgr.genii.replicatedExport.resolver.CreateResolverResponseType) _resp;
            } catch (java.lang.Exception _exception) {
                return (edu.virginia.vcgr.genii.replicatedExport.resolver.CreateResolverResponseType) org.apache.axis.utils.JavaUtils.convert(_resp, edu.virginia.vcgr.genii.replicatedExport.resolver.CreateResolverResponseType.class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
    if (axisFaultException.detail != null) {
