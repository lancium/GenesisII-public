/**
 * DeleteResourcePropertiesRequestFailedFaultType.java
 *
...
public class DeleteResourcePropertiesRequestFailedFaultType  extends org.oasis_open.wsrf.basefaults.BaseFaultType  implements java.io.Serializable {
    private org.oasis_open.docs.wsrf.rp_2.ResourcePropertyChangeFailureType resourcePropertyChangeFailure;

    public DeleteResourcePropertiesRequestFailedFaultType() {
    }
    ...
    /**
     * Gets the resourcePropertyChangeFailure value for this DeleteResourcePropertiesRequestFailedFaultType.
     * 
    ...
    /**
     * Sets the resourcePropertyChangeFailure value for this DeleteResourcePropertiesRequestFailedFaultType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof DeleteResourcePropertiesRequestFailedFaultType)) return false;
        DeleteResourcePropertiesRequestFailedFaultType other = (DeleteResourcePropertiesRequestFailedFaultType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(DeleteResourcePropertiesRequestFailedFaultType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://docs.oasis-open.org/wsrf/rp-2", "DeleteResourcePropertiesRequestFailedFaultType"));
