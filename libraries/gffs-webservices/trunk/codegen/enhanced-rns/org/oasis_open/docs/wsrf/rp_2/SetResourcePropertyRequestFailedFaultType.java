/**
 * SetResourcePropertyRequestFailedFaultType.java
 *
...
public class SetResourcePropertyRequestFailedFaultType  extends org.oasis_open.wsrf.basefaults.BaseFaultType  implements java.io.Serializable {
    private org.oasis_open.docs.wsrf.rp_2.ResourcePropertyChangeFailureType resourcePropertyChangeFailure;

    public SetResourcePropertyRequestFailedFaultType() {
    }
    ...
    /**
     * Gets the resourcePropertyChangeFailure value for this SetResourcePropertyRequestFailedFaultType.
     * 
    ...
    /**
     * Sets the resourcePropertyChangeFailure value for this SetResourcePropertyRequestFailedFaultType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SetResourcePropertyRequestFailedFaultType)) return false;
        SetResourcePropertyRequestFailedFaultType other = (SetResourcePropertyRequestFailedFaultType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SetResourcePropertyRequestFailedFaultType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://docs.oasis-open.org/wsrf/rp-2", "SetResourcePropertyRequestFailedFaultType"));
