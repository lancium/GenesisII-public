/**
 * RExportDirSOAPBindingStub.java
 *
...
public class RExportDirSOAPBindingStub extends org.apache.axis.client.Stub implements edu.virginia.vcgr.genii.replicatedExport.RExportDirPortType {
    ...
    private static void _initOperationDesc3(){
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("populateDir");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://vcgr.cs.virginia.edu/rns/2007/08/rexport-dir", "PopulateDirRequest"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://vcgr.cs.virginia.edu/rns/2007/08/rexport-dir", "PopulateDirRequestType"), edu.virginia.vcgr.genii.replicatedExport.PopulateDirRequestType.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(org.apache.axis.encoding.XMLType.AXIS_VOID);
        oper.setStyle(org.apache.axis.constants.Style.DOCUMENT);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
    ...
    public RExportDirSOAPBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public RExportDirSOAPBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public RExportDirSOAPBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    private void addBindings1() {
            ...
            qName = new javax.xml.namespace.QName("http://vcgr.cs.virginia.edu/rns/2007/08/rexport-dir", "PopulateDirRequestType");
            cachedSerQNames.add(qName);
            cls = edu.virginia.vcgr.genii.replicatedExport.PopulateDirRequestType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
...
synchronized on the service object, then another class of AXIS-2498 was prevented. */
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {getMultipleResourcePropertiesRequest});
  ...
  throw axisFaultException;
    ...
    public void populateDir(edu.virginia.vcgr.genii.replicatedExport.PopulateDirRequestType populateDirRequest) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("", "populateDir"));

        setRequestHeaders(_call);
        setAttachments(_call);
        _call.invokeOneWay(new java.lang.Object[] {populateDirRequest});
