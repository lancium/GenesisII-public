/**
 * WSIteratorSOAPBindingStub.java
 *
...
public class WSIteratorSOAPBindingStub extends org.apache.axis.client.Stub implements edu.virginia.vcgr.genii.iterator.WSIteratorPortType {
    ...
    private static void _initOperationDesc2(){
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("iterate");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://schemas.ogf.org/ws-iterator/2008/06/iterator", "IterateRequestType"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://schemas.ogf.org/ws-iterator/2008/06/iterator", "IterateRequestType"), edu.virginia.vcgr.genii.iterator.IterateRequestType.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://schemas.ogf.org/ws-iterator/2008/06/iterator", "IterateResponseType"));
        oper.setReturnClass(edu.virginia.vcgr.genii.iterator.IterateResponseType.class);
        oper.setReturnQName(new javax.xml.namespace.QName("http://schemas.ogf.org/ws-iterator/2008/06/iterator", "IterateResponseType"));
        oper.setStyle(org.apache.axis.constants.Style.DOCUMENT);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
        _operations[19] = oper;
    ...
    public WSIteratorSOAPBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public WSIteratorSOAPBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public WSIteratorSOAPBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    private void addBindings1() {
            ...
            qName = new javax.xml.namespace.QName("http://schemas.ogf.org/ws-iterator/2008/06/iterator", ">WSIteratorRP");
            cachedSerQNames.add(qName);
            cls = edu.virginia.vcgr.genii.iterator.WSIteratorRP.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
...
synchronized on the service object, then another class of AXIS-2498 was prevented. */
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {notify});
  ...
  throw axisFaultException;
    ...
    public edu.virginia.vcgr.genii.iterator.IterateResponseType iterate(edu.virginia.vcgr.genii.iterator.IterateRequestType iterateRequest) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("", "iterate"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {iterateRequest});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (edu.virginia.vcgr.genii.iterator.IterateResponseType) _resp;
            } catch (java.lang.Exception _exception) {
                return (edu.virginia.vcgr.genii.iterator.IterateResponseType) org.apache.axis.utils.JavaUtils.convert(_resp, edu.virginia.vcgr.genii.iterator.IterateResponseType.class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
