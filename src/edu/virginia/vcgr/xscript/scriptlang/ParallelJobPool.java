...
public class ParallelJobPool
{
	...
	static public final String PARALLEL_JOB_POOL_BINDING_NAME =
		"Parallel Job Pool Binding";
	...
	private LinkedList<ParallelJobContext> _jobs = 
		new LinkedList<ParallelJobContext>();
