...
public abstract class AbstractFilesystemPathRepresentation 
	implements FilesystemPathRepresentation
{
	/**
	...
	/**
	 * Converts the rooted string path array into a string representation of 
	 * the path.
	 * 
	 * @param path The rooted path array to convert into a string 
	 * representation.
	 * 
	...
	/**
	 * Given a path string, split that string into its constituant parts.
	 * This is NOT the same as converting it into a rooted path array for
	 * two reasons.  One, the path doesn't have to be rooted.  And two,
	 * the array can contain empty strings (often the case when using
	 * the String.split function) as well as . and .. elements.
	 * 
	 * @param path The path to split into a string array.
	 ...
	 * path.
	 * 
	 * @param path The path to test for rooted'ness.
	 * 
	 ...
	 * array.
	 * 
	 * @param currentPath The current rooted path to parse the new path
	 * relative to.
	 * @param newPath The new path string to parse.  This can be absolute or
	 * relative.
	 * 
