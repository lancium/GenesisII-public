...
class DefaultRegistration
{
	...
	private Collection<ApplicationRegistration> _registrations = new LinkedList<ApplicationRegistration>();

	final Map<ApplicationRegistrationTypes, ExternalApplication> createApplicationMap()
	{
		Map<ApplicationRegistrationTypes, ExternalApplication> ret = new EnumMap<ApplicationRegistrationTypes, ExternalApplication>(
