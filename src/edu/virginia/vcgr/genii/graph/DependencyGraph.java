...
{
	static private Class<?>[] dependentClasses(
	...
	private Map<Class<?>, Set<Class<?>>> _graph =
	...
	static private class GraphBasedObjectComparator<T> implements Comparator<T>
	{
		...
		private GraphBasedObjectComparator(
	...
	final public <T> Comparator<T> createObjectComparator(
		Class<T> objClass)
	{
		return new GraphBasedObjectComparator<T>(
			new GraphBasedComparator(createTotalMap()));
	}
}