		...
		IXMLComponent
{
	...
	protected void normalizeMessage() throws WsdlException
	{
		...
		{
			myElement.getAttributeNode(
				WsdlConstants.MESSAGE_ATTR).setNodeValue(newMessagePrefix + ":" +
					messageName);
		}
		if (newDocumentPrefix != null)
		{
			myElement.setAttributeNS(
	...
	protected String getMessagePrefix() throws WsdlException
	{
		String msgString = WsdlUtils.getAttribute(
			_representedNode.getAttributes(), WsdlConstants.MESSAGE_ATTR, true);
