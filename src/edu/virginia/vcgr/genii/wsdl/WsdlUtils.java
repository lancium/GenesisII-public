...
public class WsdlUtils
{
	...
	static protected String getAttribute(NamedNodeMap attrs,
		String attrName, boolean required) throws WsdlException
	{
	...
	static public QName getQNameFromString(String str)
		...
		throws WsdlException
	{
		...
		String namespace = someNode.lookupNamespaceURI(
			str.substring(0, index));
		if (namespace == null)
		{
			Document alternativeResolver = 
				AlternativeNamespaceResolution.getAlternativeResolver();
			if (alternativeResolver != null)
			{
				namespace = alternativeResolver.lookupNamespaceURI(
					str.substring(0, index));
			}
