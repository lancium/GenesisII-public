...
public class WsdlInputOutput extends MessageNormalizable
{
	...
	public WsdlInputOutput(WsdlSourcePath sourcePath, IXMLComponent parent, Node wsdlIONode) throws WsdlException
	{
		...
		Node actionNode = attrs.getNamedItemNS(WsdlConstants.ACTION_QNAME.getNamespaceURI(),
