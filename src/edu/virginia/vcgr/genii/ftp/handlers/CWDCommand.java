...
public class CWDCommand extends AbstractHandler
{
	static final private String _CWDVERB = "CWD";
	static final private String _XCWDVERB = "XCWD";
	
	public CWDCommand(FtpSession ftpSession)
	{
		super(ftpSession, _CWDVERB, _XCWDVERB);
	}
