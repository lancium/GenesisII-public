...
public class MkdirCommand extends AbstractHandler
{
	static final private String _VERB = "MKD";
	
	public MkdirCommand(FtpSession ftpSession)
	{
	...
	public void handleCommand(IFTPCommandHandler previousHandler, 
		String verb, String parameters, PrintStream out)
			throws FTPException
	{
		String newPath = getFileSystem().mkdir(parameters);
		out.println("257 \"" + newPath + "\"");
	}
}
