...
public class SizeCommand extends AbstractHandler
{
	static final private String _VERB = "SIZE";
	
	public SizeCommand(FtpSession ftpSession)
	{
	...
	public void handleCommand(IFTPCommandHandler previousHandler, 
		String verb, String parameters, PrintStream out)
			throws FTPException
	{
		out.println("257 \"" + getFileSystem().size(parameters) + "\".");
	}
}
