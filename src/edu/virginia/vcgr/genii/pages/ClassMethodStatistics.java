...
public class ClassMethodStatistics extends GenesisIIStyledPage {
	...
	protected void generateContent(PrintStream ps) throws IOException {
		...
		Map<String, MethodStatisticsReportPoint> methodMap = msr.methodTotals()
				.get(_className);
