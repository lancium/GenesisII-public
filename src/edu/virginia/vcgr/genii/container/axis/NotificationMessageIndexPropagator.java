...
public class NotificationMessageIndexPropagator extends BasicHandler
{
	...
	public void invoke(MessageContext msgContext) throws AxisFault
	{
		...
		if (clientConfig != null) {
			...
			WSNotificationContainerService notificationService = ContainerServices.findService(WSNotificationContainerService.class);
	...
	{
		SOAPHeaderElement messageIndexHeader = new SOAPHeaderElement(NotificationBrokerConstants.MESSAGE_INDEX_QNAME, messageIndex);
