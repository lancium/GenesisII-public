...
public class EnhancedNotificationBrokerFactoryServiceImpl extends GenesisIIBase
		implements EnhancedNotificationBrokerFactoryPortType {

	public static final String SERVICE_URL = "EnhancedNotificationBrokerFactoryPortType";

	private static Log _logger = LogFactory
			.getLog(EnhancedNotificationBrokerFactoryServiceImpl.class);

	public EnhancedNotificationBrokerFactoryServiceImpl()
			throws RemoteException {
		super(SERVICE_URL);
	}

	public EnhancedNotificationBrokerFactoryServiceImpl(String serviceName)
			throws RemoteException {
		super(SERVICE_URL);
	}
	...
	public EndpointReferenceType createNotificationBroker(long lifeTimeOfBroker)
		...
		try {
			EndpointReferenceType brokerEndpoint = new EnhancedNotificationBrokerServiceImpl()
					.CreateEPR(
							new MessageElement[] { cParams
									.serializeToMessageElement() },
							Container
			...
			final NotificationBrokerCreationFailedFaultType fault = new NotificationBrokerCreationFailedFaultType(
					null,
					Calendar.getInstance(),
					null,
					null,
					new BaseFaultTypeDescription[] { new BaseFaultTypeDescription(
							"Unable to create notification broker.") }, null,
					null);
			throw fault;
		}
	}
	...
	@RWXMapping(RWXCategory.EXECUTE)
	@Override
	public EndpointReferenceType createNotificationBrokerWithForwardingPort(
			BrokerWithForwardingPortCreateRequestType request)
			throws RemoteException, NotificationBrokerCreationFailedFaultType {
