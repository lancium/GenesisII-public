...
public class NotificationBrokerDBResource extends BasicDBResource {
	...
	public void createNotificationBroker(String resourceId, 
			boolean mode, 
			int messageIndex,
			String clientId, 
			EndpointReferenceType forwardingPort) throws ResourceException {
		
		NotificationBrokerDatabase.createNotificationBroker(resourceId, 
				mode, messageIndex, clientId, forwardingPort, _connection);
	}
	...
	public void storeSubscriptionTracesInDB(List<String> subscriptionEPIs, 
			EndpointReferenceType publisher, long subscriptionTerminationTime) throws ResourceException {
		...
		NotificationBrokerDatabase.storeSubscriptionTraces(_resourceKey, subscriptionEPIs, 
				publisherKey, subscriptionTerminationTime, _connection);
	}
