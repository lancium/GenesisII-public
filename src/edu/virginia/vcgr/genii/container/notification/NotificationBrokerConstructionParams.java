...
public class NotificationBrokerConstructionParams extends
	...
	public NotificationBrokerConstructionParams(Boolean mode,
			EndpointReferenceType forwardingPort, long scheduledTerminationTime) {
		this.mode = mode;
