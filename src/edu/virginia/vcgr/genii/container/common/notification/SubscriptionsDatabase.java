...
public class SubscriptionsDatabase
{
	...
	static private void destroySubscription(Connection connection, String subscriptionkey)
		...
		AdditionalUserData additionalUserData) throws SQLException
	{
		...
		try
		{
			stmt = connection.prepareStatement(
				"INSERT INTO wsnsubscriptions(subscriptionresourcekey," +
		...
		throws SQLException
	{
		...
		{
			stmt = connection.prepareStatement(
				"DELETE FROM wsnsubscriptions WHERE subscriptionresourcekey = ?");
		...
		String publisherKey) throws SQLException
	{
		...
		{
			stmt = connection.prepareStatement(
				"SELECT subscriptionresourcekey FROM wsnsubscriptions " +
			...
			TopicPath topic) throws SQLException
	{
		Collection<WSNSubscriptionInformation> subscriptions = 
			new LinkedList<WSNSubscriptionInformation>();
		...
		String subscriptionKey, boolean markPaused) throws SQLException
	{
		...
		{
			stmt = connection.prepareStatement(
				"UPDATE wsnsubscriptions SET paused = ? " +
