...
public class ConstructionParametersFork extends
	...
	public void modifyState(InputStream source) throws IOException {
		try {
			ConstructionParameters cParams = ConstructionParameters
					.deserializeConstructionParameters(getService().getClass(),
							source);
	...
	public void snapshotState(OutputStream sink) throws IOException {
		try {
			ConstructionParameters cParams = ResourceManager
