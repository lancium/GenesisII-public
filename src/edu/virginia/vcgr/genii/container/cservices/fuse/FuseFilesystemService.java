...
public class FuseFilesystemService extends AbstractContainerService
{
	...
	static public final String FUSE_DIR_CSERVICE_PROPERTY = "edu.virginia.vcgr.genii.container.cservices.fuse.fuse-directory";

	private Map<File, Map<String, Long>> _parentDir2MountPoint2Id = new HashMap<File, Map<String, Long>>();
	...
	private void selectFuseDirectory(String propertyValue)
	{
		...
		try {
			synchronized (_lockObject) {
				_fuseDirectory = new GuaranteedDirectory(dirPath, "fuse-mounts");
