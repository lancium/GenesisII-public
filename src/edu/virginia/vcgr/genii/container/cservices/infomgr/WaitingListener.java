...
/**
 * An internal class used to bundle together a timeout value with a listener.
 * 
 * @author mmm2a
 * 
...
class WaitingListener<InformationType>
{
	...
	WaitingListener(InformationListener<InformationType> listener, Calendar timeout)
	{
		_timeout = timeout;
		_listener = listener;
	}
