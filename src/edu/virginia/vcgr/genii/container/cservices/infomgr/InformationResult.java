...
public class InformationResult<InfoType>
{
	 ...
	 * @param exception
	 *            Any exceptions that occurred (or null) trying to update the information.
	 */
	public InformationResult(InfoType information, Calendar lastUpdated, Throwable exception)
	{
