...
public interface InformationPersister<InformationType> {
	 ...
	 * @return Any information stored with this persister. This result CAN be
	 *         null indicating that no information is currently stored by this
	 *         persister.
	 */
	 ...
	 * 
	 * @param endpoint
	 *            The endpoint to store information about. This parameter cannot
	 *            be null.
	 * @param information
	 *            THe information to store for the endpoint. This information
	 *            can be null, indicating that any stored information for the
