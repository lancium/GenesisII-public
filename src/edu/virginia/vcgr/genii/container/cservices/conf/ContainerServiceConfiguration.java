...
public class ContainerServiceConfiguration
{
		...
		throws ClassNotFoundException
	{
		...
		{
			_serviceClass = 
				(Class<? extends ContainerService>)ContainerServiceConfiguration.class.getClassLoader().loadClass(_className);
		}
	...
	final public ContainerService instantiate()
			...
			ExtensionFileFilter.XML))
		{
			try
			{
				ContainerServiceConfiguration conf = 
					(ContainerServiceConfiguration)unmarshaller.unmarshal(
						sourceFile);
