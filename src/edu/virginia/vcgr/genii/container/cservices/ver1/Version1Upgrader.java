...
public class Version1Upgrader {
	static private void writeUpgrade(File targetDirectory,
		...
		JAXBContext v2Context = JAXBContext
	...
	static public void upgrade(File version1File, File targetDirectory)
		...
		try {
			JAXBContext v1Context = JAXBContext
					.newInstance(Version1Configuration.class);
			Version1Configuration v1Conf = (Version1Configuration) v1Context
					.createUnmarshaller().unmarshal(version1File);
			Properties macros = v1Conf.variables();

			for (Version1ContainerService v1Service : v1Conf.services()) {
				Class<? extends ContainerService> serviceClass = v1Service
						.serviceClass(macros);
			...
			throw new IOException(
					"Failed to upgrade old container services configuration.",
					e);
		}
	}
}