...
abstract class AbstractHistoryContext implements HistoryContext {
	...
	final public HistoryEventToken trace(Throwable cause,
		...
		return logEvent(
				HistoryEventLevel.Trace,
				new HistoryEventData(String.format(shortDescriptionFormat,
	...
	final public HistoryEventToken error(Throwable cause,
			String shortDescriptionFormat, Object... formatArguments) {
		return logEvent(
				HistoryEventLevel.Error,
				new HistoryEventData(String.format(shortDescriptionFormat,
						formatArguments), cause));
	}

	@Override
	final public HistoryEventToken trace(String shortDescriptionFormat,
	...
	@Override
	final public HistoryEventToken debug(String shortDescriptionFormat,
			Object... formatArguments) {
		return logEvent(
				HistoryEventLevel.Debug,
				new HistoryEventData(String.format(shortDescriptionFormat,
	...
	@Override
	final public HistoryEventToken info(String shortDescriptionFormat,
			Object... formatArguments) {
		return logEvent(HistoryEventLevel.Information, new HistoryEventData(
	...
	@Override
	final public HistoryEventToken warn(String shortDescriptionFormat,
			Object... formatArguments) {
		return logEvent(
				HistoryEventLevel.Warning,
				new HistoryEventData(String.format(shortDescriptionFormat,
	...
	@Override
	final public HistoryEventToken error(String shortDescriptionFormat,
			Object... formatArguments) {
		return logEvent(
				HistoryEventLevel.Error,
				new HistoryEventData(String.format(shortDescriptionFormat,
	...
	@Override
	final public HistoryEventWriter createTraceWriter(
			String shortDescriptionFormat, Object... formatArguments) {
		return new HistoryContextWriter(HistoryEventLevel.Trace,
				new HistoryEventData(String.format(shortDescriptionFormat,
						formatArguments)));
	...
	@Override
	final public HistoryEventWriter createDebugWriter(
			String shortDescriptionFormat, Object... formatArguments) {
		return new HistoryContextWriter(HistoryEventLevel.Debug,
				new HistoryEventData(String.format(shortDescriptionFormat,
						formatArguments)));
	...
	@Override
	final public HistoryEventWriter createInfoWriter(
			String shortDescriptionFormat, Object... formatArguments) {
		return new HistoryContextWriter(HistoryEventLevel.Information,
				new HistoryEventData(String.format(shortDescriptionFormat,
						formatArguments)));
	...
	@Override
	final public HistoryEventWriter createWarnWriter(
			String shortDescriptionFormat, Object... formatArguments) {
		return new HistoryContextWriter(HistoryEventLevel.Warning,
				new HistoryEventData(String.format(shortDescriptionFormat,
						formatArguments)));
	...
	@Override
	final public HistoryEventWriter createErrorWriter(
			String shortDescriptionFormat, Object... formatArguments) {
		return new HistoryContextWriter(HistoryEventLevel.Error,
				new HistoryEventData(String.format(shortDescriptionFormat,
						formatArguments)));
