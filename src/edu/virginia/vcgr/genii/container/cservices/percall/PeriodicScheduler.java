...
public class PeriodicScheduler implements AttemptScheduler
{
	...
	public PeriodicScheduler(Calendar lifetime, Integer maxFailedAttempts, long period, TimeUnit periodUnits)
	{
		if (period < 0L)
	...
	public PeriodicScheduler(long lifetime, TimeUnit lifetimeUnits, Integer maxFailedAttempts, long period, TimeUnit periodUnits)
	{
		if (period < 0L)
			throw new IllegalArgumentException("Period cannot be negative.");
