...
/**
 * This interface represents the ability to perform the outcall (or whatever action) that the client wants to perform persistently until it
 * works.
 * 
 * @author morgan
 */
...
{
	/**
	 * Go ahead and try to perform the outcall. If this method returns true, then assume that the outcall succeeded, otherwise, if it returns
	 * false or throws an exception, assume that it failed.
	 * 
