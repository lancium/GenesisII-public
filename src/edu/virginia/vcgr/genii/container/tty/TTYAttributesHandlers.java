...
public class TTYAttributesHandlers extends AbstractAttributeHandler {
	...
	static final private QName WRITEABLE_QNAME = new QName(NAMESPACE,
			"Writeable");
	static final private QName SEEKABLE_QNAME = new QName(NAMESPACE, "Seekable");
	static final private QName END_OF_STREAM_QNAME = new QName(NAMESPACE,
			"EndOfStream");
	static final private QName TRANSFER_MECH_QNAME = new QName(NAMESPACE,
			"TransferMechanism");
	static final private QName DESTROY_ON_CLOSE_QNAME = new QName(NAMESPACE,
			"DestroyOnClose");

	public TTYAttributesHandlers(AttributePackage pkg)
