...
public class GenesisIIServiceConfigurationFactory
{
		...
		Class<?> serviceClass)
	{
		...
		CompositeGenesisIIServiceConfiguration composite =
			new CompositeGenesisIIServiceConfiguration(serviceClass);
				...
				if ((configFile != null) && configFile.exists())
				{
					try
					{
						...
						jaxbConf = u.unmarshal(new StreamSource(configFile),
							composite.jaxbServiceConfigurationClass()).getValue();
					}
