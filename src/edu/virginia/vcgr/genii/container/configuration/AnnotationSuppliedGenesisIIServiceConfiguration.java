...
class AnnotationSuppliedGenesisIIServiceConfiguration implements GenesisIIServiceConfiguration
{
	...
	private Class<? extends JAXBGenesisIIServiceConfiguration> _jaxbServiceConfigurationClass = null;
	...
	AnnotationSuppliedGenesisIIServiceConfiguration(GeniiServiceConfiguration serviceConfiguration)
	{
		if (serviceConfiguration != null) {
			_resourceProvider = instantiate(serviceConfiguration.resourceProvider());
			_defaultAuthZProvider = instantiate(serviceConfiguration.defaultAuthZProvider());
			_defaultResolverFactoryProxy = instantiate(serviceConfiguration.defaultResolverFactoryProxy());

			_defaultServiceCertificateLifetime = getPositiveLong(serviceConfiguration.defaultServiceCertificateLifetime());
			_defaultResourceCertificateLifetime = getPositiveLong(serviceConfiguration.defaultResourceCertificateLifetime());

			_jaxbServiceConfigurationClass = getNonInterfaceClass(serviceConfiguration.jaxbServiceConfigurationClass());
		}
	}
