...
public class GenesisIIServiceConfigurationOld {
	...
	static private GenesisIIServiceConfigurationOld discoverServiceConfiguration(
		...
		while (serviceClass != Object.class) {
			GeniiServiceConfiguration conf = serviceClass
			...
			if (conf != null) {
				...
				if (resolverFactoryProxyClass == null)
					resolverFactoryProxyClass = conf
		...
		return new GenesisIIServiceConfigurationOld(resourceProviderClass,
				authzProviderClass, resolverFactoryProxyClass);
	}
