...
public class ContainerConfiguration
{
	...
	public ContainerConfiguration(ConfigurationManager manager)
	{
		...
		String useSSLString = Installation.getDeployment(name).webContainerProperties()
			.getProperty(WebContainerConstants.USE_SSL_PROP);
		...
		String trustSelfSigned = Installation.getDeployment(name).webContainerProperties()
	...
	{
		String sListenPort = Installation.getDeployment(new DeploymentName()).webContainerProperties()
			.getProperty(WebContainerConstants.LISTEN_PORT_PROP, _DEFAULT_LISTEN_PORT_VALUE);
		_listenPort = Integer.parseInt(sListenPort);

		String dListenPort = Installation.getDeployment(new DeploymentName()).webContainerProperties()
