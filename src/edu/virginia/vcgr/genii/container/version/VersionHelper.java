...
public class VersionHelper
{
	...
	static private Version getMinimumVersion(
		Class<?> cl, String methodName, Class<?> []parameterTypes)
	{
	...
	static private Version getUncachedMinimumVersion(Method targetMethod)
	{
		...
		return getMinimumVersion(cl.getSuperclass(), targetMethod.getName(), 
	...
	static public void checkVersion(Version clientVersion, Method targetMethod)
