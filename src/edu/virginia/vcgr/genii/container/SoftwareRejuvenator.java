...
public class SoftwareRejuvenator
{
	...
	static public void startRejuvenator()
	{
		...
		try {
			...
			_logger.warn(String.format("Unable to parse softare rejuvenation cycle string \"%s\".", rejuvCycleString), e);
		}
	}
	...
	static private class Rejuvenator implements Runnable
	{
		...
		public void run()
		{
			...
			_logger.info("Software rejuvenator exiting the container for a restart.");
			System.exit(42);
		}
	}
}