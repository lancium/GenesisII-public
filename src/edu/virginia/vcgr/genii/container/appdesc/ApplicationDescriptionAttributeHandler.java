...
public class ApplicationDescriptionAttributeHandler extends
	...
	private String getApplicationDescription() throws ResourceException,
		...
		return (String) resource
				.getProperty(ApplicationDescriptionServiceImpl.APPLICATION_DESCRIPTION_PROPERTY_NAME);
	}
	...
	private ApplicationVersion getApplicationVersion()
		...
		return (ApplicationVersion) resource
				.getProperty(ApplicationDescriptionServiceImpl.APPLICATION_VERSION_PROPERTY_NAME);
	}
	...
	protected void registerHandlers() throws NoSuchMethodException {
		...
		addHandler(ApplicationDescriptionConstants.SUPPORT_DOCUMENT_ATTR_QNAME,
