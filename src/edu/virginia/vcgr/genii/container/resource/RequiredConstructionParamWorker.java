...
public class RequiredConstructionParamWorker {
	static public void setRequiredConstructionParameters(IResource resource,
		...
		X509Certificate[] certChain = (X509Certificate[]) consParms
		...
		try {
			...
			throw new ResourceException(
					"Could not initialize AuthZ for resource: "
							+ e.getMessage(), e);
		}
	}
}
