...
public class BasicDBResource implements IResource
{
	...
	public void destroy() throws ResourceException
	{
		...
		// ASG 2021-04-23. AccessMatrix removal done. 
		// Resource2 record removal done by ResourceSummary.removeResources(_connection, _resourceKey);
		// Resource and associated service type records removed by service.deleteRecords(_resourceKey);
		try {
