...
public class BasicDBResourceFactory implements IResourceFactory {
	static private Log _logger = LogFactory
			.getLog(BasicDBResourceFactory.class);
	...
	public BasicDBResourceFactory(ServerDatabaseConnectionPool pool)
			throws SQLException {
		_pool = pool;
		createTables();
		upgradeTables();
	...
	protected void createTables() throws SQLException {
		...
		try {
			...
			DatabaseTableUtils.createTables(conn, false,
					_CREATE_UNKNOWN_ATTRS_TABLE_STMT, _CREATE_KEY_TABLE_STMT,
					_CREATE_PROPERTY_TABLE_STMT, _CREATE_MATCHING_PARAMS_STMT,
