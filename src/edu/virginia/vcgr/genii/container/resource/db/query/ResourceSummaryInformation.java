...
public class ResourceSummaryInformation {
	...
	ResourceSummaryInformation(String resourceID, String humanName, String epi,
			String implementingClassString) {
	...
	final public Class<?> implementingClass() throws ClassNotFoundException {
		synchronized (_implementingClassString) {
			if (_implementingClass == null) {
				_implementingClass = GenesisClassLoader.classLoaderFactory()
						.loadClass(_implementingClassString);
			}
		}
