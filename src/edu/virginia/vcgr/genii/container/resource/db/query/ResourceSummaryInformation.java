...
public class ResourceSummaryInformation
{
	...
	ResourceSummaryInformation(String resourceID, String humanName, String epi, String implementingClassString)
	{
	...
	final public Class<?> implementingClass() throws ClassNotFoundException
	{
	...
	{
		if (_humanName == null)
			return String.format("[%s] %s@%s", _implementingClassString, _resourceID, _epi);
		else
			return String.format("%s [%s] %s@%s", _humanName, _implementingClassString, _resourceID, _epi);
	}
}