		...
		IResourceFactory
{
	...
	static private String _CREATE_ENTRY_INDEX_STMT = "CREATE INDEX idx ON entries (id)";
		...
		// will be there beforehand when the container itself is created after the caching related update.
		static private final String _ADD_ENDPOINT_ID_COLUMN_STMT = 
			"ALTER TABLE entries ADD COLUMN endpoint_id VARCHAR(128)";
