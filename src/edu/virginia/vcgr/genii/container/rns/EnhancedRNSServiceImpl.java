...
{	
	...
	protected EnhancedRNSServiceImpl(String serviceName)
	 ...
	 * if this directory has a policy that new resources must be registered with a resolver,
	 * then register the resource and return an EPR that includes the resolver reference.
	 */
	private EndpointReferenceType prepareEPRToStore(EndpointReferenceType entryReference)
		throws RemoteException
	{
		...
		extends AbstractNotificationHandler<RNSOperationContents>
	{
		...
		private String processAddEntryName(String entryName, boolean replay, IRNSResource resource)
