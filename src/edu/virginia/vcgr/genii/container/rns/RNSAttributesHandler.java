...
public class RNSAttributesHandler extends AbstractAttributeHandler {
	...
	public RNSAttributesHandler(AttributePackage pkg)
	...
	public MessageElement getElementCount() throws ResourceUnknownFaultType,
		...
		resource = (IRNSResource) (ResourceManager.getCurrentResource()
				.dereference());
		Object elementCount = null;
		if (!resource.isServiceResource()) {
			elementCount = resource
					.getProperty(IRNSResource.ELEMENT_COUNT_PROPERTY);
		}
		return new MessageElement(RNSConstants.ELEMENT_COUNT_QNAME,
				elementCount);
	}
}
