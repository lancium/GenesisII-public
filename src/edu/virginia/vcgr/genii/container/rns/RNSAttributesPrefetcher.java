...
public class RNSAttributesPrefetcher extends DefaultGenesisIIAttributesPreFetcher<IRNSResource>
{
	...
	public RNSAttributesPrefetcher(EndpointReferenceType target) throws ResourceException, ResourceUnknownFaultType
	{
	...
	protected void fillInAttributes(Collection<MessageElement> attributes)
	{
		...
		try {
			Integer elementCount = (Integer) getResource().getProperty(IRNSResource.ELEMENT_COUNT_PROPERTY);
