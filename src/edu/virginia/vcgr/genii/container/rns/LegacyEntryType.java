...
final public class LegacyEntryType
{
	...
	public LegacyEntryType(String entryName, MessageElement[] any, EndpointReferenceType epr)
	{
	...
	public LegacyEntryType(String entryName, RNSMetadataType mdt, EndpointReferenceType epr)
	{
	...
	{
		return new RNSEntryType(_epr, RNSUtilities.createMetadata(_epr, _any), _entryName);
	}

	final public RNSEntryResponseType toEntryResponseType()
	{
		return new RNSEntryResponseType(_epr, RNSUtilities.createMetadata(_epr, _any), null, _entryName);
	}
}