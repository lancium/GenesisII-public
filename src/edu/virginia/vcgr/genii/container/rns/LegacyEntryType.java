...
final public class LegacyEntryType {
	...
	final public RNSEntryType toEntryType() {
		return new RNSEntryType(_epr, RNSUtilities.createMetadata(_epr, _any),
				_entryName);
	}

	final public RNSEntryResponseType toEntryResponseType() {
		return new RNSEntryResponseType(_epr, RNSUtilities.createMetadata(_epr,
				_any), null, _entryName);
	}
}