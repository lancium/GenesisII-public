...
public class VersionedResourceAttributeHandlers extends
	...
	public MessageElement getUnlinkedReplicaAttr()
			throws ResourceUnknownFaultType, ResourceException {
		ResourceKey rKey = ResourceManager.getCurrentResource();
		IResource resource = (IResource) rKey.dereference();
		String value = (String) resource
				.getProperty(SyncProperty.UNLINKED_REPLICA_PROP_NAME);
		if (value == null)
			return null;
		return new MessageElement(SyncProperty.UNLINKED_REPLICA_QNAME, value);
	}

	public void setUnlinkedReplicaAttr(MessageElement element)
	...
	protected void registerHandlers() throws NoSuchMethodException {
		...
		addHandler(SyncProperty.REPLICATION_STATUS_QNAME,
				"getReplicationStatusAttr");
		addHandler(SyncProperty.UNLINKED_REPLICA_QNAME,
				"getUnlinkedReplicaAttr", "setUnlinkedReplicaAttr");
	}
}
