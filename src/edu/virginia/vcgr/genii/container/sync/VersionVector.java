 ...
 */
public class VersionVector extends
		edu.virginia.vcgr.genii.client.sync.VersionVector {
	...
	private Object readResolve() throws ObjectStreamException {
		...
		for (int i = 0; i < vector.length; i++) {
			realVector[i] = new edu.virginia.vcgr.genii.client.sync.VersionItem(
					vector[i].uid, vector[i].version);
		}
