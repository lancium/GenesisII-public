...
public class VersionVector implements Serializable
{
	...
	/**
	 * Version vectors are very short (usually one to four items) so we use a linear search.
	 * They are made to be sent across a network, so we use a compact data structure.
	 */
