...
public class SyncProperty
{
	...
	static public final String TARGET_ID_PROP_NAME = "edu.virginia.vcgr.genii.sync.target-id";
	static public final String VERSION_VECTOR_PROP_NAME = "edu.virginia.vcgr.genii.sync.version-vector";
	static public final String ERROR_STATE_PROP_NAME = "edu.virginia.vcgr.genii.sync.error-state";
