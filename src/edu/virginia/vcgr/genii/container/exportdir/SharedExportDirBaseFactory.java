...
{
	static private final String _CREATE_EXPORTED_FILE_TABLE_STMT = "CREATE TABLE exportedfile (fileid VARCHAR(40) PRIMARY KEY,"
	...
	static private final String _CREATE_EXPORTED_DIR_ENTRY_TABLE_STMT = "CREATE TABLE exporteddirentry "
