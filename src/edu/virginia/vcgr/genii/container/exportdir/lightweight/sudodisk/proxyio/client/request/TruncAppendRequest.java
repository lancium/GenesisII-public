...
public class TruncAppendRequest{
	...
	/**
	 * Forms a truncappend request and sends it to the proxyserver.
	 * A trunc apprend request is of the form:
	 * |nonce|file/dir|command|path-len|path|seekoffset|
	 * len of buffer to append|append buffer
	 */
