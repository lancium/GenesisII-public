...
class SVNPathIdentifier {
	...
	SVNPathIdentifier(SVNRepository repository, String svnRepositoryURL,
	...
	final public boolean equals(Object other) {
		if (other instanceof SVNPathIdentifier) {
			...
			return (_svnRepositoryURL.equals(otherPath._svnRepositoryURL)
					&& _relativePath.equals(otherPath._relativePath) && _revision == otherPath._revision);
		} else
			return false;
	}
	...
	final public String toString() {
		return String.format("%s%s@%d", _svnRepositoryURL,
