...
class SVNPathIdentifier
{
	...
	SVNPathIdentifier(SVNRepository repository, String svnRepositoryURL, String relativePath, long revision)
	{
	...
	{
		return (int) (_svnRepositoryURL.hashCode() ^ _relativePath.hashCode() ^ _revision);
	}

	@Override
	final public String toString()
	{
		return String.format("%s%s@%d", _svnRepositoryURL, _relativePath.length() == 0 ? "" : "/" + _relativePath, _revision);
	}
}