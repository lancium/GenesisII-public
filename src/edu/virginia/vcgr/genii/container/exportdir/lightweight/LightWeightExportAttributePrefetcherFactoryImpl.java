...
public class LightWeightExportAttributePrefetcherFactoryImpl 
	implements AttributesPreFetcherFactory 
{
	
	static private Log _logger = LogFactory.getLog(
			LightWeightExportAttributePrefetcherFactoryImpl.class);
			...
			throws Throwable
	{
		...
		if ( (fork = getMyRandomByteIOFork(epr, rKey, service)) != null)
		{
			...
			{
				return new ExportedRandomByteIOForkAttributePrefetcher(
					rKey, fork.getForkPath());								
			} 						
