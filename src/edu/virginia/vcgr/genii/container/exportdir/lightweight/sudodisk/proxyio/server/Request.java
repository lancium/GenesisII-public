...
public class Request
{
	...
	public Request(PathType type, String cmd, String path, int buflen, long[] args)
	{
		_type = type;
		_cmd = cmd;
		_path = path;
	 ...
	 * 
	 * @param socket
	 *            The socket attached with the request on which the response needs to be sent on.
	 */
