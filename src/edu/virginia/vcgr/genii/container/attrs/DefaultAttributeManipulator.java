...
public class DefaultAttributeManipulator implements IAttributeManipulator
{
	...
	private DefaultAttributeManipulator(Object target, QName attrQName, Method getterMethod, Method setterMethod, boolean isSingleSet)
	{
		_target = target;
	...
	@SuppressWarnings("unchecked")
	static public IAttributeManipulator createManipulator(Object target, QName attributeName, String getMethodName, String setMethodName)
		throws NoSuchMethodException
	{
