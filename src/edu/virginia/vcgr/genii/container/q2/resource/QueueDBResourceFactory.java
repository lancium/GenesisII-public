...
public class QueueDBResourceFactory extends BasicDBResourceFactory
{
	...
	static private final String[] _CREATE_STMTS = new String[] {
		...
		"CREATE TABLE q2jobs (" + "jobid BIGINT GENERATED ALWAYS AS IDENTITY PRIMARY KEY, " + "jobticket VARCHAR(256) NOT NULL, "
			...
			+ "owners BLOB(2G) NOT NULL," + "priority SMALLINT NOT NULL," + "state VARCHAR(64) NOT NULL, "
			+ "submittime TIMESTAMP NOT NULL, " + "starttime TIMESTAMP, " + "finishtime TIMESTAMP, " + "runattempts SMALLINT NOT NULL, "
			+ "jobendpoint BLOB(2G), " + "resourceid BIGINT, " + "resourceendpoint BLOB(2G), "
		...
		"CREATE TABLE q2jobhistorytokens(" + "entryid BIGINT GENERATED ALWAYS AS IDENTITY PRIMARY KEY, " + "jobid BIGINT NOT NULL, "
			+ "queueid VARCHAR(256) NOT NULL, " + "historytoken BLOB(2G) NOT NULL)", "CREATE INDEX q2joberrorsjobididx ON q2errors(jobid)",
