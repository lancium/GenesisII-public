...
final public class JobFork extends AbstractRNSResourceFork
{
	...
	final public Iterable<InternalEntry> list(EndpointReferenceType exemplarEPR, String entryName) throws IOException
	{
		...
		if (entryName == null || entryName.equals("activity")) {
			try {
				...
				_logger.warn("Error trying to get activity information for fork!", cause);
			}
		}
	...
	final public EndpointReferenceType add(EndpointReferenceType exemplarEPR, String entryName, EndpointReferenceType entry)
		throws IOException
	{
		throw new UnsupportedOperationException("Not permitted to add new entries to a Queue job fork!");
	}
	...
	{
		throw new UnsupportedOperationException("Not permitted to remove entries from a Queue job fork!");
	}
