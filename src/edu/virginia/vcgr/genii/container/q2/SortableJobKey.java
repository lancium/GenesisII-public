...
/**
 * We need to be able to sort jobs by their priority and submit time. This class
 * groups together information about a job necessary to do that sort.
 * 
 * @author mmm2a
 */
public class SortableJobKey implements Comparable<SortableJobKey> {
	...
	public SortableJobKey(JobData jobData) {
		this(jobData.getJobID(), jobData.getPriority(), jobData.getSubmitTime());
	}
	 ...
	 * 
	 * @param other
	 *            THe other job key against which to compare.
	 * 
	...
	/**
	 * Java requires that if you overload equals, you have to do it for the
	 * method signature equals(Object).
	 */
	public boolean equals(Object other) {
		/*
		 * If the other object IS a sortable job key, call through to out other
		 * equals method.
		 */
	 ...
	 * @return If "this" object is less than the "other" object, return a
	 *         negative integer, if greater, return a positive integer, if
	 *         equal, return 0.
	 */
