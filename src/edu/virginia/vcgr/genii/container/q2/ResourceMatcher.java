...
/**
 * This class matches job id's to bes id's. It's used during the scheduling
 * phase.
 * 
 * @author mmm2a
 */
public class ResourceMatcher {
	/**
	 * This operation indicates whether or not the given job can be run on the
	 * indicated bes container.
	 * 
	 * @param jobID
