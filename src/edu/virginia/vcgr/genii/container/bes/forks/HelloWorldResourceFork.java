...
public class HelloWorldResourceFork extends
		AbstractStreamableByteIOFactoryResourceFork {
	public HelloWorldResourceFork(ResourceForkService service, String forkPath) {
	...
	public void modifyState(InputStream source) throws IOException {
		throw new IOException(
				"Not allowed to modify the the hello world summary.");
	}
