...
public class PassiveStreamRedirectionDescription implements Serializable
{
	...
	public PassiveStreamRedirectionDescription(File stdinSource, File stdoutSink, File stderrSink)
	{
	...
	final public File stderrSink(File workingDirectory)
	{
		if (_stderrSink != null)
			...
			if (workingDirectory != null)
				return new File(workingDirectory, String.format("%s.stderr", new GUID()));
		}
