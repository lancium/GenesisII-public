...
public class CloudCopyDirectoryPhase extends AbstractCloudExecutionPhase implements Serializable
{
	...
	public CloudCopyDirectoryPhase(String localDir, String remoteDir, String activityID, String besid)
	{
		_localDir = localDir;
	...
	public void execute(ExecutionContext context) throws Throwable
	{
		...
		HistoryContext history = HistoryContextFactory.createContext(HistoryEventCategory.CloudSetup);

		history.createInfoWriter("Setting up working directory").close();

		tryExecuteCommand(resourceID, "mkdir " + _workingDir, System.out, System.err, tManage);

		copyDirectory(tManage, new File(_workingDir), lDir, resourceID, System.out, System.err);
