...
public class CloudGenerateRunScriptPhase implements ExecutionPhase, Serializable
{
	...
	public void execute(ExecutionContext context) throws Throwable
	{
		try {
			...
			ps.println(
				_genDir + "grid stageData --direction=\"in\" " + "--type=\"binary\" " + _workingDir + " local:" + _workingDir + _jobFile);
			...
			ps.println("export GENII_USER_DIR=" + _workingDir + _genState);
			ps.println(
				_genDir + "grid stageData --direction=\"out\" " + "--type=\"binary\" " + _workingDir + " local:" + _workingDir + _jobFile);
