...
{
	static private final String _CREATE_REXPORT_TABLE_STMT = "CREATE TABLE rexport "
		+ "(dirid VARCHAR(40) PRIMARY KEY, path VARCHAR(512), parentIds VARCHAR(4096))";
	static private final String _CREATE_REXPORT_ENTRY_TABLE_STMT = "CREATE TABLE rexportentry "
		+ "(dirid VARCHAR(40), name VARCHAR(256), endpoint BLOB(2G), " + "entryid VARCHAR(40), type CHAR(1), "
		+ "CONSTRAINT rexportentryconstraint1 PRIMARY KEY (dirid, name))";
	static private final String _CREATE_REXPORT_ATTR_TABLE_STMT = "CREATE TABLE rexportentryattr "
