...
public class RExportResolverEntry {
	 ...
	 */
	public RExportResolverEntry(URI commonEPI,
			EndpointReferenceType primaryEPR, EndpointReferenceType replicaEPR,
			URI resolverEPI, EndpointReferenceType resolverEPR,
			String primaryLocalPath, EndpointReferenceType resolverServiceEPR) {
	...
	/**
	 * Creates new entry with all but replicaEPR parameters set. commonEPI is
	 * extracted from passed in primaryEPR.
	 * 
	 * @param primaryEPR
	 * @param resolverEPI
	 * @param resolverEPR
	 ...
	 */
	public RExportResolverEntry(EndpointReferenceType primaryEPR,
			URI resolverEPI, EndpointReferenceType resolverEPR,
			String primaryLocalPath, EndpointReferenceType resolverServiceEPR)
