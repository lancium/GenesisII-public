...
public class RExportDBResource extends BasicDBResource implements IRExportResource
{
	...
	static private final String _ADD_ENTRY = "INSERT INTO rexport VALUES(?, ?, ?)";

	static private final String _RETRIEVE_DIR_INFO = "SELECT path, parentIds FROM rexport WHERE dirid = ?";
	...
	static private final String _DELETE_REXPORT_ENTRY_STMT = "DELETE FROM rexportentry WHERE entryid = ?";

	static private final String _ADD_ENTRY_STMT = "INSERT INTO rexportentry VALUES(?, ?, ?, ?, ?)";
	...
	static private final String _DELETE_REXPORT_STMT = "DELETE FROM rexport WHERE dirid = ?";

	// get all dirids that match parentId
	static private final String _RETRIEVE_ALL_DIR_IDS_FOR_PARENT_STMT = "SELECT dirid FROM rexport WHERE parentIds LIKE ?";
