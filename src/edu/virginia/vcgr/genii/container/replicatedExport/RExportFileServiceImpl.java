...
public class RExportFileServiceImpl extends RandomByteIOServiceImpl implements
		RExportFilePortType {
	static private Log _logger = LogFactory
			.getLog(RExportFileServiceImpl.class);
	...
	public RNSEntryResponseType[] remove(String[] removeRequest)
		...
		throw new RemoteException(
				"remove operation not supported in replicated export");
	}
	...
	public RNSEntryResponseType[] rename(NameMappingType[] renameRequest)
			throws RemoteException, WriteNotPermittedFaultType {
		throw new RemoteException(
				"rename operation not supported in replicated export");
	}
	...
	public RNSEntryResponseType[] setMetadata(
		...
		throw new RemoteException(
				"setMetadata operation not supported in replicated export");
	}
	...
	public RNSEntryResponseType[] add(RNSEntryType[] addRequest)
			throws RemoteException, WriteNotPermittedFaultType {
		throw new RemoteException(
				"add operation not supported in replicated export");
	}
	...
	public LookupResponseType lookup(String[] lookupRequest)
		...
		throw new RemoteException(
				"lookup operation not supported in replicated export");
	}
