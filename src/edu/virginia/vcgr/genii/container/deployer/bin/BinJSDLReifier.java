...
public class BinJSDLReifier extends AbstractReifier implements IJSDLReifier,
		Serializable {
	...
	public String[] getAdditionalLibraryPaths(File deployDirectory) {
		return new String[] { new File(deployDirectory, "lib")
				.getAbsolutePath() };
	}

	@Override
	public String[] getAdditionalPaths(File deployDirectory) {
		return new String[] { new File(deployDirectory, "bin")
				.getAbsolutePath() };
	}
