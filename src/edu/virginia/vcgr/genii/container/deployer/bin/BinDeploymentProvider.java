...
public class BinDeploymentProvider extends AbstractDeploymentProvider
	implements IDeployerProvider
{
	...
	{
		HashMap<String, File> relativeMap =
		...
		{
			for (RelativeNamedSourceType source : 
				_deploymentDescription.getStaticFile())
			{
				File target;
