...
public class GridFilesystem extends Filesystem
{
	...
	static final public Pattern MOUNT_SOURCE_PATTERN = Pattern.compile(
		"^rns:(.+)$");
	
	static final public FileSystemTypeEnumeration FILESYSTEM_TYPE =
		FileSystemTypeEnumeration.normal;
