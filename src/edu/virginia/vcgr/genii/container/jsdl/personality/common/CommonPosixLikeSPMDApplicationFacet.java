...
public class CommonPosixLikeSPMDApplicationFacet extends
		DefaultSPMDApplicationFacet {
	@Override
	public void consumeNumberOfProcesses(Object currentUnderstanding,
		...
		if (useActualCPUCount)
			throw new UnsupportedJSDLElement(new QName(
					SPMDConstants.JSDL_SPMD_NS, "useActualCPUCount"));

		((PosixLikeApplicationUnderstanding) currentUnderstanding)
				.setNumProcesses(numberOfProcesses.intValue());
	}
	...
	public void consumeProcessesPerHost(Object currentUnderstanding,
		...
		((PosixLikeApplicationUnderstanding) currentUnderstanding)
				.setNumProcessesPerHost(processesPerHost.intValue());
	}
	...
	public void consumeSPMDVariation(Object currentUnderstanding,
		...
		((PosixLikeApplicationUnderstanding) currentUnderstanding)
				.setSPMDVariation(spmdVariation);
	}
	...
	public void consumeArgument(Object currentUnderstanding,
		...
		if (filesystemName == null)
			...
			arg = new StringOrPath(new FilesystemRelativePath(filesystemName,
					argument));
	...
	public void consumeWorkingDirectory(Object currentUnderstanding,
		...
		if (filesystemName != null)
			throw new UnsupportedJSDLElement(new QName(
					JSDLPosixConstants.JSDL_POSIX_NS, "filesystemName"));
	...
	public void consumeEnvironment(Object currentUnderstanding, String name,
		...
		if (filesystemName == null)
			...
			env = new StringOrPath(new FilesystemRelativePath(filesystemName,
					environment));
	...
	public void consumeInput(Object currentUnderstanding,
		...
		((PosixLikeApplicationUnderstanding) currentUnderstanding)
				.setStdinRedirect(new FilesystemRelativePath(filesystemName,
						input));
	}
	...
	public void consumeOutput(Object currentUnderstanding,
		...
		((PosixLikeApplicationUnderstanding) currentUnderstanding)
				.setStdoutRedirect(new FilesystemRelativePath(filesystemName,
						output));
	}
	...
	public void consumeError(Object currentUnderstanding,
		...
		((PosixLikeApplicationUnderstanding) currentUnderstanding)
				.setStderrRedirect(new FilesystemRelativePath(filesystemName,
						error));
	}
	...
	public void consumeExecutable(Object currentUnderstanding,
		...
		((PosixLikeApplicationUnderstanding) currentUnderstanding)
				.setExecutable(new FilesystemRelativePath(filesystemName,
						executable));
	}
}