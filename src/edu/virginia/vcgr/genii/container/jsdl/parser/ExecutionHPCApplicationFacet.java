...
{
	@Override
	public void consumeWorkingDirectory(Object currentUnderstanding, String workingDirectory)
	{
		JobRequest jr = (JobRequest) currentUnderstanding;
		jr.setWorkingDirectory(new FilesystemRelative<String>(null, workingDirectory));
	}
	...
	@Override
	public void consumeEnvironment(Object currentUnderstanding, String name, String environment)
	{
		JobRequest jr = (JobRequest) currentUnderstanding;
		jr.addEnvironmentVariable(name, new FilesystemRelative<String>(null, environment));
	}

	@Override
	public void consumeInput(Object currentUnderstanding, String redirect)
	{
		JobRequest jr = (JobRequest) currentUnderstanding;
	...
	@Override
	public void consumeOutput(Object currentUnderstanding, String redirect)
	{
		JobRequest jr = (JobRequest) currentUnderstanding;
	...
	@Override
	public void consumeError(Object currentUnderstanding, String redirect)
	{
		JobRequest jr = (JobRequest) currentUnderstanding;
