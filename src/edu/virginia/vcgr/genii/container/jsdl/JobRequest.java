...
public class JobRequest implements Serializable
{
	...
	private Map<String, FilesystemRelative<String>> _environment =
		new HashMap<String, FilesystemRelative<String>>();
	
	private FilesystemRelative<String> _workingDirectory = null;
	
	private FilesystemRelative<String> _executable = null;
	private List<FilesystemRelative<String>> _arguments =
		new LinkedList<FilesystemRelative<String>>();
