...
/*
 * This identifies the client accessing the container. The client is supposed to generate a GUID
 * that will uniquely identify it in the container. Since GUID's are random strings and we use SSL
 * for transport layer security, chance sniffing and using another client's GUID is very low. The
