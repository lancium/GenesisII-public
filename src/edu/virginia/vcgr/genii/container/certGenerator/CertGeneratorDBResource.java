...
public class CertGeneratorDBResource extends BasicDBResource implements
		ICertGeneratorResource {
	...
	public CertGeneratorDBResource(ResourceKey parentKey,
	...
	public void setCertificateIssuerInfo(GenesisHashMap creationParameters)
		...
		setProperty(
				_DEFAULT_VALIDITY_PROPERTY_NAME,
				creationParameters
						.get(CertGeneratorUtils.CERT_GENERATOR_DEFAULT_VALIDITY_CONSTRUCTION_PARAMETER)
						.toString());
