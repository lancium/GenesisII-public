...
public class TestSystemInfo
{
    ...
    public void runTest()
    {
        ...
        System.out.println("\nReport for system:");
        System.out.println(String.format("  cpu speed=%d  user logged in=%b  screensaver active=%b",
                cpuspeed, loggedin, screensaving));
        System.out.println(String.format("  total physical memory=%d & available=%d", physmem,
                physmemavail));
        System.out.println(String.format("  total virtual memory=%d & available=%d", virtmem,
                virtmemavail));
    }
