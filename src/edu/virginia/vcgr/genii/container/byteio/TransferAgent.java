...
public class TransferAgent
{
	...
	static public byte[] receiveData(TransferInformationType transType) throws RemoteException
	{
		...
		} else if (transMech.equals(ByteIOConstants.TRANSFER_TYPE_DIME_URI) || transMech.equals(ByteIOConstants.TRANSFER_TYPE_MTOM_URI)) {
	...
	/**
	 * If a block of data was attached to the message in a self-identifying format such as MTOM or DIME, then extract the data from the
	 * message.
	 */
