...
public class DefaultRandomByteIOAttributePreFetcher extends
		RandomByteIOAttributePreFetcher<IRByteIOResource> {
	...
	public DefaultRandomByteIOAttributePreFetcher(EndpointReferenceType target)
		...
		this((IRByteIOResource) ResourceManager.getTargetResource(target)
				.dereference());
	}
