...
public abstract class StreamableByteIOAttributePreFetcher<Type extends IResource> extends ByteIOAttributePreFetcher<Type>
{
	...
	static final private QName ACCESS_TIME_ATTR_NAME = new QName(ByteIOConstants.STREAMABLE_BYTEIO_NS,
		ByteIOConstants.ACCESSTIME_ATTR_NAME);
	static final private QName MOD_TIME_ATTR_NAME = new QName(ByteIOConstants.STREAMABLE_BYTEIO_NS,
		ByteIOConstants.MODTIME_ATTR_NAME);
	static final private QName CREATE_TIME_ATTR_NAME = new QName(ByteIOConstants.STREAMABLE_BYTEIO_NS,
