...
public class TimingSink
{
	...
	static final private String CONTEXT_PROPERTY_NAME =
		"edu.virginia.vcgr.genii.container.invoker.timing.sink";
	
	static TimingSink createTimingSink(Class<?> serviceClass,
		Method targetMethod)
	{
		...
		{
			_logger.warn("Unable to set timing sink for working context.", 
				cause);
		}
	...
	static public TimingSink sink()
	{
		...
		{
			_logger.warn("Unable to get timing sink for working context.",
				cause);
		}
	...
	private Map<String, List<Long>> _events =
	...
	private TimingSink(Class<?> serviceClass,
		Method targetMethod)
	{
