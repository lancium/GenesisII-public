...
public class ResourceMInjectResolver implements MInjectResolver {
	...
	public boolean handles(MInject arg, Class<?> targetType) {
		return (arg.name().isEmpty() && (IResource.class
				.isAssignableFrom(targetType)
				|| ResourceLock.class.isAssignableFrom(targetType) || StringResourceIdentifier.class
					.isAssignableFrom(targetType)));
	}
