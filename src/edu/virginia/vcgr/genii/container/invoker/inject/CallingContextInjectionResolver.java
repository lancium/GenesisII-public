...
public class CallingContextInjectionResolver implements MInjectResolver {
	@Override
	public boolean handles(MInject arg, Class<?> targetType) {
		return (arg.name().isEmpty() && ICallingContext.class
	...
	public <Type> Type resolve(MInject arg, Class<Type> targetType)
		...
		try {
			return targetType.cast(ContextManager.getExistingContext());
		} catch (IOException e) {
