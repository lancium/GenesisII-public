...
@GeniiServiceConfiguration(
	...
	defaultAuthZProvider=KerbAuthZProvider.class)
public class KerbAuthnServiceImpl extends GenesisIIBase
	implements KerbAuthnPortType
{
			...
			throws ResourceException, BaseFaultType, RemoteException
	{
		...
		resource.setProperty(SecurityConstants.NEW_KERB_IDP_REALM_QNAME
				.getLocalPart(), realm);
		...
		resource.setProperty(SecurityConstants.NEW_KERB_IDP_KDC_QNAME
				.getLocalPart(), kdc);
		...
		try
		{
			// Create our own signed assertion to give out
		...
		RequestSecurityTokenType request) throws java.rmi.RemoteException
	{
		...
		for (InternalEntry entry : entries)
		{
			...
			try
			{
				...
				KerbAuthnPortType idp =
						ClientUtils
								.createProxy(KerbAuthnPortType.class, idpEpr);
	...
	static public class KerbAuthnAttributeHandlers extends
			AbstractAttributeHandler
	{
		public KerbAuthnAttributeHandlers(AttributePackage pkg)
