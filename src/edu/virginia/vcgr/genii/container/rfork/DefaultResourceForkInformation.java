...
public class DefaultResourceForkInformation implements ResourceForkInformation
{
	...
	public DefaultResourceForkInformation(
		Class<? extends ResourceFork> resourceForkClass,
		String forkPath)
	{
		...
		throws ResourceException
	{
		...
		{
			throw new ResourceException(
				"Unable to instantiate resource fork.",	e);
		}
		...
		} catch (InvocationTargetException e)
		{
			...
			throw new ResourceException(
				"Unable to instantiate resource fork.",	cause);
		}
	}
	...
	{
		_constructor = null;
		_resourceForkClass = (Class<? extends ResourceFork>)Class.forName(
			in.readUTF());
