...
public class RandomByteIOForkAttributePreFetcher extends
		RandomByteIOAttributePreFetcher<IResource> {
	private RandomByteIOResourceFork _fork;

	public RandomByteIOForkAttributePreFetcher(IResource resource,
