 ...
 * entries. In fact, they can change any time the resource is constructed, but
 * that behavior is incidental and should not be relied upon.
 * 
 * @author mmm2a
 */
public abstract class StaticRNSResourceFork extends ReadOnlyRNSResourceFork {
	...
	/**
	 * This is a convenience method which allows a sub-class to easily add an
	 * entry which uses the default resource fork information structure.
	 * 
	 * @param entryName
	...
	protected void addDefaultEntry(String entryName,
		...
		_entries.put(entryName, new DefaultResourceForkInformation(forkClass,
				getForkPath() + "/" + entryName));
	}

	/**
	 * This abstract method is called automatically to add the entries into this
	 * static resource fork.
	 * 
	 * @param entries
