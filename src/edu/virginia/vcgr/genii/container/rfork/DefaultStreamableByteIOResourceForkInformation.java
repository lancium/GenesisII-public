...
public class DefaultStreamableByteIOResourceForkInformation 
	implements ResourceForkInformation
{
	...
	transient private StreamableByteIOFactoryResourceFork _dependentFork 
		= null;
	private String _containerFilename;
	
	public DefaultStreamableByteIOResourceForkInformation(
		String forkPath, StreamableByteIOFactoryResourceFork dependentFork,
			...
			throws ResourceException
	{
		if (_dependentFork == null)
			_dependentFork = (StreamableByteIOFactoryResourceFork)
				_dependentForkInfo.instantiateFork(forkService);
		
		try
		{
			return new DefaultStreamableByteIOResourceFork(
				forkService, _forkPath, _destroyOnClose, _doNotify,
				_dependentFork, _containerFilename);
		}
