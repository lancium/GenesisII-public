...
/**
 * This annotation is used by XMLStateTranslaters. When an XMLStateTranslater is used, the resource fork that implements
 * SimpleStateResourceFork MUST have this annotation on it's class.
 * 
 * @author mmm2a
 */
