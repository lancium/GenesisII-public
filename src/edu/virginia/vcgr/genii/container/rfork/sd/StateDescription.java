...
/**
 * This annotation is used to decorate SimpleStateResourceFork sub-classes. It describes whether or not the piece of state is readable or
 * writable, and which translator to use for state translations.
 * 
 * @author mmm2a
 */
