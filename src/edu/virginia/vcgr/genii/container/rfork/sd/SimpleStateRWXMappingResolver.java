	...
	public RWXCategory resolve(Class<?> serviceClass, Method operation)
	{
		...
		try
		{
			...
			if (operationName.equals("snapshotState"))
				...
				translateMethod = serviceClass.getDeclaredMethod("set", 
					getterMethod.getReturnType());
			else
				throw new RWXMappingException(
					"Target operation was not snapshotState or modifyState.");
		...
		{
			throw new RWXMappingException(
				"Couldn't find appropriate get/set methods on class \"" +
