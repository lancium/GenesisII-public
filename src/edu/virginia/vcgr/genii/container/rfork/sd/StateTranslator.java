 ...
 * from some input/output form.  It is used for the SimpleStateResourceFork
 * when new state is "copied" in or out.
 * 
 * @author mmm2a
 */
public interface StateTranslator
{
	 ...
	 * 
	 * @param <StateType> The type of state variable.
	 * @param originatingFork The fork which originated the translate request.
	 * @param targetType The desired type of the resultant state.
	 ...
	 * @param <StateType> The type of state variable.
	 * @param originatingFork The fork which originated the translate request.
	 * @param state The state variable to write out.
