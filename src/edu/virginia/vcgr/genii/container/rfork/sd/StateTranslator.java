...
/**
 * This interface is implemented by classes that will translate state variables from some input/output form. It is used for the
 * SimpleStateResourceFork when new state is "copied" in or out.
 * 
 * @author mmm2a
 */
