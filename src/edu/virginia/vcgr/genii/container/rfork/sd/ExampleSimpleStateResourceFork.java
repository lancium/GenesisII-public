...
/**
 * This is an example of a SimpleStateResourceFork. It is not intended to be
 * used.
 * 
 * @author mmm2a
 */
...
public class ExampleSimpleStateResourceFork extends
		SimpleStateResourceFork<Integer> {
	/**
	 * This just serves as our state variable. We don't even really have to have
	 * a state variable, just the get/set functions.
	 */
	private int _initialValue;

	/**
	 * Construct a new example with an initial value and the other required
	 * parameters.
	 * 
	 * @param initValue
	 * @param service
	...
	static public void main(String[] args) throws Throwable {
		ExampleSimpleStateResourceFork e = new ExampleSimpleStateResourceFork(
				7, null, "/test");
