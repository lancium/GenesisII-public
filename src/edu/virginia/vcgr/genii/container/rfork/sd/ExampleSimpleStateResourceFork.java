...
/**
 * This is an example of a SimpleStateResourceFork. It is not intended to be used.
 * 
 * @author mmm2a
 */
...
public class ExampleSimpleStateResourceFork extends SimpleStateResourceFork<Integer>
{
	...
	/**
	 * Construct a new example with an initial value and the other required parameters.
	 * 
	 * @param initValue
	 * @param service
	 * @param forkPath
	 */
	public ExampleSimpleStateResourceFork(int initValue, ResourceForkService service, String forkPath)
	{
	...
	{
		ExampleSimpleStateResourceFork e = new ExampleSimpleStateResourceFork(7, null, "/test");
