...
public enum ErrorClassification {
	...
	static public ClassifiedError classify(Throwable cause)
	{
		if (cause instanceof InterruptedException)
			...
			return new ClassifiedError(ROUTINE, "Security Exception", "Permission denied", cause);
		else if (cause instanceof RNSException)
			return new ClassifiedError(ROUTINE, "RNS Exception", "No authorization", cause);
		else if (cause instanceof AxisFault)
			return new ClassifiedError(ROUTINE, "Grid Communication Fault", cause.getMessage(), cause);
