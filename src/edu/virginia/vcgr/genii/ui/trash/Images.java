...
{
	static private final String RESOURCE_PATH_FORMAT = "edu/virginia/vcgr/genii/ui/trash/resources/%s";
	...
	static {
		try {
			_emptyTrashcan = loadImage(String.format(RESOURCE_PATH_FORMAT, "empty-trashcan.png"));
			_fullTrashcan = loadImage(String.format(RESOURCE_PATH_FORMAT, "full-trashcan.png"));
