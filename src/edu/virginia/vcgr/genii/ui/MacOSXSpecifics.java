...
public class MacOSXSpecifics
{
	...
	static private Object getApplicationObject() 
	...
	static public void setupMacOSApplication(ApplicationContext context)
	{
		try
		{
			...
			callVoidMethod(application, "addAboutMenuItem",
			...
			callVoidMethod(application, "addApplicationListener",
				new Class<?>[] { getApplicationListenerInterface() },
				new Object[] {
					Proxy.newProxyInstance(MacOSXSpecifics.class.getClassLoader(), 
						new Class<?> [] { getApplicationListenerInterface() }, 
	...
	static private class ApplicationListenerInvoker implements InvocationHandler
	{
		...
		static private void setApplicationEventHandled(Object eventObject,
			boolean result) throws SecurityException, IllegalArgumentException,
