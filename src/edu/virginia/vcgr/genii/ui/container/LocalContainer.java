...
{
	static final private String SERVICE_PATH_FORMAT =
		"%s/axis/services/%s";
	static final private String CONTAINER_SERVICE_NAME =
		...
		throws ContainerNotRunningException
	{
		...
		String urlString = String.format(SERVICE_PATH_FORMAT,
			_localContainer.getContainerURL(),
