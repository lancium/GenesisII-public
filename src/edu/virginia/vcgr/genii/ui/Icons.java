...
{
	static private final String RESOURCE_PATH_FORMAT = "edu/virginia/vcgr/genii/ui/resources/%s";
	...
	{
		return new ImageIcon(loadImage(String.format(RESOURCE_PATH_FORMAT, resourceName)));
	}
