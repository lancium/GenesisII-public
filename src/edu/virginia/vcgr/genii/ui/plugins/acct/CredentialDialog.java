...
class CredentialDialog extends JDialog
{
	...
	private CredentialDialog(Component ownerComponent, Connection connection) throws SQLException
	{
		super(SwingUtilities.getWindowAncestor(ownerComponent), "Accounting Credential Manager");
		...
		EnumComboBox<AccountingCredentialTypes> box = new EnumComboBox<AccountingCredentialTypes>(
			AccountingCredentialTypes.class, EnumComboSort.Alphabetically, true, null);
	...
	static Collection<CredentialBundle> manageCredentials(Component owner, Connection connection) throws SQLException
	{
