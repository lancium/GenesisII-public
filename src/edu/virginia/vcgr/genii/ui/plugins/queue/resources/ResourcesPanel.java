...
public class ResourcesPanel extends JPanel implements LazyLoadTabHandler
{
	...
	private class ResourceUpdateAction extends AbstractAction
	{
		...
		final public void actionPerformed(ActionEvent e)
		{
			...
			_context.uiContext().progressMonitorFactory().createMonitor(
				_table, "Forcing Resource Update",
	...
	private class BrowseAction extends AbstractAction
	{
		...
		final public void actionPerformed(ActionEvent e)
		{
			...
			try
			{
				...
				context.callingContext().setCurrentPath(new RNSPath(
					_model.row(row).endpoint()));
	...
	public ResourcesPanel(UIPluginContext context)
			...
			RNSPathDoesNotExistException
	{
		...
		add(new JButton(new RefreshAction()), new GridBagConstraints(
			0, 1, 1, 1, 1.0, 0.0,
