...
public class CommandFunctionPlugin extends AbstractCombinedUIMenusPlugin
{
	...
	protected void performMenuAction(UIPluginContext context, MenuType menuType) throws UIPluginException
	{
		...
		try {
			...
			JavaCommandFunction function = CommandFunctionChoiceDialog.chooseCommandFunction(context.ownerComponent(),
			...
			if (function.parameters().length == 0) {
				int answer = JOptionPane.showConfirmDialog(context.ownerComponent(),
