...
{
	static final private String BASE_RESOURCE_PATH = "edu/virginia/vcgr/genii/ui/plugins/acls/icon-resources";
	...
	static {
		try {
			_everyoneImage = loadImage(String.format("%s/everyone.png", BASE_RESOURCE_PATH));
			_personImage = loadImage(String.format("%s/person.png", BASE_RESOURCE_PATH));
			_emptyPatternImage = loadImage(String.format("%s/empty-pattern.png", BASE_RESOURCE_PATH));
			_filledPatternImage = loadImage(String.format("%s/filled-pattern.png", BASE_RESOURCE_PATH));
