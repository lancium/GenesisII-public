...
public class DebugPlugin extends AbstractCombinedUIPlugin implements UITopMenuPlugin, UIPopupMenuPlugin, UITabPlugin
{
	@Override
	protected void performMenuAction(UIPluginContext context, MenuType menuType) throws UIPluginException
	{
		for (RNSPath path : context.endpointRetriever().getTargetEndpoints()) {
			System.err.format("%s Menu:  %s\n", (menuType == MenuType.POPUP_MENU) ? "Popup" : "Top", path.pwd());
		}
	}
