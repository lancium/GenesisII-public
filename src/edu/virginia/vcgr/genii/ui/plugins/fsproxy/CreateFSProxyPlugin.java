	...
	protected void performMenuAction(UIPluginContext context, MenuType menuType) throws UIPluginException
	{
		...
		while (true) {
			...
			try {
				...
				FSViewConnectionInformation connectInfo = dialog.connectionInformation();
				...
				if (connectInfo != null) {
					...
					RNSSelectionDialog rDialog = new RNSSelectionDialog(SwingUtilities.getWindowAncestor(context
						.ownerComponent()), context.uiContext(), new RNSTreeSelectionContainerFilter());
					rDialog.pack();
					...
					CreateResourceTool.createInstance(proxyService.getEndpoint(), new GeniiPath(path.pwd()),
