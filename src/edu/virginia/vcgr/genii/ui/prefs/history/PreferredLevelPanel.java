...
class PreferredLevelPanel extends JPanel
{
	...
	PreferredLevelPanel(HistoryEventLevel level)
	{
		...
		_combo = new EnumComboBox<HistoryEventLevel>(HistoryEventLevel.class, EnumComboSort.ByOrdinal, false,
			LevelIcon.ICON_MAP);
		_combo.setSelectedItem(level);

		add(_combo, new GridBagConstraints(0, 0, 1, 1, 1.0, 1.0, GridBagConstraints.CENTER, GridBagConstraints.NONE,
