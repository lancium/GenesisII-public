...
{
	static private final String RESOURCE_PATH_PATTERN = "edu/virginia/vcgr/genii/ui/rns/icon-resources/%s";

	static private EnumMap<EndpointType, Pair<Icon, Icon>> _endpointIcons = new EnumMap<EndpointType, Pair<Icon, Icon>>(
		EndpointType.class);
	...
	static {
		try {
			...
			_questionIcon = new ImageIcon(loadImage(String.format(RESOURCE_PATH_PATTERN, "question.png")));
	...
	static private Pair<Icon, Icon> loadIconPairs(String resourceName) throws IOException
	{
		Graphics2D g = null;
		...
		try {
			...
			BufferedImage original = loadImage(String.format(RESOURCE_PATH_PATTERN, resourceName));
