...
public enum ShapeIcons {
	Plus(Shapes.Plus.shape()), Minus(Shapes.Minus.shape()), UpArrow(Shapes.UpArrow.shape()), RightArrow(Shapes.RightArrow
		.shape()), DownArrow(Shapes.DownArrow.shape()), LeftArrow(Shapes.LeftArrow.shape());
