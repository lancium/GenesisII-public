...
public class XMLTreeIcons extends Icons
{
	static private final String RESOURCE_PATH_PATTERN =
		"edu/virginia/vcgr/genii/ui/xml/icon-resources/%s";
	...
	static
	{
		try
		{
			_elementIcon = new ImageIcon(loadImage(
				String.format(RESOURCE_PATH_PATTERN, "element.png")));
			_attributeIcon = new ImageIcon(loadImage(
					String.format(RESOURCE_PATH_PATTERN, "attribute.png")));
