...
public class JSDLFormer
{
	...
	private Map<String, String> _environmentVariables = new HashMap<String, String>();
	...
	public JobDefinition_Type formJSDL()
	{
		...
		jobIdentification = new JobIdentification_Type(_jobName, "Automatically generated JSDL document by Genesis II system.",
			null, null, null);
