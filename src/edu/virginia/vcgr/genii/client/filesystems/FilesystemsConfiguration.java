...
class FilesystemsConfiguration
{
	...
	@XmlElement(namespace = FilesystemConstants.CONFIGURATION_NS, name = "filesystem-alias")
	private Collection<FilesystemAliasConfiguration> _aliases = new LinkedList<FilesystemAliasConfiguration>();
