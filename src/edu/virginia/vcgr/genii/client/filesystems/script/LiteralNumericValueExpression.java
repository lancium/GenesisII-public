...
class LiteralNumericValueExpression implements NumericValueExpression
{
	...
	public LiteralNumericValueExpression(String literal) throws FilterScriptException
	{
		try {
			_value = new Size(literal);
		} catch (IllegalArgumentException nfe) {
			throw new FilterScriptException(String.format("Literal \"%s\" is not a valid size.", literal), nfe);
		}
	}
