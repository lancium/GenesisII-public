...
abstract class BinaryBooleanExpression implements BooleanExpression
{
	...
	protected BinaryBooleanExpression(BooleanExpression left, BooleanExpression right)
	{
		_left = left;
		_right = right;
	}

	static private class BinaryAndBooleanExpression extends BinaryBooleanExpression
	{
		private BinaryAndBooleanExpression(BooleanExpression left, BooleanExpression right)
		{
			super(left, right);
		}
	...
	static private class BinaryOrBooleanExpression extends BinaryBooleanExpression
	{
		private BinaryOrBooleanExpression(BooleanExpression left, BooleanExpression right)
		{
			super(left, right);
		}
	...
	static private class BinaryXorBooleanExpression extends BinaryBooleanExpression
	{
		private BinaryXorBooleanExpression(BooleanExpression left, BooleanExpression right)
		{
			super(left, right);
		}
