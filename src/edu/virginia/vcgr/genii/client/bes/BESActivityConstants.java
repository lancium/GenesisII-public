...
public interface BESActivityConstants
{
	...
	static public final String GENII_BES_ACTIVITY_PORT_TYPE_NAME =
		"BESActivityPortType";
	static public final PortType GENII_BES_ACTIVITY_PORT_TYPE =
		PortType.get(new QName(GENII_BES_ACTIVITY_NS, GENII_BES_ACTIVITY_PORT_TYPE_NAME));
