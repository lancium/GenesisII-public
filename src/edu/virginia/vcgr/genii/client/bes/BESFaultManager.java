...
{
	static final public String FAULT_NS =
		"http://genii.virginia.edu/faults";
	static final public QName FAULT_QNAME =
		new QName(FAULT_NS, "activity-fault");
	static final public QName FAULT_DETAIL_NAME =
		new QName(FAULT_NS, "detail");
	
	static private Detail constructDetail(Throwable []causes)
	{
		Collection<MessageElement> faultStrings = 
			new ArrayList<MessageElement>(causes.length);
		...
		for (Throwable cause : causes)
		{
			...
			writer.flush();
			faultStrings.add(new MessageElement(FAULT_DETAIL_NAME,
				sWriter.toString()));
		}
	...
	static public Fault constructFault(Throwable...causes)
