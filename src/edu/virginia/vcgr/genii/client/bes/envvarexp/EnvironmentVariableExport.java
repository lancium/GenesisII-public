...
class EnvironmentVariableExport
{
	...
	private void setConstantValue(
		EnvironmentVariableExportConstantValueProvider value)
	{
	...
	private EnvironmentVariableExportConstantValueProvider getConstantValue()
	{
		if (_valueProvider != null &&
			_valueProvider instanceof EnvironmentVariableExportConstantValueProvider)
	...
	private void setDynamicValue(
		EnvironmentVariableExportDynamicValueProvider value)
	{
		_valueProvider = value;
	}
	...
	{
		if (_valueProvider != null &&
			_valueProvider instanceof EnvironmentVariableExportDynamicValueProvider)
