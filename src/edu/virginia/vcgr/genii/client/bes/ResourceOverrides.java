...
public class ResourceOverrides implements Serializable
{
	...
	@XmlElement(namespace = BESConstructionParameters.BES_CONS_PARMS_NS,
		name = "operating-system-name", required = false)
	private OperatingSystemNames _operatingSystemName = null;
	
	@XmlElement(namespace = BESConstructionParameters.BES_CONS_PARMS_NS,
		name = "operating-system-version", required = false)
	private String _operatingSystemVersion = null;
	
	@XmlElement(namespace = BESConstructionParameters.BES_CONS_PARMS_NS,
		name = "cpu-architecture-name", required = false)
	private ProcessorArchitecture _cpuArchitectureName = null;
	
	@XmlElement(namespace = BESConstructionParameters.BES_CONS_PARMS_NS,
		name = "cpu-count", required = false)
	private Integer _cpuCount = null;
	
	@XmlElement(namespace = BESConstructionParameters.BES_CONS_PARMS_NS,
		name = "cpu-speed", required = false)
	private ClockSpeed _cpuSpeed = null;
	
	@XmlElement(namespace = BESConstructionParameters.BES_CONS_PARMS_NS,
		name = "physical-memory", required = false)
