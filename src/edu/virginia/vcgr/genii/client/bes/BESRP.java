...
{
	@ResourceProperty(namespace = GENII_BES_NS, 
		localname = POLICY_RESOURCE_PROPERTY_NAME,
	...
	@ResourceProperty(namespace = GENII_BES_NS, 
		localname = THRESHOLD_RESOURCE_PROPERTY_NAME)
	...
	@ResourceProperty(namespace = GENII_BES_NS,
		localname = IS_ACCEPTING_NEW_ACTIVITIES_NAME)
