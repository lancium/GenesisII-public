...
public class DAIRUtils {
	...
	static public MessageElement[] createCreationProperties(
			String driver, String connect_string, 
			String username, String password)
		{
			MessageElement []any = new MessageElement[4];
			any[0] = new MessageElement(new QName(
				GenesisIIConstants.GENESISII_NS, _DB_DRIVER_NAME), driver);
			any[1] = new MessageElement(new QName(
				GenesisIIConstants.GENESISII_NS, _CONNECT_STRING), connect_string);
			any[2] = new MessageElement(new QName(
				GenesisIIConstants.GENESISII_NS, _USERNAME), username);
			any[3] = new MessageElement(new QName(
				GenesisIIConstants.GENESISII_NS, _PASSWORD), password);
			return any;
		}
	...
	static public SQLAccessCombinedInitInfo extractCreationProperties(
			HashMap<QName, Object> properties){
		...
		//get driver
		/*
		 * it's not getting the correct value for the driver element
		 * there's something messed up with the creationProperties
		 */


		Hashtable <String, String > table = (Hashtable<String, String>) properties.get(
				new QName(GenesisIIConstants.GENESISII_NS, "creation-properties"));
