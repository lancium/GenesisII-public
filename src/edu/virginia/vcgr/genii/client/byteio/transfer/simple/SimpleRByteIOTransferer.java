	...
	SimpleByteIOTransferer
{
	...
	{
		TransferInformationType transType = new TransferInformationType(new MessageElement[] { createByteBundle(data) },
	...
	{
		TransferInformationType holder = new TransferInformationType(null, ByteIOConstants.TRANSFER_TYPE_SIMPLE_URI);

		ReadResponse resp = _clientStub.read(new Read(startOffset, bytesPerBlock, numBlocks, stride, holder));
