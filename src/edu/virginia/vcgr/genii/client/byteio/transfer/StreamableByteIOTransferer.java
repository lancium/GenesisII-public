 ...
 * represents the ability to transfer bytes for the streamable byteio
 ...
 * more obscure, web services related provisions such as combined
 * seek and read/write access), it was desirable in some cases to have
...
public interface StreamableByteIOTransferer extends ByteIOTransferer
{
	 ...
	 * from it.
	 * 
	 * @param origin The seek origin (one of beginning, current, or end).
	 * @param offset The offset for the seek operation (can be 0).
	...
	/**
	 * This method first seeks (if indicated) to a specific place in
	 * the target ByteIO's stream, and then writes a block of data to it.
	 * 
	 * @param origin The seek origin (one of beginning, current, or end).
	 * @param offset The offset for the seek operation (can be 0).
