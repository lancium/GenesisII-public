...
public interface WSIteratorRP
{
	...
	static final public QName ELEMENT_COUNT_QNAME = new QName(
		NS, ELEMENT_COUNT_NAME);
	
	static final public String PREFERRED_BATCH_SIZE_NAME = "preferredBatchSize";
	static final public QName PREFERRED_BATCH_SIZE_QNAME = new QName(
		NS, PREFERRED_BATCH_SIZE_NAME);
