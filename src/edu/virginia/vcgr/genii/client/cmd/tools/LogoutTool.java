...
public class LogoutTool extends BaseGridTool
{
	...
	static final private String _DESCRIPTION = "edu/virginia/vcgr/genii/client/cmd/tools/description/dlogout";
	static final private String _USAGE = "edu/virginia/vcgr/genii/client/cmd/tools/usage/ulogout";
	static final private String _MANPAGE = "edu/virginia/vcgr/genii/client/cmd/tools/man/logout";
	...
	protected int runCommand() throws Throwable
	{
		...
		if (_all) {
			...
			while (true) {
				ArrayList<NuCredential> credentials = TransientCredentials.getTransientCredentials(callContext)
					.getCredentials();
