...
public abstract class BaseLoginTool extends BaseGridTool
{
	...
	protected long _validMillis = SecurityConstants.CredentialExpirationMillis;
	...
	{
		super(new FileResource(description), new FileResource(usage), isHidden, ToolCategory.INTERNAL);
	}
