...
{
	static private final String DESCRIPTION = "edu/virginia/vcgr/genii/client/cmd/tools/description/dshell-login";
	static private final String USAGE = "edu/virginia/vcgr/genii/client/cmd/tools/usage/ushell-login";
	static final private String _MANPAGE = "edu/virginia/vcgr/genii/client/cmd/tools/man/shell-login";

	public ShellLoginTool()
	{
		super(new FileResource(DESCRIPTION), new FileResource(USAGE), false, ToolCategory.SECURITY);
