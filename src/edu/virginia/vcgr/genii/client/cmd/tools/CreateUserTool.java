...
public class CreateUserTool extends BaseGridTool
{
	...
	static final private String _DESCRIPTION = "edu/virginia/vcgr/genii/client/cmd/tools/description/dcreate-user";
	static final private String _USAGE = "edu/virginia/vcgr/genii/client/cmd/tools/usage/ucreate-user";
	 ...
	 */
	protected CreateUserTool(FileResource description, FileResource usageResource, boolean isHidden)
	{
	...
	protected void enactCreation(String storeType, String sourcePath, String idpServicePath, String idpName) throws Throwable
	{
		...
		stdout.println(String.format("\tLifetime:     %.2f days / %.2f years.",
			TimeHelpers.millisToDays(idpTool.getValidMillis()), TimeHelpers.millisToYears(idpTool.getValidMillis())));
