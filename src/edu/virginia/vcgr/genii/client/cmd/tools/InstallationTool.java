...
{
	static final private String _DESCRIPTION = "edu/virginia/vcgr/genii/client/cmd/tools/description/dlist-installations";
	static final private String _USAGE = "edu/virginia/vcgr/genii/client/cmd/tools/usage/ulist-installations";
	static final private FileResource _MANPAGE = new FileResource(
		"edu/virginia/vcgr/genii/client/cmd/tools/man/list-installations");

	public InstallationTool()
	{
		super(new FileResource(_DESCRIPTION), new FileResource(_USAGE), true, ToolCategory.INTERNAL);
		addManPage(_MANPAGE);
	}
