...
public class ManTool extends BaseGridTool
{
	...
	static private final String _DESCRIPTION = "edu/virginia/vcgr/genii/client/cmd/tools/description/dman";
	static private final String _USAGE = "edu/virginia/vcgr/genii/client/cmd/tools/usage/uman";
	static final private String _MANPAGE = "edu/virginia/vcgr/genii/client/cmd/tools/man/man";

	public ManTool()
	{
		super(new FileResource(_DESCRIPTION), new FileResource(_USAGE), true, ToolCategory.GENERAL);
	...
	{
		Map<String, ToolDescription> _tools = CommandLineRunner.getToolList(ConfigurationManager.getCurrentConfiguration()
