...
public class Grid
{
	...
	public Grid(Properties properties, BufferedReader stdin, PrintWriter stdout, PrintWriter stderr)
	{
	...
	private int runCommandInternal(String command, String... arguments) throws Throwable
	{
		...
		return new CommandLineRunner().runCommand(cLine, _stdout, _stderr, _stdin);
	}
	...
	public int runCommand(String command, String arg8) throws Throwable
	{
		return runCommandInternal(command, arg8);
	}

	public int runCommand(String command, String arg7, String arg8) throws Throwable
	{
		return runCommandInternal(command, arg7, arg8);
	}

	public int runCommand(String command, String arg6, String arg7, String arg8) throws Throwable
	{
		return runCommandInternal(command, arg6, arg7, arg8);
	}

	public int runCommand(String command, String arg5, String arg6, String arg7, String arg8) throws Throwable
	{
		return runCommandInternal(command, arg5, arg6, arg7, arg8);
	}

	public int runCommand(String command, String arg4, String arg5, String arg6, String arg7, String arg8) throws Throwable
	{
