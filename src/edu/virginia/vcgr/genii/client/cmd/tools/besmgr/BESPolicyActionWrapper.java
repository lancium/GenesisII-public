...
public enum BESPolicyActionWrapper {
	NOACTION(BESPolicyActions.NOACTION, "Do Nothing"), SUSPEND(BESPolicyActions.SUSPEND, "Suspend Jobs"), SUSPEND_OR_KILL(
		BESPolicyActions.SUSPENDORKILL, "Suspend or Kill Jobs"), KILL(BESPolicyActions.KILL, "Kill Jobs");
