...
public abstract class AbstractLoginHandler implements CallbackHandler
{
		...
		throws GeneralSecurityException, IOException
	{
		...
		KeyStore.Builder builder = new InputStreamBuilder(storeType, null, storeInput, new KeyStore.CallbackHandlerProtection(
			...
			for (int tryNumber = 0; tryNumber < _PASSWORD_TRIES; tryNumber++) {
				try {
					...
					if (_password != null) {
						...
						passwordChars = getPassword("Key Password", "Enter key password for \""
