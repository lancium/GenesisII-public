...
{
	static final private String _DESCRIPTION = "edu/virginia/vcgr/genii/client/cmd/tools/description/dset-container-service-properties";
	static final private FileResource _USAGE = new FileResource(
		"edu/virginia/vcgr/genii/client/cmd/tools/usage/uset-container-service-properties");
	static final private FileResource _MANPAGE = new FileResource(
		"edu/virginia/vcgr/genii/client/cmd/tools/man/set-container-service-properties");
	...
	private SetResourceProperties generateSetRequest()
	{
		...
		SetResourceProperties ret = new SetResourceProperties(null, elements.size() == 0 ? null : new UpdateType(
