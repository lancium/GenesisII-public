...
{
	static final private String _DESCRIPTION = "edu/virginia/vcgr/genii/client/cmd/tools/description/dscript";

	static final private String _USAGE = "edu/virginia/vcgr/genii/client/cmd/tools/usage/uscript";

	static final private String _MANPAGE = "edu/virginia/vcgr/genii/client/cmd/tools/man/script";
			...
			if (lcv >= args.size()) {
				...
				if (scriptFilePath.pathType() == GeniiPathType.Local) {
					File scriptFile = PathVariable.lookupVariable(System.getProperties(),
						GridEnvironment.GRID_PATH_ENV_VARIABLE).find(scriptFilePath.path(), PathVariable.FindTypes.FILE);
					if (scriptFile == null)
