...
public class MyProxyLoginTool extends BaseLoginTool
{
	...
	static private final String _USAGE_RESOURCE = "edu/virginia/vcgr/genii/client/cmd/tools/usage/uMyProxyLogin";
	...
	protected int runCommand() throws Throwable
	{
		...
		File trustRoot = new File(installLocation, "/deployments/"
		...
		stdout.println("Replacing client tool identity with credentials for \"" + creds[0].getSubjectDN().getName() + "\".");

		KeyAndCertMaterial clientKeyMaterial = new KeyAndCertMaterial(creds, mp.getPrivateKey());
