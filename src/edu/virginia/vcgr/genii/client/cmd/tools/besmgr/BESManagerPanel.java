...
public class BESManagerPanel extends JPanel
{
	...
	private class AcquireFinishProgressListener implements ProgressListener<ManagementData>
	{
		@Override
	...
	private class ApplyFinishProgressListener implements ProgressListener<ManagementData>
	{
		...
		public void taskExcepted(Exception e)
		{
			...
			JOptionPane.showMessageDialog(BESManagerPanel.this, "An error occurred while configuration BES container.",
