...
public class QSlotManagerTool extends BaseGridTool {
	...
	final static private String _DESCRIPTION = 
			"edu/virginia/vcgr/genii/client/cmd/tools/description/dqslotmgr";
	final static private String _USAGE = 
			"edu/virginia/vcgr/genii/client/cmd/tools/usage/uqslotmgr";
	final static private String _MANPAGE = 
			"edu/virginia/vcgr/genii/client/cmd/tools/man/qslotmgr";

	private static final String[] WAITING_JOB_STATUSES = 
		{ "Pending", "Queued", "Held", "Zombie" };
	 ...
	 * /etc/queue-slots/<queue-path> (e.g. "/etc/queue-slots/queues/grid-queue"). 
	 * The user may specify a different file path on the command line.
	 */
	private void populateSlotTable(String queuePath) 
	...
	/*
	 * This is the method YAN designed to read in a BES-level job status
	 * Returns true if the job is Waiting on a BES somewhere
	 */
	...
	/*
	 * We should increase the slot count if: 
	 *   a) all the current slots are full, and 
	 *   b) all the current jobs are running (not waiting), and 
	 *   c) the current slot count is less than the maximum 
	 * We can either increase by one at a time, or we can go straight to the 
	 * max; currently it's one at a time.
	 */
