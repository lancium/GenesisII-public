...
{
	static final private String _DESCRIPTION = "edu/virginia/vcgr/genii/client/cmd/tools/description/dcreate-user-delegate";
	static final private String _USAGE = "edu/virginia/vcgr/genii/client/cmd/tools/usage/ucreate-user-delegate";
	static final private String _MANPAGE = "edu/virginia/vcgr/genii/client/cmd/tools/man/create-user-delegate";
	...
	protected int runCommand() throws Throwable
	{
		...
		if (idpServicePath == null) {
			...
			idpServiceRNS = RNSUtilities.findService("/containers/BootstrapContainer", "X509AuthnPortType",
