...
public class IdpTool extends BaseLoginTool
{
	...
	static final private String _MANPAGE = "edu/virginia/vcgr/genii/client/cmd/tools/man/idp";
	...
	protected int runCommand() throws Throwable
	{
		...
		if ((_authnUri == null) && (_storeType == null)) {
			...
			constructionParms.add(new MessageElement(SecurityConstants.IDP_VALID_MILLIS_QNAME, _validMillis));
			...
			if (_authnUri == null) {
				...
				if (tPath.pathType() == GeniiPathType.Local) {
					...
					RNSPath authnPath = ContextManager.getExistingContext().getCurrentPath()
