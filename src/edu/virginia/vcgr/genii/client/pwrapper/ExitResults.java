...
public class ExitResults
{
	...
	{
		return String.format("Exit Code:  %d, User Time:  %d us, " +
			"Kernel Time:  %d us, Wallclock Time: %d us, " +
			"Max RSS:  %d bytes.\n",
			_exitCode, _userTime.as(TimeUnit.MICROSECONDS), 
			_kernelTime.as(TimeUnit.MICROSECONDS),
