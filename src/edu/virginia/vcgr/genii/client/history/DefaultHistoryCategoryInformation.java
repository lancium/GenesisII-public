...
public class DefaultHistoryCategoryInformation
	implements HistoryCategoryInformation
{
	...
	public DefaultHistoryCategoryInformation(
		String name, String description, IconProvider iconProvider)
	{
		if (name == null)
