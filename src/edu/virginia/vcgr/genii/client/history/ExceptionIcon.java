...
{
	static final private Icon STACK_TRACE_ICON =
		DefaultIconProvider.createIconProvider(
			ExceptionIcon.class, "resources/stack-trace.png").createIcon();
	...
	public void paintIcon(Component c, Graphics g, int x, int y)
	{
		...
		STACK_TRACE_ICON.paintIcon(c, g2,
			x + (_baseIcon.getIconWidth() - STACK_TRACE_ICON.getIconWidth()),
			y);
