...
public abstract class CommonAttributeCache extends CommonCache
{
	...
	protected Collection<String> getCacheKeysForLifetimeUpdateRequest(URI commonIdentifier)
	{
		...
		WSResourceConfig commonConfig = (WSResourceConfig) CacheManager.getItemFromCache(commonIdentifier,
			WSResourceConfig.class);
		...
		for (String rnsPath : commonConfig.getRnsPaths()) {
			...
			Map<String, WSResourceConfig> matchingChildConfigs = CacheManager.getMatchingItemsWithKeys(childPaths,
				WSResourceConfig.class);
