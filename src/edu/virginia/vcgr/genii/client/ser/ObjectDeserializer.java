...
public class ObjectDeserializer {
     ...
     * @throws ResourceException if the input could not be deserialized
     *         into a Java type.
     *
     */
    @SuppressWarnings("unchecked")
	public static <Type> Type toObject(SOAPElement element, Class<Type> javaClass)
        throws ResourceException {
        ...
        if (elem.getDeserializationContext() != null && !elem.isDirty()) {
            try {
                ...
                throw new ResourceException("Generic Deserialization Error.",
					e);
            }
        } else {
            ObjectDeserializationContext deserializer =
     ...
     * @see #toObject(SOAPElement, Class)
     */
    public static <Type> Type getFirstAsObject(
    	AnyContentType any, Class<Type> javaClass)
        throws ResourceException {
        if (any == null ||
            any.get_any() == null ||
    	...
    	throws ResourceException
    {
    	...
    	try
    	{
    		...
    		return (Type)ObjectDeserializer.deserialize(
    ...
    static public MessageElement[] anyFromBytes(byte []data)
    	throws ResourceException
	{
    	if (data == null)
    		return null;
