...
public class TextDialogProvider implements DialogProvider
{
			...
			throws DialogException, UserCancelException
	{
		TextInputDialog dialog = 
			(TextInputDialog)createInputDialog(title, prompt);
	...
	public InformationDialog createInformationDialog(String title,
			...
			UserCancelException
	{
		return new TextInformationDialog(
			title, _package, informationContent, false);
	}
	...
	public ComboBoxDialog createComboBoxDialog(String title, String prompt,
			...
			UserCancelException
	{
		return new TextComboBoxDialog(
			title, _package, prompt, defaultItem, items);
	}
