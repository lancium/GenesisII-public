...
public class TextInformationDialog extends TextInputDialog 
	implements InformationDialog
{
	...
	public TextInformationDialog(String title,
		ConsolePackage pkg, TextContent content, boolean isError)
	{
