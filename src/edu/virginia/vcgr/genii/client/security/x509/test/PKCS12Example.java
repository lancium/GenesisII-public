 ...
 * under the License.
 */
package edu.virginia.vcgr.genii.client.security.x509.test;
...
public class PKCS12Example
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		RSAPrivateCrtKeySpec intPrivKeySpec =
				new RSAPrivateCrtKeySpec(
						new BigInteger(
								"",
								16),
		...
		RSAPrivateCrtKeySpec caPrivKeySpec =
				new RSAPrivateCrtKeySpec(
						new BigInteger(
								"",
								16),
		...
		X509Certificate master =
				(X509Certificate) createMasterCert(caPubKey, caPrivKey);
		...
		chain[3] =
				(X509Certificate) createIntermediateCert(caPubKey, caPrivKey,
						(X509Certificate) chain[4], "d");
		chain[2] =
				(X509Certificate) createIntermediateCert(caPubKey, caPrivKey,
						(X509Certificate) chain[3], "e");
		chain[1] =
				(X509Certificate) createIntermediateCert(caPubKey, caPrivKey,
						(X509Certificate) chain[2], "f");
		chain[0] =
				(X509Certificate) createIntermediateCert(caPubKey, caPrivKey,
						(X509Certificate) chain[1], "g");
		...
		//
		store.setKeyEntry("Eric's Key", privKey, "hello world".toCharArray(),
				chain);
		FileOutputStream fOut = new FileOutputStream("id.p12");

		Certificate[] got = store.getCertificateChain("Eric's Key");
		 ...
		 * KeyStore.TrustedCertificateEntry(master); store2.setEntry("Bouncy
		 * Primary Certificate", entry, null); //
