...
*/
        ...
        throws Exception
    {
        ...
        X509Certificate master = (X509Certificate) createMasterCert(caPubKey, caPrivKey); 

        chain[chain.length - 1] = master;
/*        
        chain[6] = (X509Certificate) createIntermediateCert(caPubKey, caPrivKey, (X509Certificate)chain[7], "a");
        chain[5] = (X509Certificate) createIntermediateCert(caPubKey, caPrivKey, (X509Certificate)chain[6], "b");
        chain[4] = (X509Certificate) createIntermediateCert(caPubKey, caPrivKey, (X509Certificate)chain[5], "c");
*/
...
//        tmf.init(store2);
		PKIXBuilderParameters pkixParams = 
			new PKIXBuilderParameters(store2, new X509CertSelector());
		...
		for (int i = 0; i < chain.length; i++) {
            InputStream inputStream = new ByteArrayInputStream(chain[i].getEncoded());
            c2[i] = (X509Certificate) cf.generateCertificate(inputStream);
