...
public class TempTest
{
	...
	public static void main(String args[]) throws Exception
	{
		...
		X509Certificate clientCert =
				createClientCert(pubKey, caPrivKey, caPubKey);
		...
		GeneralName roleName =
				new GeneralName(GeneralName.rfc822Name, "DAU123456789");
		ASN1EncodableVector roleSyntax = new ASN1EncodableVector();
		roleSyntax.add(roleName);

		// roleSyntax OID: 2.5.24.72
		X509Attribute attributes =
				new X509Attribute("2.5.24.72", new DERSequence(roleSyntax));

		acGen.addAttribute(attributes);

		// finally create the AC
		X509V2AttributeCertificate att =
				(X509V2AttributeCertificate) acGen.generate(caPrivKey, "BC");
