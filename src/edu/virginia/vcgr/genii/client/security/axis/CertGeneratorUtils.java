...
public class CertGeneratorUtils
{
	...
	static public QName CERT_GENERATOR_DEFAULT_VALIDITY_CONSTRUCTION_PARAMETER = new QName(GenesisIIConstants.GENESISII_NS,
		"cert-generator-default-validity");
	static public QName CERT_GENERATOR_ISSUER_CHAIN_CONSTRUCTION_PARAMETER = new QName(GenesisIIConstants.GENESISII_NS,
		"cert-generator-issuer-chain");
	static public QName CERT_GENERATOR_ISSUER_PRIVATE_KEY_CONSTRUCTION_PARAMETER = new QName(GenesisIIConstants.GENESISII_NS,
		"cert-generator-issuer-private-key");

	static public void insertCertGeneratorParameters(HashMap<QName, MessageElement> parameters, Long defaultValidity,
		X509Certificate[] issuerChain, PrivateKey issuerPrivateKey) throws IOException
	{
		parameters.put(CERT_GENERATOR_DEFAULT_VALIDITY_CONSTRUCTION_PARAMETER, new MessageElement(
		...
		Long defaultValidity) throws IOException
	{
		...
		any[0] = new MessageElement(CERT_GENERATOR_ISSUER_CHAIN_CONSTRUCTION_PARAMETER, DBSerializer.serialize(issuerChain,
			Long.MAX_VALUE));
		any[1] = new MessageElement(CERT_GENERATOR_ISSUER_PRIVATE_KEY_CONSTRUCTION_PARAMETER, DBSerializer.serialize(
			issuerPrivateKey, Long.MAX_VALUE));
	...
	static public Long getDefaultValidity(HashMap<QName, MessageElement> parameters) throws IOException, Exception
	{
	...
	static public X509Certificate[] getIssuerChain(HashMap<QName, MessageElement> parameters) throws IOException, Exception
	{
	...
	static public PrivateKey getIssuerPrivateKey(HashMap<QName, MessageElement> parameters) throws IOException, Exception
	{
