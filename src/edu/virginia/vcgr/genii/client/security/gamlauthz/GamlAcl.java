...
public class GamlAcl implements Serializable {
	...
	static public GamlAcl decodeAcl(AuthZConfig config) throws AuthZSecurityException {
		...
		try {
			...
			GamlAclType gacl = (GamlAclType) aclMel
					.getObjectValue(GamlAclType.class);
