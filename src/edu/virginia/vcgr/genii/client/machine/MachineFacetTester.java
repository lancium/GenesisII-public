...
public class MachineFacetTester
{
	static public void main(String []args) throws Throwable
	{
		...
		MyMachineListener listener = new MyMachineListener(
			new File(args[0]));
		MachineFacetUpdater updater = new MachineFacetUpdater(
			1000 * 30, 1000 * 30);
	...
	static private class MyMachineListener implements MachineListener
	{
		...
		{
			_ps.println("[" + new Date() + "] -- " +
				(activated ? 
					"Screen Saver Activated" : "Screen Saver DeActivated"));
			_ps.flush();
		}
