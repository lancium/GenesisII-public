...
public class ApplicationDescriptionCreator
{
	...
	static public EndpointReferenceType createApplicationDescription(
		EndpointReferenceType serviceEPR,
		String name, ApplicationVersion applicationVersion)
		throws CreationException
	{
		return ResourceCreator.createNewResource(serviceEPR,
			new MessageElement[] {
				new MessageElement(APPLICATION_NAME_CREATION_PARAMETER, name),
				new MessageElement(APPLICATION_VERSION_CREATION_PARAMETER,
					applicationVersion.toString())
			}, null);
	}
	
	static public EndpointReferenceType createApplicationDescription(
		String serviceName, String name, ApplicationVersion applicationVersion)
		throws CreationException
	{
			...
			new MessageElement[] {
				...
				new MessageElement(APPLICATION_VERSION_CREATION_PARAMETER,
					(applicationVersion == null) ? 
						null : applicationVersion.toString())
			}, null);
	}
}