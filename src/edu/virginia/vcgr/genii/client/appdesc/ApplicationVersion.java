...
public class ApplicationVersion 
	implements Serializable, Comparable<ApplicationVersion>
{
	static final long serialVersionUID = 0L;
	
	static private Pattern _VERSION_PATTERN =
	...
	public ApplicationVersion(String versionString)
	{
		if (!_VERSION_PATTERN.matcher(versionString).matches())
			throw new IllegalArgumentException("The version given \""
	...
	public int compareTo(ApplicationVersion o)
	{
		...
		int maxLength = (myVersionLength > otherLength) ? 
			myVersionLength : otherLength;
		int lcv = 0;
		int myVal;
		int otherVal;
