...
{
	static public ExecutionTask installGenesisIIContainer(
		String account, String accountPassword) throws IOException
	{
		...
		JavaServiceWrapper.JavaServiceWrapperTask task = 
			JavaServiceWrapper.installServiceWrapper(
				wrapperExe, configurationFile, account, accountPassword);
		...
		throws IOException
	{
		...
		JavaServiceWrapper.JavaServiceWrapperTask task = 
			JavaServiceWrapper.uninstallServiceWrapper(
				wrapperExe, configurationFile);
