...
/**
 * This dialog box is displayed when the user has requested that a new
 * directory be created.  It asks the user to give a name to that new
 * directory.
 * 
 * @author mmm2a
 */
class NewDirectoryDialog extends JDialog
{
	...
	private NewDirectoryDialog(JFrame parent)
	{
		...
		/* Don't allow the user to click on "X" in the corner to close this
		 * box.  They MUST click cancel or OK.
		 */
	...
	/**
	 * The action that the OK button has to either perform actions or
	 * disable the button when the text in the text field is not
	 * appropriate to be a new directory name.
	 * 
	 * @author mmm2a
	 */
	...
	/**
	 * A helper method that creates the dialog box and uses it to get
	 * user input.
	 * 
	 * @param owner The frame that should own the new dialog.
	 * @return The string name of the directory entered by the user, or null
