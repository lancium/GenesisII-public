...
public class Instantiater
{
	 ...
	 */
	static public IPlugin instantiate(Class<IPlugin> cl, Element constructionParams) throws PluginException
	{
		try {
			try {
				/*
				...
				/*
				 * If such a constructor exists, go ahead and use it to create this plugin.
				 */
			...
			throw new PluginException("Unable to instantiate plugin class \"" + cl.getName() + "\".", ia);
		} catch (IllegalAccessException iae) {
			throw new PluginException("Constructor for plugin class \"" + cl.getName() + "\" is not public.", iae);
		} catch (NoSuchMethodException nsme) {
	...
	static public IPlugin instantiate(String className, Element constructionParams) throws PluginException
	{
		try {
			...
			throw new PluginException("Unable to find plugin class \"" + className + "\".", cnfe);
		}
	}
}