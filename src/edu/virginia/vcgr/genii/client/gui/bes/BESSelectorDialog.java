...
public class BESSelectorDialog extends JDialog
{
	...
	private BESSelectorDialog(Window owner)
	{
		...
		besPanel.add(new JScrollPane(_besList), new GridBagConstraints(
			0, 0, 1, 2, 1.0, 1.0, GridBagConstraints.CENTER,
			GridBagConstraints.BOTH, new Insets(5, 5, 5, 5), 5, 5));
		besPanel.add(new JButton(new CreateBESAction()), 
			new GridBagConstraints(
				1, 0, 1, 1, 0.0, 1.0, GridBagConstraints.CENTER,
				GridBagConstraints.NONE, new Insets(5, 5, 5, 5), 5, 5));
		besPanel.add(new JButton(new RemoveBESAction()),
			new GridBagConstraints(
				1, 1, 1, 1, 0.0, 1.0, GridBagConstraints.CENTER,
				GridBagConstraints.NONE, new Insets(5, 5, 5, 5), 5, 5));
	...
	private class CreateBESAction extends AbstractAction
	{
		...
		public void actionPerformed(ActionEvent e)
		{
			...
			while (true)
			{
				...
				JOptionPane.showMessageDialog(BESSelectorDialog.this,
					error, "Creation Error", JOptionPane.ERROR_MESSAGE);
			}
		}
	}
	
	private class RemoveBESAction extends AbstractAction
