...
public class UnixDirectory {
	...
	public void addEntry(FuseDirEnt entry) {
		...
		// First we have to remove the entry with the same name, if exists; otherwise, there is a chance that
		// the directory will hold multiple entries with the same name. This can happen if the client receive 
