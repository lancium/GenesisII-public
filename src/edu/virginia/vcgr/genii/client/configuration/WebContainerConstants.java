...
{
	static public final String LISTEN_PORT_PROP =
		"edu.virginia.vcgr.genii.container.listen-port";
	static public final String DPAGES_PORT_PROP =
		"edu.virginia.vcgr.genii.container.dpages-port";
	
	static public final String MAX_ACCEPT_THREADS_PROP =
		"edu.virginia.vcgr.genii.container.max-acceptor-threads";
