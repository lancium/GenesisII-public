...
{
	static public final String CREATION_PROPERTIES_NS =
		GenesisIIConstants.GENESISII_NS;
	static public final String CREATION_PROPERTIES_NAME =
		"creation-properties";
	static public final QName CREATION_PROPERTIES_QNAME =
		new QName(CREATION_PROPERTIES_NS, CREATION_PROPERTIES_NAME);
	
	static public final String CREATION_PROPERTY_NS =
		GenesisIIConstants.GENESISII_NS;
	static public final String CREATION_PROPERTY_NAME =
		"creation-property";
	static public final QName CREATION_PROPERTY_QNAME =
		new QName(CREATION_PROPERTY_NS, CREATION_PROPERTY_NAME);
	...
	static public MessageElement translate(Properties properties)
	{
		...
		catch (SOAPException se)
		{
			throw new RuntimeException(
				"Unable to create message properties " +
				"for creation properties.", se);
		}
	}
	
	static public Properties translate(MessageElement element)
