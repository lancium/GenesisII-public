...
final public class IterableIterable<Type> implements Iterable<Type>
{
	...
	public IterableIterable(Iterable<Type>...iterables)
	{
		this();
		
		for (Iterable<Type> iterable : iterables)
	...
	{
		return new IterableIterableIterator<Type>(
			_iterables.iterator());
	}
	
	static private class IterableIterableIterator<Type> 
