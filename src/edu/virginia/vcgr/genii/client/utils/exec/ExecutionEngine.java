...
public class ExecutionEngine
{
	...
	static private List<String> readOutput(byte []data)
		throws IOException
	{
		...
		throws IOException
	{
		...
		try
		{
			...
			return new SimpleExecutionResults(
				exitCode, readOutput(stdout.getData()), readOutput(stderr.getData()));
		}
		finally
		{
			if (proc != null)
			{
				try { proc.destroy(); } catch (Throwable cause) {}
			}
