...
public class QueryGUI extends JFrame{
	...
	private void initComponents(){
		...
		layout.setHorizontalGroup(
	            ...
	            .addGroup(layout.createSequentialGroup()
	                ...
	                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
	                    ...
	                    .addGroup(layout.createSequentialGroup()
	                        ...
	                        .addComponent(CPU))
	                     .addGroup(layout.createSequentialGroup()
	                		.addComponent(CPUArchitectureNameLabel)
	                		.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
	                    ...
	                    .addGroup(layout.createSequentialGroup()
	                		...
	                		.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED))
	                	.addGroup(layout.createSequentialGroup()
	                		.addComponent(PhysicalMamoryLabel)
	                		.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
	                    ...
	                    .addGroup(layout.createSequentialGroup()
	                    	.addComponent(IsAcceptingNewActivities)
	                		.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED))
	                	.addGroup(layout.createSequentialGroup()
	                		...
	                		.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED))
	                	.addGroup(layout.createSequentialGroup()
	                    	.addComponent(TotalNumberOfActivitiesLabel)
	                    	.addComponent(TotalNumberOfActivities)
	                		.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED))
	                	.addGroup(layout.createSequentialGroup()
	                    	.addComponent(LocalResourceManagerTypeLabel)
	                    	.addComponent(LocalResourcemanagerType)
	                		.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED))
	                	.addGroup(layout.createSequentialGroup()
	                    	.addComponent(NamingProfileLabel)
	        ...
	        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {PhysicalMamoryLabel, PhysicalMemory, VirtualMemoryLabel, VirtualMemory});
	        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {CommonNameLabel, CommonName});
	        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {TotalNumberOfActivitiesLabel, TotalNumberOfActivities});
	        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {LocalResourceManagerTypeLabel, LocalResourcemanagerType});
	...
	protected void submitButtonActionPerformed(ActionEvent evt) {
		...
		/* 
		 * if the user wants to submit the so-formed query the values entered in the GUI
		 * are stored in the variable queryParameters
		*/
	...
	public GUIInternalStruct runGUI() {
		...
		/*
		 * loop until either the OK or the Cancel button of the GUI
		 * has been clicked on
		 */
		while (stayInLoop){
