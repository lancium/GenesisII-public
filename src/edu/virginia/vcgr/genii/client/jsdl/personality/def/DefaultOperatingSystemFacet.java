...
public class DefaultOperatingSystemFacet extends DefaultPersonalityFacet
	implements OperatingSystemFacet
{
	@Override
			...
			throws JSDLException
	{
		throw new UnsupportedJSDLElement(
			new QName(JSDLConstants.JSDL_NS, "OperatingSystemVersion"));
	}
}
