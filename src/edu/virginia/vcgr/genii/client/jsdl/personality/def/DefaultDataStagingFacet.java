...
public class DefaultDataStagingFacet extends DefaultPersonalityFacet implements DataStagingFacet
{
	@Override
	public void consumeCreationFlag(Object currentUnderstanding, CreationFlagEnumeration creationFlag) throws JSDLException
	{
		throw new UnsupportedJSDLElement(new QName(JSDLConstants.JSDL_NS, "CreationFlag"));
	}

	@Override
	public void consumeDeleteOnTerminateFlag(Object currentUnderstanding, boolean deleteOnTerminate) throws JSDLException
	{
		throw new UnsupportedJSDLElement(new QName(JSDLConstants.JSDL_NS, "DeleteOnTerminateFlag"));
	}
	...
	{
		throw new UnsupportedJSDLElement(new QName(JSDLConstants.JSDL_NS, "FileSystemName"));
	}
