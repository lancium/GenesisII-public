...
@XmlRootElement(namespace = RNSConstants.GENII_RNS_NS, 
		name = "RNSContentChangeNotification")
public class RNSContentChangeNotification extends NotificationMessageContents {
	...
	@XmlElement(namespace = RNSConstants.GENII_RNS_NS,
			name = "RNSEntry", nillable = false, required = false)
	private byte[] entryEPR;
	
	@XmlElement(namespace = RNSConstants.GENII_RNS_NS,
			name = "elementCount", nillable = false, required = true)
