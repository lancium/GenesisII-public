...
@XmlRootElement(namespace = AdditionalUserDataConstants.NS,
	name = AdditionalUserDataConstants.ELEMENT_NAME)
public class AdditionalUserData implements Serializable
{
		...
		MessageElement toMessageElement(Type value) throws JAXBException
	{
		...
		JAXBElement jaxbe = new JAXBElement(
			AdditionalUserDataConstants.ELEMENT_QNAME, 
	...
	static public <Type extends AdditionalUserData>
		Type fromElement(Class<Type> type, Element me)
