...
public class TopicNode implements Serializable
{
	...
	{
		if (nodeName == null)
			throw new IllegalArgumentException("TopicNode name cannot be null.");
	...
	{
		return new TopicNode(new QName(_nodeName.getNamespaceURI(), childName));
	}
	...
	{
		return _nodeName.getNamespaceURI().hashCode() ^ _nodeName.getLocalPart().hashCode();
	}
}