...
@XmlRootElement(namespace = WSRFConstants.WSRF_RL_NS,
	name = "TerminationNotification")
public class ResourceTerminationContents extends NotificationMessageContents
{
	static final long serialVersionUID = 0L;
	
	@XmlElement(namespace = WSRFConstants.WSRF_RL_NS, 
		name = "TerminationTime", nillable = true, required = true)
	private Calendar _terminationTime;
	
	@XmlElement(namespace = WSRFConstants.WSRF_RL_NS, 
		name = "TerminationReason", nillable = false, required = false)
	...
	public ResourceTerminationContents(
