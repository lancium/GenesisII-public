...
public class ByteIOContentsChangedContents extends NotificationMessageContents
{
	...
	@XmlElement(namespace = ByteIOConstants.BYTEIO_NS,
	...
	public ByteIOContentsChangedContents(ByteIOOperations operation, long offset,
			int bytesPerBlock, long stride, int size)
	{
