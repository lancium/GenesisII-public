...
public interface WSRFConstants
{
	...
	static public final PortType WSN_NOTIFICATION_CONSUMER_PORT =
		PortType.get(new QName(
			WSN_BASE_NOT_NS, "NotificationConsumer"));
	static public final PortType WSN_NOTIFICATION_PRODUCER_PORT =
		PortType.get(new QName(
			WSN_BASE_NOT_NS, "NotificationProducer"));
	static public final PortType WSN_PULL_POINT_PORT =
		PortType.get(new QName(
			WSN_BASE_NOT_NS, "PullPoint"));
	static public final PortType WSN_CREATE_PULL_POINT_PORT =
		PortType.get(new QName(
			WSN_BASE_NOT_NS, "CreatePullPoint"));
	static public final PortType WSN_SUBSCRIPTION_MANAGER_PORT =
		PortType.get(new QName(
			WSN_BASE_NOT_NS, "SubscriptionManager"));
	static public final PortType WSN_PAUSABLE_SUBSCRIPTION_MANAGER_PORT =
		PortType.get(new QName(
			WSN_BASE_NOT_NS, "PausableSubscriptionManager"));
	static public final PortType WSN_REGISTER_PUBLISHER_PORT =
		PortType.get(new QName(
			WSN_BROKERED_NOT_NS, "RegisterPublisher"));
	static public final PortType WSN_BROKERED_NOTIFICATION_PORT =
		PortType.get(new QName(
			WSN_BROKERED_NOT_NS, "NotificationBroker"));
	static public final PortType WSN_PUBLISHER_REGISTRATION_MANAGER_PORT =
		PortType.get(new QName(
			WSN_BROKERED_NOT_NS, "PublisherRegistrationManager"));
	
	static public final QName FIXED_TOPIC_SET_QNAME = new QName(
		WSN_BASE_NOT_XSD_NS, "FixedTopicSet");
	
	static public final QName TOPIC_EXPRESSION_DIALECT_RP = new QName(
		WSN_BASE_NOT_XSD_NS, "TopicExpressionDialect");
	
	static public final QName TOPIC_EXPRESSION_RP = new QName(
		WSN_BASE_NOT_XSD_NS, "TopicExpression");
	
	static public final QName TOPIC_SET_RP = new QName(
			WSN_BASE_NOT_XSD_NS, "TopicSet");
