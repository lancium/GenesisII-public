...
public interface QueueConstants
{
	...
	static final public QName CURRENT_RESOURCE_INFORMATION_QNAME = new QName(QUEUE_NS, CURRENT_RESOURCE_INFORMATION_NAME);

	static final public PortType QUEUE_PORT_TYPE = PortType.get(new QName(QUEUE_NS, QUEUE_PORT_TYPE_NAME));

	static public QName RESOURCE_SLOTS_QNAME = new QName(QUEUE_NS, "total-slots");
