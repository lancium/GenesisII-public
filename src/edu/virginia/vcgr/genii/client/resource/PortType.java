...
public class PortType
{
	...
	static private final FileResource KNOWN_PORT_TYPES_RESOURCE = new FileResource(
		"edu/virginia/vcgr/genii/client/resource/known-porttypes.xml");
	...
	static {
		...
		try {
			...
			if (badPortType == true) {
				...
				throw new IOException("Invalid entry found in known-porttypes.xml file.\n" + "Expected <portType> but saw <"
					+ n.getNodeName() + ">");
			}
	...
	static public String translate(PortType portType)
	{
