...
import edu.virginia.vcgr.genii.client.jni.giilibmirror.localtest.TestDirHandle;
import edu.virginia.vcgr.genii.client.jni.giilibmirror.localtest.TestFileHandle;
...
public class JNIOpen extends JNILibraryBase{
	...
	public static ArrayList<String> open(String fileName, Integer requestedDeposition,
		...
		System.out.println("GICING:  Open Received for " + fileName + " depo: " +
				requestedDeposition + " access: " + desiredAccess + " mustBeDir: " + mustBeADirectory);
