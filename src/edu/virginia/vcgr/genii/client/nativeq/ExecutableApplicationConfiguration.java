...
public class ExecutableApplicationConfiguration 
	implements Serializable, NativeQConstants
{
	...
	@XmlElement(namespace = NS, name = "additional-argument", required = false,
		nillable = false)
	...
	public ExecutableApplicationConfiguration(
		String pathOverride, Collection<String> additionalArguments)
	{
	...
	final public List<String> startCommandLine(
		File binDirectoryOverride, String defaultBinaryName)
			throws FileNotFoundException
	{
		List<String> ret = new LinkedList<String>();
		
		ret.add(findBinary(binDirectoryOverride,
			defaultBinaryName).getAbsolutePath());
