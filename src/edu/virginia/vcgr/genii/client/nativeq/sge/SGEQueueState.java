...
public class SGEQueueState implements NativeQueueState
{
	...
	static public SGEQueueState fromStateString(String string) throws NativeQueueException
	{
		if (string.equals("pending"))
			...
			throw new NativeQueueException(String.format("%s is not a known SGE Queue Job State.", string));
	}
}