	...
	AbstractNativeQueueConnection<ProviderConfigType>
{
		...
		throws NativeQueueException, IOException
	{
		...
		try {
			...
			ProcessWrapper wrapper = ProcessWrapperFactory.createWrapper(getCommonDirectory(), overrides.operatingSystemName(),
			...
			Vector<String> testCmdLine = wrapper.formCommandLine(application.getFuseMountPoint(), application.getEnvironment(),
