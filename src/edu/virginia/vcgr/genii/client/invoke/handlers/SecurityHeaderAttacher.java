...
public class SecurityHeaderAttacher
{
	...
	public SubmitJobResponseType submitJob(InvocationContext ctxt, SubmitJobRequestType submitJobRequest) throws Throwable
	{
	...
	public CreateActivityResponseType createActivity(InvocationContext ctxt, CreateActivityType parameters) throws Throwable
	{
		MyProxyCertificate.setIfXSEDEUser();
		CreateActivityResponseType c = (CreateActivityResponseType) ctxt.proceed();
		MyProxyCertificate.reset();
		return c;
	}
