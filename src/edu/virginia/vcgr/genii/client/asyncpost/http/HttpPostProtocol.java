...
public class HttpPostProtocol extends AbstractPostProtocol
	implements PostProtocol
{
	static private final String []HANDLED_PROTOCOLS =
		new String[] { "http" };
	...
	protected void doPost(URI target, byte[] content) throws Throwable
	{
		...
		finally
		{
			...
			if (connection != null)
			{
				try { connection.disconnect(); } catch (Throwable cause) {}
			}
		}
	}
}