...
{
	/**
	 * Constructs an object for recursing a File. This takes 4 alert methods that will be invoked
	 * when (1) entering a directory, (2) leaving a directory, (3) hitting a file, and (4)
	...
	public JavaFileRecurser(TreeTraversalActionAlert<File> enterDirectoryAlert,
		TreeTraversalActionAlert<File> exitDirectoryAlert, TreeTraversalActionAlert<File> fileAlert,
