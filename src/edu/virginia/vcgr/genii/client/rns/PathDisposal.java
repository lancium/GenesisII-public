...
public class PathDisposal
{
	...
	final static int MAX_DELETE_DEPTH = 20; // we do not try to remove directory trees deeper than
											// this.
	...
	static public PathOutcome recursiveDelete(RNSPath path)
	{
		...
		RNSRecurser zapper = new RNSRecurser(null, new RemoveDirectoryRNS(helping, ourBouncer), new RemoveFileRNS(helping,
