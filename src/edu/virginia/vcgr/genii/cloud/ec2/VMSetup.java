...
public class VMSetup {
	...
	public static void setupVM(
			String script, String archive, String remoteDirectory,
			String resourceID, CloudManager tManage) throws Exception{
		...
		if (tManage != null){
			...
			tManage.sendCommand(
					resourceID, "sudo chmod 777 /mnt", System.out, System.err);
			...
			if (script != null){
				...
				tManage.sendCommand(
						resourceID, command, System.out, System.err);  
				//Execute script
				tManage.sendCommand(
						resourceID, remoteScript, System.out, System.err);
			}
		}
	}
