...
public class VMStatusRPTranslater implements SingleResourcePropertyTranslator
{
	...
	public <Type> Type deserialize(Class<Type> clazz, MessageElement element) throws ResourcePropertyException
	{
		if (!VMStats.class.isAssignableFrom(clazz))
			throw new ResourcePropertyException("Unable to translate from type \"" + clazz.getName() + "\" to VMStats.");
