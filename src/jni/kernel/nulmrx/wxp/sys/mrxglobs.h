...
extern 
NTSTATUS 
GenesisCompleteQueryDirectory(PRX_CONTEXT RxContext, PVOID requestBuffer);

extern 
NTSTATUS 
GenesisCompleteQueryFileInformation(PRX_CONTEXT RxContext, PVOID requestBuffer);

extern
VOID
GenesisSaveInfoIntoFCB(PGENESIS_FCB fcb, PVOID info, int size);
...
extern
ULONG
GenesisSendDirectoryAndTarget(PRX_CONTEXT RxContext, PVOID buffer);
