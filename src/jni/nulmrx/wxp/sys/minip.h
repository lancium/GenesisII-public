...
typedef struct _GENESIS_COMPLETION_CONTEXT {
    //
...
} GENESIS_COMPLETION_CONTEXT, *PGENESIS_COMPLETION_CONTEXT;

#define IO_TYPE_SYNCHRONOUS     0x00000001
#define IO_TYPE_ASYNC           0x00000010

#define GenesisGetMinirdrContext(pRxContext)     \
        ((PGENESIS_COMPLETION_CONTEXT)(&(pRxContext)->MRxContext[0]))
