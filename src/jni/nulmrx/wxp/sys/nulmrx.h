...
#define USER_KERNEL_MAX_TRANSFER_SIZE 65536
...
#define GENESIS_FILE_SYSTEM L"NTFS"
...
#define IOCTL_CODE_UFS_STOP			203
...
#define GENII_CONTROL_UFS_STOP CTL_CODE(GENII_CONTROL_TYPE, IOCTL_CODE_UFS_STOP, METHOD_BUFFERED, FILE_WRITE_ACCESS)

//Genii calls to user service
#define GENII_QUERYDIRECTORY 0x30
#define GENII_CREATE 0x50
#define GENII_READ 0x60
#define GENII_WRITE 0x70
#define GENII_CLOSE 0x80
#define GENII_TRUNCATEAPPEND 0x90
#define GENII_STOP 0xA0
#define GENII_RENAME 0xC0

//For Genesis Create on Java side
#define GENESIS_FILE_SUPERSEDE	0
#define GENESIS_FILE_OPEN	1
#define GENESIS_FILE_CREATE	2
#define GENESIS_FILE_OPEN_IF	3
#define GENESIS_FILE_OVERWRITE	4
#define GENESIS_FILE_OVERWRITE_IF	5

#define GENESIS_FILE_READ_DATA	1
#define GENESIS_FILE_WRITE_DATA	2
#define GENESIS_FILE_APPEND_DATA	4
#define GENESIS_FILE_EXECUTE	8
#define GENESIS_FILE_DELETE	16
