...
#define SHIM_DECL_VOID(FUNCTION_NAME, PARAMETER_LIST)						\
	void real_##FUNCTION_NAME PARAMETER_LIST;								\
	void interceptor_##FUNCTION_NAME PARAMETER_LIST
...
#define SHIM_DEF_VOID(FUNCTION_NAME, PARAMETER_LIST, ARG_LIST)		\
	static void __initialize_##FUNCTION_NAME PARAMETER_LIST;			\
	static void (*_real_##FUNCTION_NAME) PARAMETER_LIST = __initialize_##FUNCTION_NAME;				\
	static void (*_current_##FUNCTION_NAME) PARAMETER_LIST = real_##FUNCTION_NAME;			\
	void __initialize_##FUNCTION_NAME PARAMETER_LIST					\
	{																		\
		_real_##FUNCTION_NAME = (void (*)PARAMETER_LIST)dlsym(		\
			RTLD_NEXT, #FUNCTION_NAME);										\
		_real_##FUNCTION_NAME ARG_LIST;								\
	}																		\
	void real_##FUNCTION_NAME PARAMETER_LIST							\
	{																		\
		_real_##FUNCTION_NAME ARG_LIST;								\
	...
	extern "C" {															\
		...
		{																	\
			_current_##FUNCTION_NAME ARG_LIST;						\
		}																	\
	}																		\
	void interceptor_##FUNCTION_NAME PARAMETER_LIST
