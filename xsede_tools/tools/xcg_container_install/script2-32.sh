...
FILE=installergenesis2_container_linux32_v2_6_0.bin

FILE1=xcg3_tls_cert.pfx

LOGFILE=wget.log

URL=http://genesis2.virginia.edu/wiki/uploads/Main/xcg_releases/4354/genesis2_container_linux32_v2_6_1.bin
