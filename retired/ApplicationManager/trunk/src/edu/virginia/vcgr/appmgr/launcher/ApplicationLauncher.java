...
public class ApplicationLauncher
{
	...
	static private final String UPDATE_FREQUENCY_PROPERTY = "edu.virginia.vcgr.appwatcher.update-frequency";
	...
	static public void main(String[] args)
	{
		...
		try {
			...
			if (appDesc.updateDisabled())
				...
				long updateFrequency = Long.parseLong(System.getProperty(UPDATE_FREQUENCY_PROPERTY, "-1"));
