...
public class TestCommandLineParser {
	...
	static private class startupKludge extends ApplicationBase {
		public startupKludge() {
			...
			// this code is not sufficient. we are getting nasty error message
			// from deep
	...
	// @Test
	public void notAtestCommandLineParser() throws ToolException,
			FileNotFoundException, IOException {
		String[] cLine = CommandLineFormer
				.formCommandLine("a bb ccc abc   abfoo");
