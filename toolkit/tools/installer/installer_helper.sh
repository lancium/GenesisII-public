...
#hmmm: this has not been separated completely from the caller yet; the installer_config variable is still needed, probably others.

#hmmm: plus the replace_compiler_variables name is not a great name.
